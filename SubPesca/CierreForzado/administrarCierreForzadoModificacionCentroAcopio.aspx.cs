...
{
    public partial class administrarCierreForzadoModificacionCentroAcopio : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (PreviousPage != null && PreviousPage is GenerarCierreForzadoModificacionCentroAcopio)
                {
                    MensajeSuperior.Text = ((GenerarCierreForzadoModificacionCentroAcopio)PreviousPage).MensajeRegistro;
                ...
                if (PreviousPage != null && PreviousPage is CierreForzadoResolucionModificacionCentroAcopio)
                {
                    MensajeSuperior.Text = ((CierreForzadoResolucionModificacionCentroAcopio)PreviousPage).MensajeRegistro;
                    if (!MensajeSuperior.Text.Equals(""))
                    {
                        PanelMensajeSuperior.Visible = true;
                        UpdatePanelMensajeSuperior.Update();
        ...
        protected void CargaGrilla(int idInforme, string numPert)
        {
            ...
            System.Data.DataTable dataTableCierreForzado = cierreForzadoService.ListarDocGralCierreIT(idInforme, rbTipo.CENTRO_DE_ACOPIO, rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO, numPert);
        ...
        protected void GridCierreForzado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_CIERRE_FORZADO_SOLICITUD_MODIFICACION_ACOPIO }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.ACCESO))
                    {
        ...
        protected void GridCierreForzado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "AsignarResolucionSSP":
                    ...
                    Response.Redirect("~/CierreForzado/CierreForzadoResolucionModificacionCentroAcopio.aspx?idDocCierre=" + id);
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            switch (nom_grilla)
            {
                case "cierreForzadoSolicitudConcesion":
                    ...
                    ngrilla = "cierreForzadoModificacionCentroAcopio.xls";
                    break;
