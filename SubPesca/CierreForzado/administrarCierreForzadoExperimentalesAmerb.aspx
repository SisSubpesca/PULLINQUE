<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarCierreForzadoExperimentalesAmerb.aspx.cs" 
Inherits="SubPesca.CierreForzado.administrarCierreForzadoExperimentalesAmerb" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Cierres Forzados Solicitud Experimentales Amerb</span></td>
    </tr>
    </table>
    <hr style="width:100%;" />
