<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarCierreForzadoFaenamiento.aspx.cs" 
Inherits="SubPesca.CierreForzado.administrarCierreForzadoFaenamiento" Theme="admin_style" %>



<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<%@ Reference Page="GenerarCierreForzadoFaenamiento.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Cierres Forzados Solicitud Centro de Faenamiento</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
