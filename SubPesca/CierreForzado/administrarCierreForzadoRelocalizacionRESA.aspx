<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarCierreForzadoRelocalizacionRESA.aspx.cs" 
Inherits="SubPesca.CierreForzado.administrarCierreForzadoRelocalizacionRESA" Theme="admin_style" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>

<%@ Reference Page="GenerarCierreForzadoRelocalizacionRESA.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Cierres Forzados Relocalización RESA</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
