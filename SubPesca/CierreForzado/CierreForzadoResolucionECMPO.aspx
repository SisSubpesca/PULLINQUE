<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="CierreForzadoResolucionECMPO.aspx.cs" 
Inherits="SubPesca.CierreForzado.CierreForzadoResolucionECMPO" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Cierre Forzado Acuicultura en ECMPO - Resumen</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
