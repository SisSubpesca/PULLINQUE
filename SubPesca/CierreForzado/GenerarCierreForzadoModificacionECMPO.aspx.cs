...
{
    public partial class GenerarCierreForzadoModificacionECMPO : System.Web.UI.Page
    {
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    TipoTramite.Items.Add(new ListItem("Trámite de Modificación Acuicultura en ECMPO", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO)));
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO);
            ...
            solicitudConcesion.tipoUnidadEspacial = new ParametroGenerico(rbTipo.ECMPO);

            ViewState["FILTRO_CIERRE_FORZADO_ECMPO"] = solicitudConcesion;
        ...
        protected void CargaGrilla()
        {
            ...
            SolicitudConcesion filtro = (SolicitudConcesion)ViewState["FILTRO_CIERRE_FORZADO_ECMPO"];

            List<SolicitudConcesion> resultadosLista = (List<SolicitudConcesion>)cierreForzadoService.ListarSolicitudECMPOCierreForzado(filtro);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.ECMPO);
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoModificacionECMPO.aspx");
        ...
        protected void GridVwHeaderChckbox_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)ViewState["FILTRO_CIERRE_FORZADO_ECMPO"];
            ...
            ViewState["FILTRO_CIERRE_FORZADO_ECMPO"] = solicitudFiltro;
