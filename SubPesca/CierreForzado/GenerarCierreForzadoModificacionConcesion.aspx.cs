...
{
    public partial class GenerarCierreForzadoModificacionConcesion : System.Web.UI.Page
    {
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_MODIFICACION);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_MODIFICACION);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoModificacionConcesion.aspx");
