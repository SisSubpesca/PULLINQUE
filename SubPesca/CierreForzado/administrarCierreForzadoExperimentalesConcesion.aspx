<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarCierreForzadoExperimentalesConcesion.aspx.cs" 
Inherits="SubPesca.CierreForzado.administrarCierreForzadoExperimentalesConcesion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Cierres Forzados Solicitud Experimentales Concesión</span></td>
    </tr>
    </table>
    <hr style="width:100%;" />
