...
{
    public partial class GenerarCierreForzadoRelocalizacionRESA : System.Web.UI.Page
    {
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoRelocalizacionRESA.aspx");
