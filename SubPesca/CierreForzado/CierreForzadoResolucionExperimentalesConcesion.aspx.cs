...
{
    public partial class CierreForzadoResolucionExperimentalesConcesion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["idDocCierre"] != null)
                {
                    ...
                    {
                        Response.Redirect("administrarCierreForzadoExperimentalesConcesion.aspx");
                    }

                    idInformeTecnico.Value = Convert.ToString(informeCierre.idRequerimiento); 
                    ViewState["informeCierre"] = informeCierre;

                    //InformeFlujoDocumental.Text = Convert.ToString(informeCierre.flujoDocumental.descripcion);
                    //InformeTipoEntrada.Text = Convert.ToString(informeCierre.tipoEntrada.descripcion);
                    //InformeOrigen.Text = Convert.ToString(informeCierre.origen.descripcion);
                    //InformeTipoDocumento.Text = Convert.ToString(informeCierre.tipoDocumento.descripcion);
                    //InformeTipo.Text = Convert.ToString(informeCierre.ambitoTipo[0].tipo.descripcion);
                    InformeNumero.Text = Convert.ToString(informeCierre.numero);
                    //InformeFecha.Text = Convert.ToString(informeCierre.fecha);
                    //InformeResultado.Text = Convert.ToString(informeCierre.ambitoTipo[0].estadoResultadoResp.descripcion);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    resolucionCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.CENTRO_DE_ACOPIO);
