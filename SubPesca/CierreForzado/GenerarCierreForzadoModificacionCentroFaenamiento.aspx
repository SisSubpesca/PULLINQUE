<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="GenerarCierreForzadoModificacionCentroFaenamiento.aspx.cs"
 Inherits="SubPesca.CierreForzado.GenerarCierreForzadoModificacionCentroFaenamiento" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Cierres Forzados Modificación Centro de Faenamiento</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
