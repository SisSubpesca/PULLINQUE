<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="GenerarCierreForzadoModificacionECMPO.aspx.cs" 
Inherits="SubPesca.CierreForzado.GenerarCierreForzadoModificacionECMPO" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Cierres Forzados Modificación ECMPO</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
