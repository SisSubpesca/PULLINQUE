<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="GenerarCierreForzadoModificacionAmerb.aspx.cs"
 Inherits="SubPesca.CierreForzado.GenerarCierreForzadoModificacionAmerb" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Cierres Forzados Modificación Acuicultura Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
