...
{
    public partial class CierreForzadoResolucionModificacionConcesion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["idDocCierre"] != null)
                {
                    ...
                    {
                        Response.Redirect("administrarCierreForzadoModificacionConcesion.aspx");
                    }
