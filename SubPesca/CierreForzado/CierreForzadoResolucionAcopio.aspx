<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="CierreForzadoResolucionAcopio.aspx.cs" 
Inherits="SubPesca.CierreForzado.CierreForzadoResolucionAcopio" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Cierre Forzado Centro de Acopio - Resumen</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
