<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarCierreForzadoColectores.aspx.cs"
Inherits="SubPesca.CierreForzado.administrarCierreForzadoColectores" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Cierres Forzados Solicitud Colectores de Semilla</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
