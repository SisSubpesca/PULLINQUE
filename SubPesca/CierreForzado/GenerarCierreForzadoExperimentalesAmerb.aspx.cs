...
{
    public partial class GenerarCierreForzadoExperimentalesAmerb : System.Web.UI.Page
    {
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB);
            ...
            solicitudConcesion.tipoUnidadEspacial = new ParametroGenerico(rbTipo.EXPERIMENTALES_AMERB);

            ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTAL_AMERB"] = solicitudConcesion;
        ...
        protected void CargaGrilla()
        {
            ...
            SolicitudConcesion filtro = (SolicitudConcesion)ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTAL_AMERB"];

            List<SolicitudConcesion> resultadosLista = (List<SolicitudConcesion>)cierreForzadoService.ListarSolicitudExperimentalesAmerbCierreForzado(filtro);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.EXPERIMENTALES_AMERB);
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoExperimentalesAmerb.aspx");
        ...
        protected void GridVwHeaderChckbox_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTAL_AMERB"];
            ...
            ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTAL_AMERB"] = solicitudFiltro;
