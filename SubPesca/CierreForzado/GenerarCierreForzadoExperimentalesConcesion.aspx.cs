...
{
    public partial class GenerarCierreForzadoExperimentalesConcesion : System.Web.UI.Page
    {
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION);
            ...
            solicitudConcesion.tipoUnidadEspacial = new ParametroGenerico(rbTipo.UNID_ESPACIAL_EXPERIMENTALES_CONCESION);

            ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTALES_CONCESION"] = solicitudConcesion;
        ...
        protected void CargaGrilla()
        {
            ...
            SolicitudConcesion filtro = (SolicitudConcesion)ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTALES_CONCESION"];
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.UNID_ESPACIAL_EXPERIMENTALES_CONCESION);
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoExperimentalesConcesion.aspx");
        ...
        protected void GridVwHeaderChckbox_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTALES_CONCESION"];
            ...
            ViewState["FILTRO_CIERRE_FORZADO_EXPERIMENTALES_CONCESION"] = solicitudFiltro;
