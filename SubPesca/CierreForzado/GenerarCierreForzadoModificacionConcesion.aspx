<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="GenerarCierreForzadoModificacionConcesion.aspx.cs"
 Inherits="SubPesca.CierreForzado.GenerarCierreForzadoModificacionConcesion"  Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Cierres Forzados Modificación Concesión</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
            ...
            <asp:UpdatePanel ID="UpdatePanelRCA" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3" colspan="4"><asp:DropDownList ID="RCA" runat="server" Width="300px"></asp:DropDownList></td>
                    </tr>
                </ContentTemplate>
            </asp:UpdatePanel>
