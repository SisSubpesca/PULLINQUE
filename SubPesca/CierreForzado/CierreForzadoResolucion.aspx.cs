...
{
    public partial class CierreForzadoResolucion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["idDocCierre"] != null)
                {
                    ...
                    {
                        Response.Redirect("administrarCierreForzado.aspx");
                    }
            ...
            */
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    resolucionCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.CONCESION_DE_ACUICULTURA);
