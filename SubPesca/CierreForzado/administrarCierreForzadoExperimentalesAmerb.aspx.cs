...
{
    public partial class administrarCierreForzadoExperimentalesAmerb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                if (PreviousPage != null && PreviousPage is GenerarCierreForzadoExperimentalesAmerb)
                {
                    MensajeSuperior.Text = ((GenerarCierreForzadoExperimentalesAmerb)PreviousPage).MensajeRegistro;
                ...
                if (PreviousPage != null && PreviousPage is CierreForzadoResolucionExperimentalesAmerb)
                {
                    MensajeSuperior.Text = ((CierreForzadoResolucionExperimentalesAmerb)PreviousPage).MensajeRegistro;
                    if (!MensajeSuperior.Text.Equals(""))
                    {
                        PanelMensajeSuperior.Visible = true;
                        UpdatePanelMensajeSuperior.Update();
        ...
        {
            System.Data.DataTable dataTableCierreForzado = cierreForzadoService.ListarDocGralCierreIT(idInforme, rbTipo.UNID_ESPACIAL_EXPERIMENTALES_AMERB, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB, numPert);
        ...
        protected void GridCierreForzado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_CIERRE_FORZADO_SOLICITUD_EXPERIMENTALES_AMERB }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.ACCESO))
                    {
        ...
        protected void GridCierreForzado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "AsignarResolucionSSP":
                    ...
                    Response.Redirect("~/CierreForzado/CierreForzadoResolucionExperimentalesAmerb.aspx?idDocCierre=" + id);
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "cierreForzadoSolicitudExperimentalesAmerb";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "cierreForzadoSolicitudExperimentalesAmerb":
                    GridCierreForzado.Columns.RemoveAt(4);
                    grilla = GridCierreForzado;
                    ngrilla = "cierreForzadoSolicitudExperimentalesAmerb.xls";
                    break;
