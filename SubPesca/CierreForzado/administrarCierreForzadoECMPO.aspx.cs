...
{
    public partial class administrarCierreForzadoECMPO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                if (PreviousPage != null && PreviousPage is GenerarCierreForzadoECMPO)
                {
                    MensajeSuperior.Text = ((GenerarCierreForzadoECMPO)PreviousPage).MensajeRegistro;
                ...
                if (PreviousPage != null && PreviousPage is CierreForzadoResolucionECMPO)
                {
                    MensajeSuperior.Text = ((CierreForzadoResolucionECMPO)PreviousPage).MensajeRegistro;
                    if (!MensajeSuperior.Text.Equals(""))
                    {
                        PanelMensajeSuperior.Visible = true;
                        UpdatePanelMensajeSuperior.Update();
        ...
        {
            System.Data.DataTable dataTableCierreForzado = cierreForzadoService.ListarDocGralCierreIT(idInforme, rbTipo.ECMPO, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO, numPert);
        ...
        protected void GridCierreForzado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_CIERRE_FORZADO_SOLICITUD_ECMPO }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.ACCESO))
                    {
        ...
        protected void GridCierreForzado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "AsignarResolucionSSP":
                    ...
                    Response.Redirect("~/CierreForzado/CierreForzadoResolucionECMPO.aspx?idDocCierre=" + id);
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "cierreForzadoSolicitudECMPO";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "cierreForzadoSolicitudECMPO":
                    GridCierreForzado.Columns.RemoveAt(4);
                    grilla = GridCierreForzado;
                    ngrilla = "cierreForzadoSolicitudECMPO.xls";
                    break;
