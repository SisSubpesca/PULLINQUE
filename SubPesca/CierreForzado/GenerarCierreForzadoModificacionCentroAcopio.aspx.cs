...
{
    public partial class GenerarCierreForzadoModificacionCentroAcopio : System.Web.UI.Page
    {
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                case "TipoTramite":
                    ...
                    TipoTramite.Items.Add(new ListItem("Trámite de Modificación Centro de Acopio", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO)));
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO);
            ...
            solicitudConcesion.tipoUnidadEspacial = new ParametroGenerico(rbTipo.CENTRO_DE_ACOPIO);
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> resultadosLista = (List<SolicitudConcesion>)cierreForzadoService.ListarSolicitudAcopioCierreForzado(filtro);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.CENTRO_DE_ACOPIO);
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoModificacionCentroAcopio.aspx");
