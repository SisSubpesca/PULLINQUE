...
{
    public partial class CierreForzadoResolucionAmerb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["idDocCierre"] != null)
                {
                    ...
                    {
                        Response.Redirect("administrarCierreForzadoAmerb.aspx");
                    }
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    resolucionCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.ACUICULTURA_EN_AMERB);
