...
{
    public partial class CierreForzadoResolucionRelocalizacionRESA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["idDocCierre"] != null)
                {
                    ...
                    {
                        Response.Redirect("administrarCierreForzadoRelocalizacionRESA.aspx");
                    }
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    resolucionCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA);
