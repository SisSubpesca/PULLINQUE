<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="CierreForzadoResolucionExperimentalesConcesion.aspx.cs" 
Inherits="SubPesca.CierreForzado.CierreForzadoResolucionExperimentalesConcesion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Cierre Forzado Experimentales Concesión - Resumen</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
                ...
                <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>              
                        ...
                        <tr style="display:none;">
                            ...
                            <td class="col3"><asp:Literal ID="InformeFlujoDocumental" runat="server"></asp:Literal></td>
                        </tr>
                        <tr style="display:none;">
                            <td class="col1"><span class="item">Tipo Entrada</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeTipoEntrada" runat="server"></asp:Literal></td>
                        </tr>
                        <tr style="display:none;">
                            <td class="col1"><span class="item">Origen</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeOrigen" runat="server"></asp:Literal></td>
                        </tr>
                        <tr style="display:none;">
                            <td class="col1"><span class="item">Tipo Documento</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeTipoDocumento" runat="server"></asp:Literal></td>
                        </tr>
                        <tr style="display:none;">
                            <td class="col1"><span class="item">Tema</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeTipo" runat="server"></asp:Literal></td>
                        </tr>
                        <tr>
                            <td class="col1"><span class="item">Número Informe</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeNumero" runat="server"></asp:Literal></td>
                        </tr>
                        <tr style="display:none;">
                            <td class="col1"><span class="item">Fecha</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeFecha" runat="server"></asp:Literal></td>
                        </tr>
                        <tr style="display:none;">
                            <td class="col1"><span class="item">Resultado</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:Literal ID="InformeResultado" runat="server"></asp:Literal></td>
                        </tr>
