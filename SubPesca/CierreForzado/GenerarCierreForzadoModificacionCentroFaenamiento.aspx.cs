...
{
    public partial class GenerarCierreForzadoModificacionCentroFaenamiento : System.Web.UI.Page
    {
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    TipoTramite.Items.Add(new ListItem("Trámite de Modificación Centro de Faenamiento", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO)));
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO);
            ...
            solicitudConcesion.tipoUnidadEspacial = new ParametroGenerico(rbTipo.CENTRO_DE_FAENAMIENTO);
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> resultadosLista = (List<SolicitudConcesion>)cierreForzadoService.ListarSolicitudFaenamientoCierreForzado(filtro);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.CENTRO_DE_FAENAMIENTO);
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoModificacionCentroFaenamiento.aspx");
