<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="GenerarCierreForzadoColectores.aspx.cs" 
Inherits="SubPesca.CierreForzado.GenerarCierreForzadoColectores" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Cierres Forzados Solicitudes de Colectores de Semilla</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <asp:Panel ID="FormularioBusqueda" runat="server" Visible="true">
        ...
        <table class="form" cellpadding="0px" cellspacing="0px">
            ...
            <asp:UpdatePanel ID="UpdatePanelIdentificadorSolicitud" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <asp:Panel ID="PanelIdentificadorSolicitud" Visible="true" runat="server">
                        <tr>
                ...
                <ContentTemplate>      
                    ...
                    <asp:GridView 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Identificador de la Solicitud">
                                <ItemTemplate>
