...
{
    public partial class administrarCierreForzadoAmerb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                if (PreviousPage != null && PreviousPage is GenerarCierreForzadoAmerb)
                {
                    MensajeSuperior.Text = ((GenerarCierreForzadoAmerb)PreviousPage).MensajeRegistro;
                ...
                if (PreviousPage != null && PreviousPage is CierreForzadoResolucionAmerb)
                {
                    MensajeSuperior.Text = ((CierreForzadoResolucionAmerb)PreviousPage).MensajeRegistro;
                    if (!MensajeSuperior.Text.Equals(""))
                    {
                        PanelMensajeSuperior.Visible = true;
                        UpdatePanelMensajeSuperior.Update();
        ...
        {
            System.Data.DataTable dataTableCierreForzado = cierreForzadoService.ListarDocGralCierreIT(idInforme, rbTipo.ACUICULTURA_EN_AMERB, rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB, numPert);
        ...
        protected void GridCierreForzado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_CIERRE_FORZADO_SOLICITUD_AMERB }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.ACCESO))
                    {
        ...
        protected void GridCierreForzado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "AsignarResolucionSSP":
                    ...
                    Response.Redirect("~/CierreForzado/CierreForzadoResolucionAmerb.aspx?idDocCierre=" + id);
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "cierreForzadoSolicitudAmerb";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "cierreForzadoSolicitudAmerb":
                    GridCierreForzado.Columns.RemoveAt(4);
                    grilla = GridCierreForzado;
                    ngrilla = "cierreForzadoSolicitudAmerb.xls";
                    break;
