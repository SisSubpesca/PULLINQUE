...
{
    public partial class GenerarCierreForzado : System.Web.UI.Page
    {
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    TipoTramite.Items.Add(new ListItem("Solicitud de Concesión", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_CONCESION_ACUICULTURA)));
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_CONCESION_ACUICULTURA);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (seleccionados == null || seleccionados.Count() == 0)
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_CONCESION_ACUICULTURA);
                    ...
                    if (var) {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzado.aspx");
