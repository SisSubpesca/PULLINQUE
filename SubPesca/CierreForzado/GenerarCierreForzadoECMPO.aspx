<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="GenerarCierreForzadoECMPO.aspx.cs" 
Inherits="SubPesca.CierreForzado.GenerarCierreForzadoECMPO" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Cierres Forzados ECMPO</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
