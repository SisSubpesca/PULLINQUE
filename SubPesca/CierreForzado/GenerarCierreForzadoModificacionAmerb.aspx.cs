...
{
    public partial class GenerarCierreForzadoModificacionAmerb : System.Web.UI.Page
    {
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                case "TipoTramite":
                    ...
                    TipoTramite.Items.Add(new ListItem("Trámite de Modificación Acuicultura en Amerb", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB)));
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            solicitudConcesion.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB);
            ...
            solicitudConcesion.tipoUnidadEspacial = new ParametroGenerico(rbTipo.ACUICULTURA_EN_AMERB);
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> resultadosLista = (List<SolicitudConcesion>)cierreForzadoService.ListarSolicitudAmerbCierreForzado(filtro);
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Page.IsValid)
                {
                    ...
                    docCierre.tipoUnidEspacial = new ParametroGenerico(rbTipo.ACUICULTURA_EN_AMERB);
                    docCierre.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB);
                    ...
                    if (var)
                    {
                        ...
                        Server.Transfer("~/CierreForzado/administrarCierreForzadoModificacionAmerb.aspx");
