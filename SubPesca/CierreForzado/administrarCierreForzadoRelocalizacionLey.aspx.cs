...
{
    public partial class administrarCierreForzadoRelocalizacionLey : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (PreviousPage != null && PreviousPage is GenerarCierreForzadoRelocalizacionLey)
                {
                    MensajeSuperior.Text = ((GenerarCierreForzadoRelocalizacionLey)PreviousPage).MensajeRegistro;
                ...
                if (PreviousPage != null && PreviousPage is CierreForzadoResolucionRelocalizacionLey)
                {
                    MensajeSuperior.Text = ((CierreForzadoResolucionRelocalizacionLey)PreviousPage).MensajeRegistro;
                    if (!MensajeSuperior.Text.Equals(""))
                    {
                        PanelMensajeSuperior.Visible = true;
                        UpdatePanelMensajeSuperior.Update();
        ...
        protected void CargaGrilla(int idInforme, string numPert)
        {
            ...
            System.Data.DataTable dataTableCierreForzado = cierreForzadoService.ListarDocGralCierreIT(idInforme, rbTipo.CONCESION_DE_ACUICULTURA, rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION, numPert);
        ...
        protected void GridCierreForzado_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_CIERRE_FORZADO_SOLICITUD_RELOCALIZACION_LEY }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.ACCESO))
                    {
        ...
        protected void GridCierreForzado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "AsignarResolucionSSP":
                    ...
                    Response.Redirect("~/CierreForzado/CierreForzadoResolucionRelocalizacionLey.aspx?idDocCierre=" + id);
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            switch (nom_grilla)
            {
                case "cierreForzadoSolicitudConcesion":
                    ...
                    ngrilla = "cierreForzadoRelocalizacionLey.xls";
                    break;
