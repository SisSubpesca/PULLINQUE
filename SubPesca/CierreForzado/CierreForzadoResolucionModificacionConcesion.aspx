<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="CierreForzadoResolucionModificacionConcesion.aspx.cs" 
Inherits="SubPesca.CierreForzado.CierreForzadoResolucionModificacionConcesion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Cierre Forzado Modificación Concesion - Resumen</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
