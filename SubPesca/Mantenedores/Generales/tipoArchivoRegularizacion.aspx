<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" Theme="admin_style" AutoEventWireup="true" CodeBehind="tipoArchivoRegularizacion.aspx.cs" Inherits="SubPesca.Mantenedores.Generales.tipoArchivoRegularizacion" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Tipo Archivo Coordenadas Regularización</span>
            </td>
    ...
    <legend>Datos de Tipo Archivo Coordenada</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style2"><span class="item">Tipo Archivo Coordenadas Regularización</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    
                    <asp:TextBox ID="nombre" runat="server" MaxLength="50" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Tipo Archivo Coordenadas Regularización" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
                <td class="style2">
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Tipo Archivo" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Tipo de Archivo" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
