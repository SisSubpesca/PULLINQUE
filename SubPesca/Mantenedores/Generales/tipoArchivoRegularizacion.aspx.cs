...
{
    public partial class tipoArchivoRegularizacion : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            parametroGenerico.clave = "TIPO_DOC_ANTEC_REGULARIZACION";
        ...
        protected void CargaGrilla()
        {
            ...
            parametroGenericoFiltro.clave = "TIPO_DOC_ANTEC_REGULARIZACION";
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "tipoArchivoRegularizacion";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "tipoArchivoRegularizacion":
                    ...
                    grilla = GridView1;
                    ngrilla = "tipoArchivoRegularizacion.xls";
                    break;
