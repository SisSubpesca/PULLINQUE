    <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="tipoContenedor.ascx.cs" Inherits="SubPesca.Mantenedores.Generales.tipoContenedor1" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de 
                <asp:Label ID="TipoGeneral" runat="server"></asp:Label>
                </span>
            </td>
    ...
    <fieldset>
    <legend>Datos del <asp:Label ID="TipoFormulario" runat="server"></asp:Label>
        </legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="col1">
                    <span class="item"><span class="item"><asp:Label ID="TipoCampo" runat="server"></asp:Label></span>
                </td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    
                    <asp:TextBox ID="nombre" runat="server" MaxLength="50" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para el campo" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
