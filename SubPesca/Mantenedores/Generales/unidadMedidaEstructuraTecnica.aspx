<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" Theme="admin_style" AutoEventWireup="true" CodeBehind="unidadMedidaEstructuraTecnica.aspx.cs" Inherits="SubPesca.Mantenedores.Generales.unidadMedidaEstructuraTecnica" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Unidad Medida Estructura</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de
                <span id="titulo_modulo0">Unidad Medida Estructura</span></legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style3"><span class="item">Nombre Unidad Medida Estructura</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    
                    <asp:TextBox ID="nombre" runat="server" MaxLength="50" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Nombre Unidad Medida Estructura" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
             <tr>
                <td class="style3"><span class="item">Sigla</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    
                    <asp:TextBox ID="sigla" runat="server" MaxLength="50" Width="83px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorsigla" runat="server" ControlToValidate="sigla" ValidationGroup="grupo1" ErrorMessage="Sigla" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
                <td class="style3">
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Nombre Unidad Medida Estructura" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                            <asp:Label ID="gNombre" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("descripcion")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Nombre Unidad Medida Estructura" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>

                        </EditItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Sigla" SortExpression="clave" ItemStyle-Width="458px">
                        <ItemTemplate>
                            <asp:Label ID="gClave" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("clave")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="geClave" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "clave") %>' MaxLength="30" Width="99%"></asp:TextBox>
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeClave" runat="server" ControlToValidate="geClave"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Sigla" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
