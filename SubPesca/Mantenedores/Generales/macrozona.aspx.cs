...
{
    public partial class macrozona : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            Macrozona macrozona = new Macrozona();
            macrozona.macrozona = nombre.Text.Trim();
            macrozona.regionMacrozona = new ParametroGenerico();
            macrozona.regionMacrozona.id = Convert.ToInt32(Region.SelectedValue);
            //macrozona.id_region = Convert.ToInt32(Region.SelectedValue);

            if (macrozona != null)
            {
                //Aqui se debe guardar la macrozona
                DataTable dt = mantenedorGeneralService.guardarMacrozona(macrozona);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "La macrozona '" + macrozona.macrozona + "' ha sido creada.";
                    ...
                    {
                        mensaje = "La macrozona '" + macrozona.macrozona + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear la macrozona.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar los datos de la macrozona.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            macrozonaFiltro.macrozona = nombre.Text;
            macrozonaFiltro.id_region = Convert.ToInt32(Region.SelectedValue);

            //Aquí se debe obtener la lista de las macrozonas
            List<Macrozona> dt = mantenedorGeneralService.listarMacrozona(macrozonaFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar la macrozona " + DataBinder.Eval(e.Row.DataItem, "macrozona") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            if (nombre.Text != "" && region.SelectedValue != "-1")
            {
                id = Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value);
                Agregar.Enabled = true;
                Update(id, nombre.Text, region.SelectedItem.Value);
            }
            else
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos de la macrozona.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre, string region)
        {
            Macrozona macrozona = new Macrozona();
            macrozona.id_macrozona = id;
            macrozona.macrozona = nombre.Trim();
            macrozona.regionMacrozona = new ParametroGenerico();
            macrozona.regionMacrozona.id = Convert.ToInt32(region);
            //macrozona.id_region = Convert.ToInt32(region);

            DataTable dt = mantenedorGeneralService.actualizarMacrozona(macrozona);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "La macrozona con ID:" + id + " ha sido actualizada.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "La macrozona '" + nombre + "' ya existe";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar la macrozona.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarMacrozona(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "La macrozona ha sido eliminada.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "La macrozona que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar la macrozona.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        {
            Macrozona macrozona = new Macrozona();
            macrozona.macrozona = nombre.Text;
            macrozona.id_region = Convert.ToInt32(Region.SelectedValue);
            
            if (macrozona != null)
            {
                List<Macrozona> dt = mantenedorGeneralService.listarMacrozona(macrozona);
