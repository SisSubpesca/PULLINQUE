...
{
    public partial class formaEstructura : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            ParametroGenerico formaEstructura = new ParametroGenerico();
            formaEstructura.descripcion = nombre.Text;


            if (formaEstructura != null)
            {

                DataTable dt = mantenedorGeneralService.guardarFormaEstructura(formaEstructura);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "El tipo forma estructura '" + formaEstructura.descripcion + "' ha sido creada.";
                    ...
                    {
                        mensaje = "El tipo forma estructura '" + formaEstructura.descripcion + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear el tipo forma estructura.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar tipo forma estructura.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            List<ParametroGenerico> dt = mantenedorGeneralService.listarFormaEstructura(parametroGenericoFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar el tipo forma estructura " + DataBinder.Eval(e.Row.DataItem, "descripcion") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos del tipo forma estructura.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre)
        {
            ...
            DataTable dt = mantenedorGeneralService.actualizarFormaEstructura(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "El tipo forma estructura con ID:" + id + " ha sido actualizada.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "El tipo forma estructura '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar el tipo forma estructura.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminaTipoFormaEstructura(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "El tipo forma estructura ha sido eliminada.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "El tipo forma estructura que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar el tipo forma estructura.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "formaEstructura";
            string ngrilla = "";
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (formaEstructura != null)
            {
                List<ParametroGenerico> dt = mantenedorGeneralService.listarFormaEstructura(formaEstructura);
