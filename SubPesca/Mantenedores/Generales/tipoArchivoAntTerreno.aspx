<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" Theme="admin_style" AutoEventWireup="true" CodeBehind="tipoArchivoAntTerreno.aspx.cs" Inherits="SubPesca.Mantenedores.Generales.tipoArchivoAntTerreno" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Tipo Archivo Coordenadas 14 TER</span>
            </td>
    ...
    <legend>Datos de Tipo Archivo Coordenada</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style2"><span class="item">Tipo Archivo Coordenadas 14 TER</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    
                    <asp:TextBox ID="nombre" runat="server" MaxLength="50" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Tipo Archivo Coordenadas 14 TER" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
                <td class="style2">
