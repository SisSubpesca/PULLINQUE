...
{
    public partial class huso : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            ParametroGenerico huso = new ParametroGenerico();
            huso.descripcion = nombre.Text.Trim();


            if (huso != null)
            {
                
                DataTable dt = mantenedorGeneralService.guardarHuso(huso);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "El huso '" + huso.descripcion + "' ha sido creado.";
                    ...
                    {
                        mensaje = "El huso '" + huso.descripcion + "' ya existe";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear el huso.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar un nombre de huso.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            ParametroGenerico husoFiltro = new ParametroGenerico();
            husoFiltro.descripcion = nombre.Text;

            //Aquí se debe obtener la lista de las huso
            List<ParametroGenerico> dt = mantenedorGeneralService.listarHuso(husoFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar el huso " + DataBinder.Eval(e.Row.DataItem, "descripcion") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos del huso.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre)
        {
            ...
            DataTable dt = mantenedorGeneralService.actualizarHuso(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "El huso con ID:" + id + " ha sido actualizado.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "El huso '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar el huso.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarHuso(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "El huso ha sido eliminado.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "El huso que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar el huso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        {
            ParametroGenerico huso = new ParametroGenerico();
            huso.descripcion = nombre.Text;

            if (huso != null)
            {
                List<ParametroGenerico> dt = mantenedorGeneralService.listarHuso(huso);
