...
{
    public partial class datum : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            parametroGenerico.clave = nombre.Text.Trim();


            if (parametroGenerico != null)
            {

                DataTable dt = mantenedorGeneralService.guardarDatum(parametroGenerico);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "El datum '" + parametroGenerico.clave + "' ha sido creado.";
                    ...
                    {
                        mensaje = "El datum '" + parametroGenerico.clave + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear el datum.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar un datum.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            List<ParametroGenerico> dt = mantenedorGeneralService.listarDatum(parametroGenericoFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar el datum " + DataBinder.Eval(e.Row.DataItem, "clave") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos del datum.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre)
        {
            ...
            parametroGenerico.clave = nombre.Trim();

            DataTable dt = mantenedorGeneralService.actualizarDatum(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "El datum con ID:" + id + " ha sido actualizada.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "El datum '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar el datum.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarDatum(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "El datum ha sido eliminada.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "El datum que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
        ...
        {
            ParametroGenerico parametroGenerico = new ParametroGenerico();
            parametroGenerico.clave = nombre.Text;

            if (parametroGenerico != null)
            {
                List<ParametroGenerico> dt = mantenedorGeneralService.listarDatum(parametroGenerico);
