<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="provincia.aspx.cs" Inherits="SubPesca.Mantenedores.Generales.provincia" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Provincia</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de Provincia</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorRegion" runat="server" ControlToValidate="Region" Display="Static" ErrorMessage="Región" ValidationGroup="grupo1" InitialValue="-1">*</asp:RequiredFieldValidator>
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Provincia" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Region" SortExpression="id_region" ItemStyle-Width="458px">
                         <ItemTemplate>
                            <asp:Label ID="gRegion" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("nombreReg")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            
                        <asp:DropDownList ID="ddleditCountry" runat="server" AutoPostBack="true" />
                        <asp:HiddenField ID="hdnCountry" runat="server" Value='<%#Eval("nombreReg") %>' />
                    ...
                    <asp:TemplateField HeaderText="Provincia" SortExpression="provincia" ItemStyle-Width="458px">
                        <ItemTemplate>
                            <asp:Label ID="gNombre" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("provincia")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="geNombre" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "provincia") %>' MaxLength="30" Width="99%"></asp:TextBox>
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Provincia" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
