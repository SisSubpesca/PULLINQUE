...
{
    public partial class unidadMedidaEstructuraTecnica : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            parametroGenerico.clave = sigla.Text.Trim(); ;

            if (parametroGenerico != null)
            {
                DataTable dt = mantenedorGeneralService.guardarUnidadMedidaEstructuraTecnica(parametroGenerico);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "La unidad de medida '" + parametroGenerico.descripcion + "' ha sido creada.";
                    ...
                    {
                        mensaje = "La unidad de medida '" + parametroGenerico.descripcion + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear la unidad de medida.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar los datos de la unidad de medida.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            parametroGenericoFiltro.clave = sigla.Text;

            List<ParametroGenerico> dt = mantenedorGeneralService.listarUnidadMedidaEstructuraTecnica(parametroGenericoFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar la unidad medida estructura técnica " + DataBinder.Eval(e.Row.DataItem, "descripcion") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            TextBox clave = (TextBox)GridView1.Rows[e.RowIndex].FindControl("geClave");

            if (nombre.Text != "")
            {
                id = Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value);
                Agregar.Enabled = true;
                Update(id, nombre.Text, clave.Text);
            }
            else
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos para la unidad medida estructura técnica.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre, string clave)
        {
            ParametroGenerico parametroGenerico = new ParametroGenerico();
            parametroGenerico.id = id;
            parametroGenerico.descripcion = nombre;
            parametroGenerico.clave = clave;

            DataTable dt = mantenedorGeneralService.actualizarUnidadMedidaEstructuraTecnica(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "La unidad de medida estructura técnica con ID:" + id + " ha sido actualizada.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "La unidad medida estructura técnica '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar la unidad medida estructura técnica.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarUnidadMedidaEstructuraTecnica(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "La unidad medida estructura técnica ha sido eliminada.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "La unidad medida estructura técnica que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar la unidad medida estructura técnica.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "unidadMedidaEstructuraTecnica";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "unidadMedidaEstructuraTecnica":
                    GridView1.Columns.RemoveAt(3);
                    grilla = GridView1;
                    ngrilla = "unidadMedidaEstructuraTecnica.xls";
                    break;
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            parametroGenerico.clave = sigla.Text;

            if (parametroGenerico != null)
            {
                List<ParametroGenerico> dt = mantenedorGeneralService.listarUnidadMedidaEstructuraTecnica(parametroGenerico);
