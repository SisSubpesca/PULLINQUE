...
{
    public partial class tipoArchivoAntTerreno : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            parametroGenerico.clave = "TIPO_DOC_ANTEC_TERRENO";
        ...
        protected void CargaGrilla()
        {
            ...
            parametroGenericoFiltro.clave = "TIPO_DOC_ANTEC_TERRENO";
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "tipoArchivo14TER";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "tipoArchivo14TER":
                    GridView1.Columns.RemoveAt(2);
                    grilla = GridView1;
                    ngrilla = "tipoArchivo14TER.xls";
                    break;
