...
{
    public partial class estadosUOT : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            if (parametroGenerico != null)
            {
                ...
                DataTable dt = mantenedorGeneralService.guardarEstadoUOT(parametroGenerico);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "El Estado UOT '" + parametroGenerico.descripcion + "' ha sido creado.";
                    ...
                    {
                        mensaje = "El Estado UOT '" + parametroGenerico.clave + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear el Estado UOT.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar un Estado UOT.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            //Aquí se debe obtener la lista de Estado UOT
            List<ParametroGenerico> dt = mantenedorGeneralService.listarEstadoUOT(parametroGenericoFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar el Estado UOT " + DataBinder.Eval(e.Row.DataItem, "clave") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos del Estado UOT.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre)
        {
            ...
            DataTable dt = mantenedorGeneralService.actualizarEstadoUOT(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "El Estado UOT con ID:" + id + " ha sido actualizado.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "El Estado UOT '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar el Estado UOT.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarEstadoUOT(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "El Estado UOT ha sido eliminado.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "El Estado UOT que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar el datum.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
            ...
            {
                mensaje = "Se ha producido un error al intentar eliminar el Estado UOT.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (parametroGenerico != null)
            {
                List<ParametroGenerico> dt = mantenedorGeneralService.listarEstadoUOT(parametroGenerico);
