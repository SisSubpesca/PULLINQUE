...
{
    public partial class tipoOrganizacion : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            parametroGenerico.id = 0;

            if (parametroGenerico != null)
            {
                DataTable dt = mantenedorGeneralService.guardarTipoOrganizacion(parametroGenerico);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "El tipo de organización '" + parametroGenerico.descripcion + "' ha sido creado.";
                    ...
                    {
                        mensaje = "El tipo de organización '" + parametroGenerico.descripcion + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear el tipo de organización.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar los datos del tipo de organización.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            List<ParametroGenerico> dt = mantenedorGeneralService.listarTipoOrganizacion(parametroGenerico);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar el tipo de organización " + DataBinder.Eval(e.Row.DataItem, "descripcion") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar un nombre de tipo de organización.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre)
        {
            ...
            DataTable dt = mantenedorGeneralService.actualizarTipoOrganizacion(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "El tipo de organización con ID:" + id + " ha sido actualizado.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "El tipo de organización '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar el tipo de organización.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarTipoOrganizacion(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "El tipo de organización ha sido eliminado.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "El tipo de organización que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar el tipo de organización.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "tipoOrganizacion";
            string ngrilla = "";
