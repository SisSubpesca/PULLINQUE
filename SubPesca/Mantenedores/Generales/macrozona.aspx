<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="macrozona.aspx.cs" Inherits="SubPesca.Mantenedores.Generales.macrozona" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Macrozona</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de Macrozona</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="col1">
                    <span class="item">Macrozona</span></td>
                <td class="col2">
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorNombre" runat="server" 
                        ControlToValidate="nombre" Display="Static" ErrorMessage="Macrozona" 
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    <asp:BoundField HeaderText="ID" DataField="id_macrozona" ReadOnly="true" ItemStyle-Width="60px" />
                    <asp:TemplateField HeaderText="Region" SortExpression="regionMacrozonaString" ItemStyle-Width="458px">
                         <ItemTemplate>
                            <asp:Label ID="gRegion" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("regionMacrozonaString")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            
                        <asp:DropDownList ID="ddleditCountry" runat="server" AutoPostBack="true" />
                        <asp:HiddenField ID="hdnCountry" runat="server" Value='<%#Eval("regionMacrozonaString") %>' />
                    ...
                    <asp:TemplateField HeaderText="Macrozona" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                            <asp:Label ID="gNombre" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("macrozona")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="geNombre" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "macrozona") %>' MaxLength="30" Width="99%"></asp:TextBox>
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Macrozona" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>

                        </EditItemTemplate>
                    </asp:TemplateField>                    
                    <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="60px">
                        <ItemTemplate>
                            <asp:ImageButton ID="gModificar" Visible="false" runat="server" CommandName="Edit" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id_macrozona") %>'
                                 ImageUrl="~/App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar" ToolTip="Modificar" />
                            <asp:ImageButton ID="gEliminar" Visible="false" runat="server" CausesValidation="false" CommandName="Eliminar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id_macrozona") %>'
