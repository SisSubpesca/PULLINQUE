<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master"  AutoEventWireup="true" CodeBehind="tipoArchivoAntEspaciales.aspx.cs" Inherits="SubPesca.Mantenedores.Generales.tipoArchivo" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Tipo Archivo Coordenadas Originales</span>
            </td>
    ...
    <legend>Datos de Tipo Archivo Coordenada</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style2"><span class="item">Tipo Archivo Coord. Originales</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    
                    <asp:TextBox ID="nombre" runat="server" MaxLength="50" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Tipo Archivo Coord. Originales" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
                <td class="style2">
