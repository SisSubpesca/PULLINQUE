<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verContactoTitular.aspx.cs" Inherits="SubPesca.Mantenedores.Titulares.verContactoTitular" 
...
<asp:ToolkitScriptManager ID="ToolkitScriptManageAdministracionContactos" runat="server"></asp:ToolkitScriptManager>
    ...
    <fieldset>
        ...
        <td class="col3">
            <asp:Label ID="rutTitular" runat="server"></asp:Label>
        </td>
        <td class="col3" align="left">Nombre</td>
        <td class="col3">:</td>
        <td class="col3">
            <asp:Label ID="nombreTitular" runat="server"></asp:Label>
        </td>  
        </tr>
    </table>
    </fieldset>
