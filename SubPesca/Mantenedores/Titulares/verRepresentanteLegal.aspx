<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="verRepresentanteLegal.aspx.cs" 
Inherits="SubPesca.Mantenedores.Titulares.verRepresentanteLegal" Theme="admin_style" %>
...
<asp:Content ID="FormularioIngresoSolicitante" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Ver Representante Legal</span>
            </td>
    ...
    <fieldset>
        ...
        <asp:Panel ID="PanelDatosTitular" Visible="true" runat="server">
            ...
            <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        ...
                        <td class="col3">
                            <asp:TextBox ID="RutPersona" MaxLength="8" Width="100px" runat="server" BackColor="#ddddee" ReadOnly="true"></asp:TextBox> - <asp:TextBox ID="DVPersona" MaxLength="1" Width="20px" runat="server" BackColor="#ddddee" ReadOnly="true"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="display:none">
                        <td class="col1" nowrap><span class="item">Tipo Representante Legal</span></td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3">
                            <asp:TextBox ID="TipoRepresentante" runat="server" BackColor="#ddddee" 
                                ReadOnly="true" Width="300px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="col1" nowrap>
                            <span class="item">Nombre del Representante Legal</span></td>
                        <td class="col2">
                            <span class="item">:</span></td>
                        <td class="col3">
                            <asp:TextBox ID="NombreSolicitante" runat="server" BackColor="#ddddee" 
        ...
        <asp:GridView 
           ...
           PagerStyle-CssClass="pgr"
           Width="100%"
           OnRowCreated="GridViewContactos_RowCreated"
           AllowPaging="True" PageSize="5" OnPageIndexChanging="GridViewContactos_PageIndexChanged">
       ...
       <asp:HiddenField ID="BackPage" runat="server" />
        ...
        <div id="verContactoRepresentanteLegal" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_verContactoRepresentanteLegal" CssClass="cerrar" OnClientClick="javascript:close_dialog('verContactoRepresentanteLegal');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                    <legend>Ver Contactos Representante Legal</legend>
                    <iframe id="iframe_verContactoRepresentanteLegal" src="" width="100%" height="249px" frameborder="0" scrolling="no"></iframe>
                </fieldset>
            </div>
        </div>
        </div>
