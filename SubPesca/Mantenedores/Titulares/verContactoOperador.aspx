<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="verContactoOperador.aspx.cs" Inherits="SubPesca.Mantenedores.Titulares.verContactoOperador" 
...
<asp:ToolkitScriptManager ID="ToolkitScriptManageAdministracionContactos" runat="server"></asp:ToolkitScriptManager>
    ...
    <fieldset>
        ...
        <td class="col3">
            <asp:Label ID="rutOperador" runat="server"></asp:Label>
        </td>
        <td class="col3" align="left">Nombre</td>
        <td class="col3">:</td>
        <td class="col3">
            <asp:Label ID="nombreOperador" runat="server"></asp:Label></td>
