<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="agregarRepresentanteLegal.aspx.cs" 
Inherits="SubPesca.Mantenedores.Titulares.agregarRepresentanteLegal" Theme="admin_style" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <asp:Content ID="FormularioAdministracionRepresentanteLegal" ContentPlaceHolderID="rightbody" runat="server">

    <asp:ToolkitScriptManager ID="ToolkitScriptManageAdministracionRepresentanteLegal" runat="server" EnableScriptGlobalization="true"></asp:ToolkitScriptManager>

    <!-- Título de la página -->
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo"><asp:Label ID="LabelAccion" runat="server"></asp:Label> Representante Legal</span>
            </td>
    ...
    <asp:ValidationSummary ID="ValidationSummaryIngresoRepresentanteLegal" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList" ValidationGroup="grupo1" />
    ...
    <asp:Panel ID="PanelTipoPersona" Visible="false" runat="server">
    <tr>
        <td class="col1"><span class="item">Tipo Representante Legal</span></td>
        <td class="col2"><span class="item">:</span></td>
        <td class="col3">
            
            <asp:DropDownList ID="TipoPersona" runat="server"></asp:DropDownList>
            
        </td>
    </tr>
    </asp:Panel>

    <asp:HiddenField ID="nombreRepresentanteLegalAnterior" runat="server" />
    ...
    <tr>
        ...
        <td class="col3">
            ...
            <asp:TextBox ID="NombreRepresentanteLegal" runat="server" Width="300px"></asp:TextBox>
            <asp:RequiredFieldValidator id="RequiredFieldValidatorNombreRepresentanteLegal" runat="server" ControlToValidate="NombreRepresentanteLegal"  ValidationGroup="grupo1" ErrorMessage="Nombre Representante Legal" Display="Static">*</asp:RequiredFieldValidator>
    ...
    <tr>
        ...
        <td class="col3">
            <asp:LinkButton ID="VerNombresPersona" 
                OnClientClick="javascript:abre_dialogo2('verNombres',document.getElementById('ctl00_rightbody_RutPersona').value,2)" 
   ...
   <asp:Panel ID="PanelArchivoAdjunto"  Visible="true" runat="server">
    ...
    <tr>
        ...
        <asp:Button ID="GuardarRepresentanteLegal" runat="server" ValidationGroup ="grupo1" CausesValidation="true"
                Text="Crear Representante Legal" onclick="GuardarRepresentanteLegal_Click" />
         
         <asp:Button ID="ModificarRepresentanteLegal" runat="server" Text="Modificar Representante Legal" 
                CausesValidation="true" ValidationGroup="grupo1" Visible="false" onclick="ModificarRepresentanteLegal_Click" 
                 />
                       
                </td>
        <td class="col2" colspan="5"><asp:Button ID="Cancelar" runat="server" 
