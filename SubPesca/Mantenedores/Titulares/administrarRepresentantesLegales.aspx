<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarRepresentantesLegales.aspx.cs" 
Inherits="SubPesca.Mantenedores.Titulares.administrarRepresentantesLegales" Theme="admin_style" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Administrar Representantes Legales</span>
            </td>
    ...
    <asp:Panel ID="PanelSolicitudesMsg"  CssClass="Content_msgGrilla" Visible="false" runat="server">
    ...
    <fieldset>
    <legend>Búsqueda de Representantes Legales</legend>
    
    <table class="form" cellpadding="0px" cellspacing="0px">
    <tr>
        <td class="col1"><span class="item">Rut Representante Legal</span></td>
    ...
    <tr>
        <td class="col1"><span class="item">Nombre Representante Legal</span></td>
        <td class="col2"><span class="item">:</span></td>
        <td class="col3" colspan="4">
            <asp:UpdatePanel ID="UpdatePanelNombreRepresentanteLegal" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
    ...
    <tr>
        ...
        <td class="col3">
            ...
            <asp:Button ID="Buscar" runat="server" Text="Buscar"  CausesValidation="true" 
                ValidationGroup="grupo1" onclick="Buscar_Click" />
        </td>
    </tr>
    </table>

    <asp:UpdatePanel ID="UpdatePanelRepresentanteLegal" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
                             
            <asp:Panel ID="PanelRepresentanteLegal"  Visible="true" runat="server">
                   
                 <asp:GridView ID="GridRepresentanteLegal"  
                       runat="server"
                       DataKeyNames="rutPersonaRepLegal"
                       AutoGenerateColumns="False" 
                       CellPadding="4" 
                       ForeColor="#333333" 
                       GridLines="None"
                       AllowPaging="True" PageSize="20" OnPageIndexChanging="GridRepresentanteLegal_PageIndexChanged"
                       OnRowCreated="GridRepresentanteLegal_RowCreated"
                       OnRowDataBound="GridRepresentanteLegal_RowDataBound"
                       OnRowCommand="GridRepresentanteLegal_RowCommand"
                       CssClass="mGrid"
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="120px">
                                <ItemTemplate>
                                    <asp:ImageButton ID="gVer" Visible="false" runat="server" CausesValidation="false" CommandName="Ver" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "rutPersonaRepLegal") %>'
                                    ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver" ToolTip="Ver" />

                                    <asp:ImageButton ID="gModificar" Visible="false" runat="server" CausesValidation="false" CommandName="Modificar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "rutPersonaRepLegal") %>'
                                    ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar" ToolTip="Modificar" />

                                    <asp:ImageButton ID="gNoVigente" Visible="false" runat="server" CausesValidation="false" CommandName="NoVigente" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "rutPersonaRepLegal") %>'
                                    ...
                                    <asp:ImageButton ID="gVigente" Visible="false" runat="server" CausesValidation="false" CommandName="Vigente" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "rutPersonaRepLegal") %>'
                                    ImageUrl="../../App_Themes/admin_style/images/unauth.png" Height="20px" AlternateText="Pasar a Vigente" ToolTip="Pasar a Vigente" />

                                    <asp:ImageButton ID="gBorrar" Visible="false" runat="server" CausesValidation="false" CommandName="Eliminar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "rutPersonaRepLegal") %>'
