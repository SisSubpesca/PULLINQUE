<%@ Page Language="C#" MasterPageFile="~/Mantenedores/SitioMantenedorTitulares.Master" AutoEventWireup="true" CodeBehind="asociarRepresentanteLegal.aspx.cs" 
Inherits="SubPesca.Mantenedores.Titulares.asociarRepresentanteLegal" Theme="admin_style" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Asociar Representante Legal</span>
            </td>
    ...
    <tr>
        ...
        <td class="col3">
            ...
            <asp:Button ID="BuscarRepresentante" runat="server" Text="Buscar" 
                CausesValidation="true" ValidationGroup="grupo1" 
                onclick="BuscarRepresentante_Click" />
            12345678-K
    ...
    <asp:Panel ID="PanelNombreRepresentanteLegal" Visible="false" runat="server">
    <table class="form" cellpadding="0px" cellspacing="0px">
    <tr>
        ...
        <td class="col3">
            ...
            <asp:TextBox ID="NombreRepresentanteLegal" runat="server" Width="300px" BackColor="#ddddee" ReadOnly></asp:TextBox>
    ...
    <tr runat="server" visible="false">
                           ...
                           <td class="col3">
                               ...
                               <asp:TextBox ID="TipoRepresentanteLegal" runat="server" BackColor="#ddddee" ReadOnly></asp:TextBox>
    ...
    <tr>
        <td class="col1">
            <asp:Button ID="AsociarRepresentante" runat="server" 
                Text="Asociar Representante Legal" onclick="AsociarRepresentante_Click" 
                style="width: 251px" CausesValidation="true" ValidationGroup="grupo2" /></td>
        <td class="col2" colspan="2">
            <asp:Button ID="Volver" runat="server" 
                Text="Volver" onclick="Volver_Click" /></td>
