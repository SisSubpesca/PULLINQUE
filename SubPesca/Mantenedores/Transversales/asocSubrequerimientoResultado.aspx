<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="asocSubrequerimientoResultado.aspx.cs" Inherits="SubPesca.Mantenedores.Transversales.asocDocumentoResultado" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Subrequerimiento - Resultado</span>
            </td>
    ...
    <fieldset>
    <legend>Asociación Subrequerimiento - Resultado</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style1"><span class="item">Subrequerimiento</span></td>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorSubrequerimiento" runat="server" 
                        ControlToValidate="Subrequerimiento" Display="Static" ErrorMessage="Nombre Subrequerimiento" 
                        ValidationGroup="grupo1" InitialValue="-1">*</asp:RequiredFieldValidator>
                </td>
                
            </tr>
             <tr>
                <td class="style1"><span class="item">Resultado</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    <asp:DropDownList ID="Resultado" runat="server"></asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorResultado" runat="server" 
                        ControlToValidate="Resultado" Display="Static" ErrorMessage="Resultado" 
                        ValidationGroup="grupo1" InitialValue="-1">*</asp:RequiredFieldValidator>
                </td>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Subrequerimiento" SortExpression="tipoString" ItemStyle-Width="458px">
                         <ItemTemplate>
                            <asp:Label ID="gSubrequerimiento" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("tipoString")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                             <asp:DropDownList ID="ddleditCountry" runat="server" AutoPostBack="true" />
                             
                             <asp:HiddenField ID="hdnCountry" runat="server" Value='<%#Eval("tipoString") %>' />
                    
                             <asp:RequiredFieldValidator id="RequiredFieldValidatorddleditCountry" runat="server" ControlToValidate="ddleditCountry"  ValidationGroup="grupo2" ErrorMessage="Seleccione valor para Subrequerimiento" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>

                        </EditItemTemplate>
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Resultado" SortExpression="resultadoString" ItemStyle-Width="458px">
                         <ItemTemplate>
                            <asp:Label ID="gResultado" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("resultadoString")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>

                             <asp:DropDownList ID="ddleditCountry2" runat="server" AutoPostBack="true" />
                             
                             <asp:HiddenField ID="hdnCountry2" runat="server" Value='<%#Eval("resultadoString") %>' />
                    
                             <asp:RequiredFieldValidator id="RequiredFieldValidatorddleditCountry2" runat="server" ControlToValidate="ddleditCountry2"  ValidationGroup="grupo2" ErrorMessage="Seleccione valor para Resultado" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>

                        </EditItemTemplate>
                    </asp:TemplateField> 
                    <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="60px">
                        <ItemTemplate>
                            <asp:ImageButton ID="gModificar" Visible="false" runat="server" CommandName="Edit" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idResultado") + ";" + DataBinder.Eval(Container.DataItem, "idTipo") %>'
                                 ImageUrl="~/App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Cambiar nombre" ToolTip="Cambiar nombre" />
                            <asp:ImageButton ID="gEliminar" Visible="false" runat="server" CausesValidation="false" CommandName="Eliminar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idResultado") + ";" + DataBinder.Eval(Container.DataItem, "idTipo") %>'
