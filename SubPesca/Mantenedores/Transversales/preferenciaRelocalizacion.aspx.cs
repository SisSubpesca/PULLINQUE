...
{
    public partial class preferenciaRelocalizacion : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            if (parametroGenerico != null)
            {
                ...
                DataTable dt = mantenedorGeneralService.guardarPreferenciaRelocalizacion(parametroGenerico);
                ...
                try
                {
                    ...
                    if (msg == "OK")
                    {
                        mensaje = "La preferencia de relocalización '" + parametroGenerico.descripcion + "' ha sido creada.";
                    ...
                    {
                        mensaje = "El nombre de preferencia de relocalización '" + parametroGenerico.descripcion + "' ya existe.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                    };
                }
                catch
                {
                    mensaje = "Se ha producido un error al intentar crear preferencia de relocalización.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            ...
            {
                mensaje = "Para agregar debe ingresar un nombre de preferencia de relocalización.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        protected void CargaGrilla()
        {
            ...
            //Aquí se debe obtener la lista de responsable dac
            List<ParametroGenerico> dt = mantenedorGeneralService.listarPreferenciaRelocalizacion(parametroGenericoFiltro);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar preferencia de relocalización " + DataBinder.Eval(e.Row.DataItem, "descripcion") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos de preferencia de relocalización.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string nombre)
        {
            ...
            DataTable dt = mantenedorGeneralService.actualizarPreferenciaRelocalizacion(parametroGenerico);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "La preferencia de relocalización con ID:" + id + " ha sido actualizada.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "La preferencia de relocalización '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar preferencia de relocalización.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarPreferenciaRelocalizacion(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "La preferencia de relocalización ha sido eliminado.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "La preferencia de relocalización que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar preferencia de relocalización.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "preferenciaRelocalizacion";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "preferenciaRelocalizacion":
                    GridView1.Columns.RemoveAt(2);
                    grilla = GridView1;
                    ngrilla = "preferenciaRelocalizacion.xls";
                    break;
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (parametroGenerico != null)
            {
                List<ParametroGenerico> dt = mantenedorGeneralService.listarPreferenciaRelocalizacion(parametroGenerico);
