<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="responsableDAC.aspx.cs" Inherits="SubPesca.Mantenedores.Transversales.responsableDAC" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Responsable DAC</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de Responsable DAC</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="col1"><span class="item">Responsable DAC</span></td>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Responsable DAC" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Responsable DAC" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
