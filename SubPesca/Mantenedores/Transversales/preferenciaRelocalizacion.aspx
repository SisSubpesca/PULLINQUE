<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="preferenciaRelocalizacion.aspx.cs" Theme="admin_style" Inherits="SubPesca.Mantenedores.Transversales.preferenciaRelocalizacion" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Preferencia Relocalización</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de Preferencia Relocalización</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                <td class="style2"><span class="item">Preferencia Relocalización</span></td>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Preferencia Relocalizacion" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Preferencia de Relocalización" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
