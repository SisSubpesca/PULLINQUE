<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="materia.aspx.cs" Inherits="SubPesca.Mantenedores.Transversales.materia" Theme="admin_style" %>
 ...
 <asp:Content ID="FormularioAdministracionMateriaSubrequerimiento" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Materia</span>
            </td>
    ...
    <legend>Datos de Materia</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
             <tr>
                <td class="col1"><span class="item">Nombre Materia</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    <asp:TextBox ID="nombre" runat="server" MaxLength="250" Width="400px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Nombre Materia" Display="Static">*</asp:RequiredFieldValidator>    
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    <asp:BoundField HeaderText="ID" DataField="id" ReadOnly="true" ItemStyle-Width="20px" />
                    
                    <asp:TemplateField HeaderText="Nombre Materia" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                            <asp:Label ID="gNombre" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("descripcion")) %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="geNombre" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "descripcion") %>' MaxLength="250" Width="99%"></asp:TextBox>
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Nombre Materia" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
                        </EditItemTemplate>
                    </asp:TemplateField>  
