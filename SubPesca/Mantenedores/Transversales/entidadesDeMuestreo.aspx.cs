...
{
    public partial class entidadesDeMuestreo : System.Web.UI.Page
    {
        ...
        protected void Agregar_Click(object sender, EventArgs e)
        {
            ...
            if (numEntidadMuestreo.Text != null && !numEntidadMuestreo.Text.Equals(""))
            {
                entidadMuestreador.numEntidad = Convert.ToInt32(numEntidadMuestreo.Text);
            }
            ...
            if (entidadMuestreador != null)
            {
                ...
                DataTable dt = mantenedorGeneralService.guardarEntidadDeMuestreo(entidadMuestreador);
        ...
        protected void CargaGrilla()
        {
            ...
            List<EntidadMuestreador> dt = mantenedorGeneralService.listarEntidadDeMuestreo(entidadMuestreador);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                {
                    boton_eliminar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro de eliminar la entidad de muestreo " + DataBinder.Eval(e.Row.DataItem, "razonSocial") + "?')");
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                Content_msgGrilla.Visible = true;
                msgGrilla.Text = "Para modificar debe ingresar los datos de la entidad de muestreo.";
            };
            CargaGrilla();
        ...
        protected void Update(int id, string razonSocial, string representanteLegal, string domicilio, string categoria, string numero, string fecha, string fechaIniVigencia, string fechaTerminoVigencia, string condVigencia, string correoElectronico, string telefono)
        {
            ...
            DataTable dt = mantenedorGeneralService.actualizarEntidadDeMuestreo(entidadMuestreador);
            ...
            try
            {
                ...
                if (msg == "OK")
                {
                    mensaje = "La entidad de muestreo:" + id + " ha sido actualizada.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                    GridView1.EditIndex = -1;
                }
                else
                {
                    mensaje = "La entidad de muestreo '" + nombre + "' ya existe.";
                    Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                };
            }
            catch
            {
                mensaje = "Se ha producido un error al intentar actualizar la entidad de muestreo.";
                Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
            };
        ...
        {
            DataTable dt = mantenedorGeneralService.eliminarEntidadDeMuestreo(id);
            ...
            try
            {
                ...
                {
                    case "OK":
                        mensaje = "La entidad de muestreo ha sido eliminado.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
                        break;
                    case "En uso":
                        mensaje = "La entidad de muestreo que intenta borrar está actualmente en uso.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                    default:
                        mensaje = "Se ha producido un error al intentar eliminar la entidad de muestreo.";
                        Ico_msgGrilla.ImageUrl = "~/App_Themes/admin_style/images/important.gif";
                        break;
                };
            }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "entidadDeMuestreo";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "entidadDeMuestreo":
                    GridView1.Columns.RemoveAt(12);
                    grilla = GridView1;
                    ngrilla = "entidadDeMuestreo.xls";
                    break;
