<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="entidadesDeMuestreo.aspx.cs" Inherits="SubPesca.Mantenedores.Transversales.entidadesDeMuestreo" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Entidades de Muestreo</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de Entidades de Muestreo</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
             <tr>
                <td class="col1"><span class="item">Número Entidad de Muestreo</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td>
                    <asp:TextBox ID="numEntidadMuestreo" runat="server" MaxLength="20" Width="100px"></asp:TextBox>
                    <asp:RequiredFieldValidator id="RequiredFieldValidatornumEntidadMuestreo" runat="server" 
                        ControlToValidate="numEntidadMuestreo"  ValidationGroup="grupo1" ErrorMessage="Número Entidad de Muestreo" 
                        Display="Static">*</asp:RequiredFieldValidator>
                    <asp:RangeValidator ID="RangeValidatornumEntidadMuestreo" runat="server" Type="Integer" 
                        MinimumValue="1" MaximumValue="1999999999" ControlToValidate="numEntidadMuestreo" 
                        ErrorMessage="Número con rango no permitido" ValidationGroup="grupo1" ForeColor="Red" />
                    <asp:CompareValidator ID="CompareValidatornumEntidadMuestreo" runat="server" Operator="DataTypeCheck" Type="Integer" 
                        ControlToValidate="numEntidadMuestreo" ErrorMessage="Número Entidad de Muestreo Ingrese valores numéricos" ValidationGroup="grupo1" ForeColor="Red" />
                </td>
            ...
            <tr>
                ...
                <td class="col2"><span class="item">:</span></td>
                <td>
                    <asp:TextBox ID="Telefono" runat="server" MaxLength="20" Width="100px"></asp:TextBox>
        ...
        <ContentTemplate>   
            ...
            <asp:Panel ID="PanelGridEntidadMuestreo"  Visible="true" runat="server" CssClass="Content_Grilla">                                          
                ...
                <Columns>
                    <asp:BoundField HeaderText="Numero Entidad Muestreo" DataField="numEntidad" ReadOnly="true" ItemStyle-Width="60px"/>
                    <asp:TemplateField HeaderText="Razon Social" SortExpression="razonSocial" ItemStyle-Width="600px">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Representante Legal" SortExpression="repLegal" ItemStyle-Width="600px">
                        <ItemTemplate>
