<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="resultado.aspx.cs" Inherits="SubPesca.Mantenedores.Transversales.resultado" Theme="admin_style" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Mantenedor de Resultado</span>
            </td>
    ...
    <fieldset>
    <legend>Datos de Resultados</legend>
        ...
        <table class="form" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNombre" runat="server" ControlToValidate="nombre" ValidationGroup="grupo1" ErrorMessage="Resultado" Display="Static">*</asp:RequiredFieldValidator>    
                </td>
            </tr>
            <tr>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Resultado" SortExpression="descripcion" ItemStyle-Width="458px">
                        <ItemTemplate>
                        ...
                        <EditItemTemplate>
                            ...
                            <asp:RequiredFieldValidator id="RequiredFieldValidatorgeNombre" runat="server" ControlToValidate="geNombre"  ValidationGroup="grupo2" ErrorMessage="Ingrese valor para Resultado" ForeColor="Red" Display="Static"></asp:RequiredFieldValidator>
