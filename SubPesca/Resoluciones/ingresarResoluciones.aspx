...
CodeBehind="ingresarResoluciones.aspx.cs" Inherits="SubPesca.Resoluciones.ingresarResoluciones" Theme="admin_style" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
            ...
            <ContentTemplate>                        
                <asp:Panel ID="PanelNumero"  Visible="true" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="Numero" autocomplete="tel-extension" runat="server" MaxLength="20"></asp:TextBox>&nbsp;<asp:Label ID="RequeridoNumero" runat="server"></asp:Label> * </td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
                            ...
                            <div class="calendario">
                                ...
                                <asp:Panel ID="PanelCalendarioFecha" Visible="true" runat="server">
                                    <div class="calendario_icono">
                                        <asp:Image src="../App_Themes/admin_style/images/calendar.png" id="imgFecha" alt="Calendario"  runat="server"  style="vertical-align: middle" />&nbsp;<asp:Label ID="RequeridoFecha" runat="server"></asp:Label>  *
                                    </div>
                                </asp:Panel>
            ...
            <ContentTemplate>                        
                <asp:Panel ID="PanelNumeroCI"  Visible="true" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="NumeroCI"  autocomplete="tel-extension" runat="server"  onKeyUp="return onlyNumeric(this)"  MaxLength="9"  AutoPostBack="true"></asp:TextBox>&nbsp;<asp:Label ID="RequeridoNumeroCI" runat="server"></asp:Label>&nbsp;<asp:Literal runat="server" ID="NumeroCIMensaje" Text=""></asp:Literal></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
        ...
        <ContentTemplate>                        
            <asp:Panel ID="Panel3"  Visible="true" runat="server">
                ...
                <tr>
                    ...
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:TextBox ID="NroDiarioOficial" runat="server" onChange="return onlyNumeric(this)" onKeyUp="return onlyNumeric(this)" MaxLength="9"></asp:TextBox>&nbsp;<asp:Label ID="RequeridoNroDiarioOficial" runat="server"></asp:Label></td>
                </tr>
                </table>
            </asp:Panel>
        </ContentTemplate>
                    ...
                    <tr>
                        ...
                        <td class="col3">
                            ...
                            <div class="calendario">
                                ...
                                <asp:Panel ID="PanelCalendarioFechaPrincipal" Visible="true" runat="server">
                                    <div class="calendario_icono">
                                        <asp:Image src="../App_Themes/admin_style/images/calendar.png"  id="imgFechaPrincipal" alt="Calendario" runat="server" style="vertical-align: middle" />&nbsp;<asp:Label ID="Label8" runat="server"></asp:Label>
                                    </div>
                                </asp:Panel>
        ...
        <ContentTemplate>                        
            <asp:Panel ID="PanelCodigoCentro"  Visible="false" runat="server">
                ...
                <tr>
                    ...
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:TextBox ID="CodigoCentro" runat="server" onKeyUp="return onlyNumeric(this)"  MaxLength="20" AutoPostBack="true" OnTextChanged="Identificador_TextChanged"></asp:TextBox>&nbsp;<asp:Label ID="Label3" runat="server"></asp:Label></td>
                </tr>
                </table>
            </asp:Panel>
        </ContentTemplate>
        ...
        <ContentTemplate>                        
            <asp:Panel ID="PanelNumeroPert"  Visible="false" runat="server">
                ...
                <tr>
                    ...
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:TextBox ID="NumeroPert" runat="server"  MaxLength="20" AutoPostBack="true" OnTextChanged="Identificador_TextChanged"></asp:TextBox>&nbsp;<asp:Label ID="Label4" runat="server"></asp:Label></td>
                </tr>
                </table>
            </asp:Panel>
        </ContentTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanelCentroRelocalizado" UpdateMode="Conditional" runat="server">
        <ContentTemplate>                        
            <asp:Panel ID="PanelCentroRelocalizado"  Visible="false" runat="server">
                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Código Centro Relocalizado</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:TextBox ID="CodigoCentroRelocalizado" runat="server" onKeyUp="return onlyNumeric(this)" MaxLength="20" AutoPostBack="true" OnTextChanged="Identificador_TextChanged"></asp:TextBox>&nbsp;<asp:Label ID="Label11" runat="server" CssClass="msgGrilla_div2" Text="(Solo para trámites de regularización que NO poseen Pert)"></asp:Label></td>
                </tr>
                </table>
            </asp:Panel>
        </ContentTemplate>
        ...
        <ContentTemplate>                        
            <asp:Panel ID="PanelNumeroIdentificador"  Visible="false" runat="server">
                ...
                <tr>
                    ...
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:TextBox ID="NumeroIdentificador" runat="server" onKeyUp="return onlyNumeric(this)" MaxLength="20" AutoPostBack="true" OnTextChanged="Identificador_TextChanged"></asp:TextBox>&nbsp;<asp:Label ID="Label5" runat="server"></asp:Label></td>
                </tr>
                </table>
            </asp:Panel>
        </ContentTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanelFechaNuevoVencimiento" UpdateMode="Conditional" runat="server">
        <ContentTemplate>                        
            <asp:Panel ID="PanelFechaNuevoVencimiento"  Visible="false" runat="server">
                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Nueva Fecha Vencimiento</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3">
                    
                       <div class="calendario">
                                <div class="calendario_textbox">               
                                <asp:TextBox ID="FechaNuevoVencimiento" Columns="8" Width="80px" runat="server"></asp:TextBox>
                                <asp:MaskedEditExtender ID="MaskedEditExtender9" runat="server" TargetControlID="FechaNuevoVencimiento"
                                    Mask="99/99/9999" MaskType="Date" CultureName="es-CL" CultureAMPMPlaceholder=""
                                    CultureDateFormat="DMY" CultureDatePlaceholder="/">
                                </asp:MaskedEditExtender>
                                </div>
                                ...
                                <asp:Panel ID="Panel4" Visible="true" runat="server">
                                    <div class="calendario_icono">
                                        <asp:Image src="../App_Themes/admin_style/images/calendar.png"  id="imgFechaNuevoVencimiento" alt="Calendario" runat="server" style="vertical-align: middle" />&nbsp;<asp:Label ID="Label9" runat="server"></asp:Label>
                                    </div>
                                </asp:Panel>
                                ...
                                runat="server"
                                ControlToValidate="FechaNuevoVencimiento"
                                ForeColor="Red"
                                ValidationExpression="^(0[1-9]|[12][0-9]|3[01])[-/.](0[1-9]|1[012])[-/.](19|20)\d\d$" 
                                ErrorMessage="Ingrese formato válido"
                                ValidationGroup="grupo1">
  ...
  <asp:UpdatePanel ID="UpdatePanelDatosCentro" UpdateMode="Conditional" runat="server">
        ...
        <ContentTemplate>                        
            <asp:Panel ID="PanelUnidadEspacial"  Visible="true" runat="server">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Código de Centro"           DataField="codigoCentro"                        ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" />
                    
                    <asp:TemplateField HeaderText="Pert" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"> 
                        <ItemTemplate>
                            <%# DataBinder.Eval(Container, "DataItem.numeroPert")%>
                        </ItemTemplate>
                    </asp:TemplateField> 

                    <asp:BoundField HeaderText="Número Identificador"       DataField="numeroIdentificador"                 ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"/>
                    <asp:BoundField HeaderText="Sector"                     DataField="DescripcionNumSector"                ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"/>
                    ...
                    <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="200px">
                        <ItemTemplate>
                            ...
                            <asp:ImageButton ID="gNoVigente" Visible="false" runat="server" CausesValidation="false" CommandName="NoVigente" CommandArgument='<%#  DataBinder.Eval(Container.DataItem, "idReferencia") %>'
                            ...
                            <asp:ImageButton ID="gVigente" Visible="false" runat="server" CausesValidation="false" CommandName="Vigente" CommandArgument='<%#  DataBinder.Eval(Container.DataItem, "idReferencia") %>'
    ...
    <asp:UpdatePanel ID="UpdatePanelTipoDocumentoReferencia" UpdateMode="Conditional" runat="server">
        <ContentTemplate>              
            <asp:Panel ID="PanelTipoDocumentoReferencia" Visible="true" runat="server">

                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Tipo Documento</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:DropDownList ID="TipoDocumentoReferencia" AutoPostBack="true" runat="server"></asp:DropDownList></td>
                </tr>
                </table>
    ...
    <asp:UpdatePanel ID="UpdatePanelTipoIngresoReferencia" UpdateMode="Conditional" runat="server">
        <ContentTemplate>              
            <asp:Panel ID="PanelTipoIngresoReferencia" Visible="true" runat="server">

                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Tipo Ingreso</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:DropDownList ID="TipoIngresoReferencia" AutoPostBack="true" runat="server"></asp:DropDownList></td>
                </tr>
                </table>
        ...
        <ContentTemplate>                        
            <asp:Panel ID="PanelNumeroReferencia"  Visible="true" runat="server">
                ...
                <tr>
                    <td class="col1"><span class="item">Número</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:TextBox ID="NumeroReferencia" runat="server" MaxLength="20"></asp:TextBox>&nbsp;<asp:Label ID="RequeridoNumeroReferencia" runat="server"></asp:Label> *</td>
                </tr>
                </table>
            </asp:Panel>
        </ContentTemplate>
    ...
    <tr>
        ...
        <td class="col2"></td>
        <td class="col3">
            <asp:Button ID="Guardar" runat="server" Text="Guardar"  CausesValidation="true" ValidationGroup="grupo1" OnClick="Guardar_Click"  />
        </td>
    </tr>
    </table>
