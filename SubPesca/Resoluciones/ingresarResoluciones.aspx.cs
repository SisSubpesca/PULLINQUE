...
{
    public partial class ingresarResoluciones : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string script = "calendario('" + FechaPrincipal.ClientID + "','" + imgFechaPrincipal.ClientID + "');";
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scriptCalentario" + FechaPrincipal.ClientID, script.ToString(), true);

            string script2 = "calendario('" + FechaNuevoVencimiento.ClientID + "','" + imgFechaNuevoVencimiento.ClientID + "');";
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scriptCalentario" + FechaNuevoVencimiento.ClientID, script2.ToString(), true);
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["idResolucion"] != null && Convert.ToInt32(Request.QueryString["idResolucion"]) > 0)
                {
                    ...
                    Titulo.Text = "Modificación de Resolución";
            ...
            if(PanelFormularioReferencia.Visible == true){
                script = "calendario('" + FechaReferencia.ClientID + "','" + imgFechaReferencia.ClientID + "');";
        ...
        protected void Initialize_Comboboxs()
        {
            ...
            Carga_Combobox("TipoIngresoReferencia");
            TipoIngresoReferencia.SelectedValue = "0";


            Carga_Combobox("TipoDocumentoReferencia");
            TipoDocumentoReferencia.SelectedValue = "0";
            ...
            switch (combobox)
            {
                ...
                case "Materia":
                    ...
                    if (Convert.ToInt32(TipoDocumento.SelectedValue) > 0 && Convert.ToInt32(Origen.SelectedValue) > 0)
                    {
                        ...
                        List<ParametroGenerico> sortList = new List<ParametroGenerico>();
                        ...
                        if (nodoMateria != null)
                        {
                            ...
                            {
                                sortList.Add(new ParametroGenerico(Convert.ToInt32(item.Key), Convert.ToString(((Combobox)item.Value).nombreAtributo)));
                        ...
                        if (sortList != null)
                        {
                            foreach (ParametroGenerico parametroGenerico in sortList)
                            {
                                Materia.Items.Add(new ListItem(Convert.ToString(parametroGenerico.descripcion), Convert.ToString(parametroGenerico.id)));
                            }
                        }
                    }
                ...
                case "Resultado":
                    ...
                    if (Convert.ToInt32(TipoDocumento.SelectedValue) > 0 && Convert.ToInt32(Origen.SelectedValue) > 0 && Convert.ToInt32(Materia.SelectedValue) > 0)
                    {
                        ...
                        if (nodoResultado != null)
                        {
                            ...
                            {
                                sortList.Add(new ParametroGenerico(Convert.ToInt32(item.Key), Convert.ToString(((ResolucionValidacion)item.Value).estadoMateria.descripcion)));
                            }
                        }
                        ...
                        if (sortList != null)
                        {
                            foreach (ParametroGenerico parametroGenerico in sortList)
                            {
                                Resultado.Items.Add(new ListItem(Convert.ToString(parametroGenerico.descripcion), Convert.ToString(parametroGenerico.id)));
                            }
                        }
                ...
                case "TipoDocumentoReferencia":


                    TipoDocumentoReferencia.Items.Clear();
                    if (campos != null)
                    {
                        foreach (DictionaryEntry item in campos)
                        {
                            TipoDocumentoReferencia.Items.Add(new ListItem(Convert.ToString(((Combobox)item.Value).nombreAtributo), Convert.ToString(item.Key)));
                        }
                    }
                    TipoDocumentoReferencia.DataBind();
                    TipoDocumentoReferencia.Items.Insert(0, new ListItem("-- Seleccione --", "0"));
                ...
                case "TipoIngresoReferencia":

                    TipoIngresoReferencia.Items.Clear();
                    TipoIngresoReferencia.DataSource = parametroDa.ListarTiposGenerico("paSelRbTipo", "@grupo", "TIPO_INGRESO_RESOL", "idTipo", "nombreTipo");
                    TipoIngresoReferencia.DataTextField = "descripcion";
                    TipoIngresoReferencia.DataValueField = "id";
                    TipoIngresoReferencia.DataBind();
                    TipoIngresoReferencia.Items.Insert(0, new ListItem("-- Seleccione --", "0"));
        ...
        protected void Tipo_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                TipoUnidadEspacial_SelectedIndexChanged(null, null);
                TipoSolicitud_SelectedIndexChanged(null, null);
        ...
        protected void TipoSolicitud_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            NumeroSector.Text = "";
            CodigoCentroRelocalizado.Text = "";
            FechaNuevoVencimiento.Text = "";
            titularesCAD.Text = "";
            regionCad.Text = "";
            toponimioCad.Text = "";
            ...
            if (Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA) //COLECTORES
            {
                ...
                PanelCentroRelocalizado.Visible = false;
                UpdatePanelCentroRelocalizado.Update();
                ...
                if ((Convert.ToInt32(Materia.SelectedValue) == rbMateria.RESUELVE_AMPLIACION_PLAZO_CARTA_MO || Convert.ToInt32(Materia.SelectedValue) == rbMateria.RESUELVE_AMPLIACION_PLAZO_CARTA_SEIA || Convert.ToInt32(Materia.SelectedValue) == rbMateria.RESUELVE_AMPLIACION_PLAZO_CARTA_RECOPILACION_CPS_E_INFAS) && Convert.ToInt32(Resultado.SelectedValue) == rbEstadosGenerales.APRUEBA)
                {
                    PanelFechaNuevoVencimiento.Visible = true;
                    UpdatePanelFechaNuevoVencimiento.Update();
                }

            }

            else if (Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION || Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA ) //Sector Relocalizacion
            {
                PanelCodigoCentro.Visible = false;
                UpdatePanelCodigoCentro.Update();
            ...
            else if (Convert.ToInt32(TipoSolicitud.SelectedValue) > 0)
            {
                ...
                if (Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB || Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO || Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO || Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO || Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_MODIFICACION) 
                {
                    PanelCentroRelocalizado.Visible = true;
                    UpdatePanelCentroRelocalizado.Update();
                }
            ...
            else
            {
                ...
                PanelFechaNuevoVencimiento.Visible = false;
                UpdatePanelFechaNuevoVencimiento.Update();
        ...
        protected void TipoUnidadEspacial_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(TipoUnidadEspacial.SelectedValue) == rbTipo.UNID_ESPACIAL_EXPERIMENTALES_AMERB || Convert.ToInt32(TipoUnidadEspacial.SelectedValue) == rbTipo.UNID_ESPACIAL_EXPERIMENTALES_CONCESION)
            {
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(TipoIngresoResolucion.SelectedValue) > 0)
            {
                resolucion.tipoIngreso = new ParametroGenerico(Convert.ToInt32(TipoIngresoResolucion.SelectedValue));
            }
            ...
            if (Convert.ToInt32(TipoRelacionDocumento.SelectedValue) == rbTipo.RESOLUCION_COMPLEMENTARIA)
            {
                ...
                if (Convert.ToInt32(TipoDocumentoPrincipal.SelectedValue) > 0)
                {
                    resolucion.resolucionPrincipal.tipoDocumento = new ParametroGenerico(Convert.ToInt32(TipoDocumentoPrincipal.SelectedValue));
                }

                if (Convert.ToInt32(OrigenPrincipal.SelectedValue) > 0)
                {
                    resolucion.resolucionPrincipal.origen = new ParametroGenerico(Convert.ToInt32(OrigenPrincipal.SelectedValue));
                }

                if (!NumeroPrincipal.Text.Trim().Equals(""))
                {
                    resolucion.resolucionPrincipal.numero = NumeroPrincipal.Text.Trim();
                }

                if (!FechaPrincipal.Text.Trim().Equals(""))
                {
                    resolucion.resolucionPrincipal.fecha = Convert.ToDateTime(FechaPrincipal.Text);
                }
            }
        ...
        protected void GridUnidadEspacial_Agregar(object sender, EventArgs e)
        {
            ...
            if (!CodigoCentroRelocalizado.Text.Trim().Equals(""))
            {
                newReferencia.codigoCentroRegularizado = CodigoCentroRelocalizado.Text;
            }

            if (!FechaNuevoVencimiento.Text.Trim().Equals(""))
            {
                newReferencia.fechaNuevoVencimiento = Convert.ToDateTime(FechaNuevoVencimiento.Text);
            }
        ...
        protected void GridReferencia_Agregar(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(TipoDocumentoReferencia.SelectedValue) > 0)
            {
                newReferencia.tipoDocResol = new ParametroGenerico(Convert.ToInt32(TipoDocumentoReferencia.SelectedValue), TipoDocumentoReferencia.SelectedItem.Text);
            }


            if (Convert.ToInt32(TipoIngresoReferencia.SelectedValue) > 0)
            {
                newReferencia.tipoIngresoResol = new ParametroGenerico(Convert.ToInt32(TipoIngresoReferencia.SelectedValue), TipoIngresoReferencia.SelectedItem.Text);
            }
            ...
            else
            {
                ...
                UpdatePanelTipoDocumentoReferencia.Update();
                UpdatePanelTipoIngresoReferencia.Update();
        ...
        public void Identificador_TextChanged(object sender, EventArgs e)
        {
            ...
            //SI ESCRIBIO EN EL CAMPO DE PARA BUSCAR REGULARIZACIONES SE BORRA LO QUE HAYA EN EL CAMPO PERT
            if (!CodigoCentroRelocalizado.Text.Trim().Equals("")) {
                NumeroPert.Text = "";
                UpdatePanelNumeroPert.Update();
            }
            ...
            if (Convert.ToInt32(Tipo.SelectedValue) == rbTipo.RESOLUCION_SUB_REFERENCIA_SOLICITUD) //SOLICITUDES
            {
                if (Convert.ToInt32(TipoSolicitud.SelectedValue) > 0)
                {
                    ...
                    else if (Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION && !NumeroPert.Text.Trim().Equals("") && !NumeroSector.Text.Trim().Equals("")) //Sector Relocalizacion LEY
                    {
                    ...
                    else if (Convert.ToInt32(TipoSolicitud.SelectedValue) == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA && !NumeroPert.Text.Trim().Equals("") && !NumeroSector.Text.Trim().Equals("")) //Sector Relocalizacion RESA
                    {

                        String pertRelocalizaciones = NumeroPert.Text.Trim() + "-" + NumeroSector.Text.Trim().ToString();

                        //VERIFICAR QUE EXISTA
                        SolicitudConcesion sol = resolucionService.VerificaExistenciaReferencia(Convert.ToInt32(Tipo.SelectedValue), 0, rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA, pertRelocalizaciones, Convert.ToInt32(NumeroSector.Text.Trim()));
                    ...
                    else if (!NumeroPert.Text.Trim().Equals("") || !CodigoCentroRelocalizado.Text.Trim().Equals(""))  //OTROS TIPOS DE SOLICITUDES
                    {
                        ...
                        if (!CodigoCentroRelocalizado.Text.Trim().Equals(""))
                        {
                            sol = resolucionService.VerificaExistenciaReferencia(Convert.ToInt32(Tipo.SelectedValue), 1, Convert.ToInt32(TipoSolicitud.SelectedValue), CodigoCentroRelocalizado.Text.Trim(), 0);
                        }
                        else
                        {

                            sol = resolucionService.VerificaExistenciaReferencia(Convert.ToInt32(Tipo.SelectedValue), 0, Convert.ToInt32(TipoSolicitud.SelectedValue), NumeroPert.Text.Trim(), 0);
                        }
            ...
            if (Convert.ToInt32(Tipo.SelectedValue) == rbTipo.RESOLUCION_SUB_REFERENCIA_UE) //CONCESIONES
            {
                if (Convert.ToInt32(TipoUnidadEspacial.SelectedValue) > 0)
                {
                    ...
                    else if (!CodigoCentro.Text.Trim().Equals("") || !NumeroPert.Text.Trim().Equals(""))  //OTROS TIPOS DE UNIDADES ESPACIALES
                    {
                        ...
                        if (!NumeroPert.Text.Trim().Equals(""))
                        {
                            sol = resolucionService.VerificaExistenciaReferencia(Convert.ToInt32(Tipo.SelectedValue), Convert.ToInt32(TipoUnidadEspacial.SelectedValue), 1, NumeroPert.Text.Trim(), 0);
                        }
                        else
                        {
                            sol = resolucionService.VerificaExistenciaReferencia(Convert.ToInt32(Tipo.SelectedValue), Convert.ToInt32(TipoUnidadEspacial.SelectedValue), 0, CodigoCentro.Text.Trim(), 0);
                        }
