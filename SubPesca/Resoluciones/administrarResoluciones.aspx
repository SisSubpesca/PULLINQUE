<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarResoluciones.aspx.cs" 
Inherits="SubPesca.Resoluciones.administrarResoluciones" Theme="admin_style" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Reference Page="ingresarResoluciones.aspx" %>
...
<fieldset>
        ...
        <legend>Administrador de Resoluciones</legend>
        <br />
                       ...
                       Width="100%">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Tipo de Documento">
                                <ItemTemplate>
                                     <asp:Label HeaderText="idArchivo" ID="gIDArchivo" runat="server" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem, "archivoAdjunto.idArchivo") %>'></asp:Label><asp:Label HeaderText="idEstadoVigencia" ID="gEstadoVigencia" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "vigencia.id") %>'></asp:Label><asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("tipoDocumento.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Origen">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("origen.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Numero">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Numero C.I.">
                                <ItemTemplate>
                                     <%# DataBinder.Eval(Container, "DataItem.numeroCI")%>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField HeaderText="Fecha C.I." DataField="fechaCIString" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" />
                            
                            <asp:TemplateField HeaderText="Resultado">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("resultado.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Numero Diario Oficial">
                                <ItemTemplate>
                                     <%# DataBinder.Eval(Container, "DataItem.numeroDiarioOficial")%>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField HeaderText="Fecha Diario Oficial" DataField="fechaDiarioOficialString" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" />

                            <asp:TemplateField HeaderText="Vigencia">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("vigencia.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:BoundField HeaderText="Fecha Inicio Plazo" DataField="fechaInicioPlazoString" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" />

                            <asp:BoundField HeaderText="Fecha Vencimiento" DataField="fechaVencimientoString" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" />

                            <asp:TemplateField HeaderText="Materia">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("materia.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Opciones" ItemStyle-Width="120px">
                                <ItemTemplate>
                                    
                                    <asp:ImageButton ID="gVer" Visible="true" runat="server" CausesValidation="false" CommandName="VerResolucion" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idResolucion") %>'
                                         ImageUrl="~/App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Resolución" ToolTip="Ver Resolución" />

                                    <asp:ImageButton ID="gModificar" Visible="true" runat="server" CausesValidation="false" CommandName="ModificarResolucion" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idResolucion") %>'
                                         ImageUrl="~/App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar Resolución" ToolTip="Modificar Resolución" />

                                    <asp:ImageButton ID="gDescargar" Visible="false" runat="server" CausesValidation="false" CommandName="DescargarArchivo" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "archivoAdjunto.idArchivo") %>'
                                    ...
                                    <asp:ImageButton ID="gEliminar" Visible="true" runat="server" CausesValidation="false" CommandName="EliminarResolucion" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idResolucion") %>'
                                         ImageUrl="~/App_Themes/admin_style/images/delete.png" Height="20px" AlternateText="Eliminar Resolución" ToolTip="Eliminar Resolución" />
