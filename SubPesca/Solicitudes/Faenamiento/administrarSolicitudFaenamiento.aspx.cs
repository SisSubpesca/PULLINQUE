...
{
    public partial class administrarSolicitudFaenamiento : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_SOLICITUD_FAENAMIENTO };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "Estado":
                    Estado.Items.Clear();
                    Estado.DataSource = reporteDA.ListarEstadosPorTipoTramite(37);
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudCentroFaenamientoAdmin(solicitudFiltro);
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "solicitudCentroFaenamiento";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudCentroFaenamiento":
                    GridSolicitudesAdm.Columns.RemoveAt(7);
                    grilla = GridSolicitudesAdm;
                    ngrilla = "solicitudCentroFaenamiento.xls";
                    break;
