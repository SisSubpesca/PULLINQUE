<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudFaenamiento.aspx.cs" 
Inherits="SubPesca.Solicitudes.Faenamiento.administrarSolicitudFaenamiento" Theme="admin_style" %>

<%@ Reference Page="inicioSolicitudFaenamiento.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Solicitudes de Centro de Faenamiento</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Solicitudes de Centro de Faenamiento</legend>
