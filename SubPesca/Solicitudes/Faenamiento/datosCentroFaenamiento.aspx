<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Solicitudes/SitioSolicitudesFaenamiento.Master" CodeBehind="datosCentroFaenamiento.aspx.cs"
 Inherits="SubPesca.Solicitudes.Faenamiento.datosCentroFaenamiento" Theme="admin_style"  %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Solicitud Centro de Faenamiento</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Solicitud Centro de Faenamiento</legend>
        ...
        <br /> 
                <table class="form" cellpadding="0px" cellspacing="0px">
                    ...
                    <asp:UpdatePanel ID="UpdatePanelTipoCentroFaenamiento" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="PanelTipoCentroFaenamiento" runat="server" Visible="true">
                        
                            <tr>
                               <td class="col1"><span class="item">Tipo Centro de Faenamiento</span></td>
                               <td class="col2"><span class="item">:</span></td>
                               <td class="col3"><asp:DropDownList ID="TipoCentroDeFaenamiento" runat="server"></asp:DropDownList></td>
                            </tr>
                    ...
                    <asp:UpdatePanel ID="UpdatePanelProfundidadMinima" UpdateMode="Conditional" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="PanelProfundidadMinima" runat="server" Visible="true">
                        
                            <tr>
                               <td class="col1"><span class="item">Profundidad min área solicitada</span></td>
                               <td class="col2"><span class="item">:</span></td>
                               <td class="col3"><asp:TextBox ID="ProdundidadMinima" runat="server"></asp:TextBox></td>
                            </tr>
