...
{
    public partial class menuSolicitudesModificacionCentroFaenamiento : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SolicitudConcesion solicitudConcesion = (SolicitudConcesion)Session[paginas.solicitudModificacionCentroFaenamientoSession];
            ...
            if (despliegueMenuSeccionList != null && despliegueMenuSeccionList.Count > 0)
            {
                ...
                {
                    if (solicitudModificacionService.esComunaFronteriza(solicitudConcesion.idSolConcesion))
                    {
                        Difrol.Visible = true;
                    }
                }
