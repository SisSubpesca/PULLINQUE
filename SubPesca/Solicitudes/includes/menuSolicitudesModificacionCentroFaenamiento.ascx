<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="menuSolicitudesModificacionCentroFaenamiento.ascx.cs" Inherits="SubPesca.Solicitudes.includes.menuSolicitudesModificacionCentroFaenamiento" %>
         ...
         <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav">
                <ul class="nav" id="Ul1">
                   ...
                   <li>
                        <a href="#"><i class="fa-fw"></i>Solicitud de Modificación de Centro de Faenamiento<span></span></a>
                        <ul class="nav nav-third-level">
                            <li ID="Li5" Visible="true" runat="server">
                               <a href="<% Response.Write(ResolveClientUrl("~/Solicitudes/ModificacionCentroFaenamiento/datosModificacionCentroFaenamiento.aspx")); %>" >Datos del Trámite de Modificación</a>
                           </li>
                           <li ID="Li1" Visible="true" runat="server">
                               <a href="<% Response.Write(ResolveClientUrl("~/Solicitudes/ModificacionCentroFaenamiento/identificacionTitularModificacionCentroFaenamiento.aspx")); %>" >Identificación del Titular</a>
                           </li>
                           ...
                           <li ID="Li6" Visible="true" runat="server">
                               <a href="<% Response.Write(ResolveClientUrl("~/Solicitudes/ModificacionCentroFaenamiento/unidadesEspacialesModificacionCentroFaenamiento.aspx")); %>">Modificación de Centro de Faenamiento</a>
                           </li>
                        </ul>
                   </li>
                </ul>
