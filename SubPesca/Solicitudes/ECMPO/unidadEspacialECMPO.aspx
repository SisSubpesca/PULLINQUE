<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Solicitudes/SitioSolicitudesECMPO.Master" CodeBehind="unidadEspacialECMPO.aspx.cs" 
Inherits="SubPesca.Solicitudes.ECMPO.unidadEspacialECMPO" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Creación de Acuicultura en ECMPO</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos de Acuicultura en ECMPO</legend>
        ...
        <br /> 
                        ...
                        <td class="col1" colspan="4" align="center">
                             ...
                             <asp:ImageButton ID="CrearConcesionButton" runat="server" 
                                 ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                                   AlternateText="Crear ECMPO" ToolTip="Crear Concesión" onclick="CrearConcesion_Click" 
                                   CausesValidation="true" ValidationGroup="grupo1" />
                            <span class="item">Crear ECMPO</span>&nbsp;&nbsp;<asp:ImageButton 
                ...
                <asp:Panel id="PanelMensajePendientes" runat="server" Visible="false">
                    <table class="form" cellpadding="0px" cellspacing="0px" width="100%">   
                    <tr>
                        <td class="col1" colspan="4" align="center"><span style="color:#772222;">Advertencia: Aun existen documentos pendientes que no permiten la Creación de la Acuicultura ECMPO, sin embargo puede guardar la información contenida en esta página (El Centro no se creará)</span></td>
                    </tr>
                    <tr>
