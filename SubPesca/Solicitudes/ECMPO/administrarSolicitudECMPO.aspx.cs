...
{
    public partial class administrarSolicitudECMPO : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINSITRAR_SOLICITUD_ECMPO };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "Estado":
                    Estado.Items.Clear();
                    Estado.DataSource = reporteDA.ListarEstadosPorTipoTramite(537);
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (!NumeroECMPO.Text.Trim().Equals(""))
            {
                solicitudFiltro.datosSolicitudUE = new DatosSolicitudUE();
                solicitudFiltro.datosSolicitudUE.ecmpoSSP = new DataExterna();
                solicitudFiltro.datosSolicitudUE.ecmpoSSP.codigo = Convert.ToInt32(NumeroECMPO.Text);
            }
            ...
            if (solicitudFiltro.fechaRangoFiltro1 != null && solicitudFiltro.fechaRangoFiltro2 != null)
            {
                ...
                {
                    Page.Validators.Add(new ValidationError("FormBusquedaECMPO", "\"Fecha Ingreso Trámite Desde\" debe ser posterior a \"Fecha Ingreso Trámite Hasta\""));
                ...
                else
                {
                    ...
                    {
                        Page.Validators.Add(new ValidationError("FormBusquedaECMPO", "El rango máximo de búsqueda es de 3 meses"));
                    }
                }
            }
            if (error.Length > 0)
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudECMPOAdmin(solicitudFiltro);
        ...
        protected void eliminarSolicitud(int idSolcon)
        {
            CommonService commonService = new CommonService();
            bool resp = commonService.EliminarSolicitudRel(idSolcon, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
