<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudECMPO.aspx.cs" 
Inherits="SubPesca.Solicitudes.ECMPO.administrarSolicitudECMPO" Theme="admin_style" %>

<%@ Reference Page="inicioSolicitudECMPO.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Solicitudes de Acuicultura en ECMPO</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <asp:UpdatePanel ID="UpdatePanelMensajesValidaciones" UpdateMode="Conditional" runat="server">
       <ContentTemplate>    
           <asp:panel ID="Panel1" runat="server">
                <asp:ValidationSummary ID="ValidationSummaryErrores" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList"   ValidationGroup="FormBusquedaECMPO" />
            </asp:panel>
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Solicitudes de Acuicultura en ECMPO</legend>
    ...
    <tr>
        <td class="col1"><span class="item">Numero ECMPO</span></td>
        <td class="col2"><span class="item">:</span></td>
        <td class="col3" colspan="4">
            <asp:UpdatePanel ID="UpdatePanelNumeroECMPO" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="NumeroECMPO" Width="80px" AutoPostBack="true" runat="server" onChange="return onlyNumeric(this)" onKeyUp="return onlyNumeric(this)" MaxLength="10"></asp:TextBox>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
                    ...
                    <asp:GridView ID="GridSolicitudesAdm"  
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Codigo ECMPO">
                                <ItemTemplate>
                                     <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode(Eval("datosSolicitudUE.ecmpoSSP.codigo")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
