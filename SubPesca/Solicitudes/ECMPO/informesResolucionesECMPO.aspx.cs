...
{
    public partial class informesResolucionesECMPO : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                PanelInforCart.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.ITC_UOT, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                PanelunidadDeDependencia.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.UNIDADES_DE_DEPENDENCIA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                PanelInspeccionTerreno.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.INSPECCION_TERRENO, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                PanelInspeccionTerrenoCoordenadas.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.COORDENADAS_GEOGRAFICAS_INSPECCION_TERRENO, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                //Banco Natural
                PanelLinkBancoNatural.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.BANCO_NATURAL, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);

                //Difusión Banco Natural
                PanelLinkDifusionBancoNatural.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DIFUSION_BANCO_NATURAL, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);

                //Difrol
                PanelLinkDifrol.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DIFROL, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                //Informe Ambiental
                PanelLinkInformeSEA.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.APLICA_SEA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);


                //Antecedentes Complementarios
                PanelAntecedentesComplementarios.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.ANTECEDENTES_COMPLEMENTARIOS, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                PanelCertificadoOperacion.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CERTIFICADO_REGISTRO_OPERACION, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                //Planos
                PanelPlanos.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.ANTECEDENTES_PLANOS, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                PanelPlanosInformeTecnicoUOT.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.INFORME_TECNICO_UOT, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                //Informe DAC
                PanelInformeDAC.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.INFORME_DAC, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                PanelInformeDACDevolucionJuridica.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DEVOLUCION_JURIDICA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                //Resolucion SSP
                PanelResolucionSSP.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.RESOLUCION_SSP, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                PanelResolucionSSPDevolucionSSFFAA.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DEVOLUCION_SSFFAA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                ...
                //Resolución SSFFAA
                PanelLinkResolucionSSFFAA.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.RESOLUCION_SSFFAA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
        ...
        protected void FlujoSEA_change(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(FlujoSEA.SelectedValue) == rbTipo.SOMETIMIENTO_SEA_SOMETE)
            {
                ...
                PanelInformeSEACartaTitular.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.ANTECEDENTES_AMBIENTALES, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO); ;
                PanelInformeSEARCA.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.RESOLUCION_CALIFICACION_AMBIENTAL, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO); ;
                PanelInformeSEAConsultaSEA.Visible = false;
                PanelInformeSEACartaAmbiental.Visible = false;
                PanelInformeSEAInformeUnidadAmbiental.Visible = false;
            }
            else if (Convert.ToInt32(FlujoSEA.SelectedValue) == rbTipo.SOMETIMIENTO_SEA_NO_SOMETE)
            {
                PanelInformeSEACartaTitular.Visible = false;
                PanelInformeSEARCA.Visible = false;
                PanelInformeSEAConsultaSEA.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.NOTIFICACION_SMA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO); ;
                PanelInformeSEACartaAmbiental.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.ANTECEDENTES_AMBIENTALES_MO, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO); ;
                PanelInformeSEAInformeUnidadAmbiental.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.INFORME_AMBIENTALES_MO, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
