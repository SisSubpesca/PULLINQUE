<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesECMPO.Master" AutoEventWireup="true" CodeBehind="datosCentroECMPO.aspx.cs" 
Inherits="SubPesca.Solicitudes.ECMPO.datosCentroECMPO" Theme="admin_style"  %>
...
<script type="text/javascript">
    ...
    function nuevaFuncion() {
        $("#<%=Ecmpo.ClientID%>").autocomplete('../ECMPO/SearchEcmpo_CS.ashx');
    }
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Solicitud de Acuicultura en ECMPO</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Solicitud <span id="titulo_modulo0">de Acuicultura</span> en ECMPO</legend>
...
<tr>
    ...
    <td class="col3">
        ...
        <asp:HiddenField ID="IdEcmpo" runat="server" Value="0"></asp:HiddenField>

        <asp:TextBox ID="Ecmpo" runat="server" Width="350px" 
            AutoCompleteType="Disabled" ontextchanged="Ecmpo_TextChanged"></asp:TextBox>
...
<asp:UpdatePanel ID="UpdatePanelECMPO" UpdateMode="Conditional" runat="server">
<ContentTemplate>
<asp:Panel ID="PanelECMPO" runat="server" Visible="false"> 
<tr>
    <td class="col1"><span class="item">Nombre ECMPO</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="Solicitud_Emcpo" runat="server"></asp:Label></td>
    <td class="col1"><span class="item">Comuna Indígena</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="ComunaIndigena" runat="server"></asp:Label></td>
</tr>
<tr>
    <td class="col1"><span class="item">Comuna</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="Comuna" runat="server"></asp:Label></td>
    <td class="col1"><span class="item">Región</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="Region" runat="server"></asp:Label></td>
</tr>
<tr>
    <td class="col1"><span class="item">Estado Tramitación</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="Estado" runat="server"></asp:Label></td>
    <td class="col1"><span class="item">Sector</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="sector" runat="server"></asp:Label></td>
</tr>
<tr>
    <td class="col1"><span class="item">N° Decreto</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="numDecreto" runat="server"></asp:Label></td>
    <td class="col1"><span class="item">Fecha Decreto</span></td>
    <td class="col2"><span class="item">:</span></td>
    <td class="col3"><asp:Label ID="fechaDecreto" runat="server"></asp:Label></td>
</tr>
</asp:Panel>
<asp:Panel ID="PaneGuardarBoton" runat="server" Visible="true"> 
<tr>
    <td class="col1"></td>
    <td class="col2"></td>
    <td class="col3"><asp:ImageButton ID="GuardarDatoEcmpo" runat="server" ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                                   AlternateText="Guardar Datos" ToolTip="Guardar Datos" onclick="GuardarDatosEcmpo_Click" 
                                   CausesValidation="true" ValidationGroup="grupo1" />
