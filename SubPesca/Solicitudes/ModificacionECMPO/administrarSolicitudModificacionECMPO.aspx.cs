...
{
    public partial class administrarSolicitudModificacionECMPO : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_SOLICITUD_MODIFICACION_ECMPO };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "SubtipoTramite":
                    ...
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación ECMPO: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_ECMPO_AMPLIA_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación ECMPO: Reducción de Superficie", Convert.ToString(rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación ECMPO: Especie", Convert.ToString(rbTipo.MOD_ECMPO_ESPECIE)));SubtipoTramite.Items.Insert(0, new ListItem("-- Seleccione --", "0"));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación ECMPO: Proyecto Técnico", Convert.ToString(rbTipo.MOD_ECMPO_PT)));UpdatePanelSubtipoTramite.Update();
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación ECMPO: Regularización", Convert.ToString(rbTipo.MOD_ECMPO_REGULARIZACION)));
        ...
        protected void GridSolicitudesAdm_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)Session["Filtro_SolicModificacionECMPO"];
            ...
            Session["Filtro_SolicModificacionECMPO"] = solicitudFiltro;
        ...
        protected void CargaGrilla()
        {
            ...
            solicitudFiltro.tipoUnidadEspacial = new ParametroGenerico(rbTipo.UNID_ESPACIAL_ECMPO);
            solicitudFiltro.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO);
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Ver":
                    ...
                    Session["SolicitudModificacionECMPO"] = (SolicitudConcesion)solicitudVer;
                    Response.Redirect("~/Solicitudes/ModificacionECMPO/identificacionTitularModificacionECMPO.aspx");
        ...
        protected void GridConcesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Redefinir":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/ModificacionECMPO/redefinirTramiteModificacionECMPO.aspx?idSolConces=" + idSolConces);
                    break;
        ...
        protected void GridConcesAdm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (boton_modificar != null)
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.INGRESAR_SOLICITUD_MODIFICACION_ECMPO }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.EDITAR))
                    {
