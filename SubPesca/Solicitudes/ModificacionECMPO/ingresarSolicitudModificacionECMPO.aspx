<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ingresarSolicitudModificacionECMPO.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionECMPO.ingresarSolicitudModificacionECMPO" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Nueva Solicitud de Modificación de ECMPO</span>
            </td>
        </tr>
    </table>
    <hr style="width:100%;" />
        ...
        <br />
            ...
            <tr>
                <td 
                        ...
                        <asp:CheckBox ID="Especie" runat="server" Text="Especie" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3">
                   
                        <asp:CheckBox ID="ProyectoTecnico" runat="server" Text="Proyecto Técnico" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3">
