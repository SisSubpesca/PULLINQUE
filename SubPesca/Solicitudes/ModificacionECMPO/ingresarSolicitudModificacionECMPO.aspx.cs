...
{
    public partial class ingresarSolicitudModificacionECMPO : System.Web.UI.Page
    {
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            SolicitudModificacionECMPOService solicitudModificacionECMPOService = new SolicitudModificacionECMPOService();
            ...
            solicitudInicial.tipoUnidadEspacial = new ParametroGenerico(rbTipo.UNID_ESPACIAL_ECMPO);
            solicitudInicial.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO);
            ...
            if (Especie.Checked)
            {
                solicitudInicial.tipoModificacionesTram.Add(new ParametroGenerico(rbTipo.MOD_ECMPO_ESPECIE));
            }

            if (ProyectoTecnico.Checked)
            {
                solicitudInicial.tipoModificacionesTram.Add(new ParametroGenerico(rbTipo.MOD_ECMPO_PT));
            }

            if (ampliacionSuperficie.Checked)
            {
                solicitudInicial.tipoModificacionesTram.Add(new ParametroGenerico(rbTipo.MOD_ECMPO_AMPLIA_SUPERFICIE));
            }

            if (reduccionSuperficie.Checked)
            {
                solicitudInicial.tipoModificacionesTram.Add(new ParametroGenerico(rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE));
            }

            if (regularizacion.Checked)
            {
                solicitudInicial.tipoModificacionesTram.Add(new ParametroGenerico(rbTipo.MOD_ECMPO_REGULARIZACION));
            }
            ...
            {
                if (solicitudModificacionECMPOService.guardarSolicitudModificacionECMPOInicial(solicitudInicial, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario))
                {
                    ...
                    solicitudDB.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO);


                    Session["SolicitudModificacionECMPO"] = (SolicitudConcesion)solicitudDB;
        ...
        protected void CodigoCentro_OnTextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Page.IsValid)
                {
                    List<String> listErroresSolicitudInicial = ingresarSolicitudModificacionValidacion.validaCodigoCentroECMPO(CodigoCentro.Text);
        ...
        protected void TitularCentro_OnTextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Page.IsValid)
                {
                    List<String> listErroresSolicitudInicial = ingresarSolicitudModificacionValidacion.validaTitularCentroECMPO(CodigoCentro.Text, TitularCentro.Text);
