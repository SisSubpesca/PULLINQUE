...
CodeBehind="datosModificacionECMPO.aspx.cs" Inherits="SubPesca.Solicitudes.ModificacionECMPO.datosModificacionECMPO" Theme="admin_style" %>
...
<asp:Content ID="FormularioIngresoSolicitante" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Datos del Trámite de Modificación ECMPO</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        ...
        <br />
            ...
            <asp:Panel ID="PanelSuperficieECMPO" Visible="true" runat="server">
            <table>
            <tr>
