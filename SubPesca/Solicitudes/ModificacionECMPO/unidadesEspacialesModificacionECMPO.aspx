...
CodeBehind="unidadesEspacialesModificacionECMPO.aspx.cs" Inherits="SubPesca.Solicitudes.ModificacionECMPO.unidadesEspacialesModificacionECMPO" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Modificación de Acuicultura en ECMPO</span>
            </td>
        </tr>
    </table>
        ...
        <tr>
           ...
           <asp:Panel ID="PanelModConcesion" Visible="false" runat="server">
                ...
                <tr>
                    ...
                    <td class="col2" colspan="2"><span class="item">:</span></td>
                    <td class="col3">
              ...
              <%--  <tr>
                    ...
                    <td class="col3">
                       ...
                       <asp:HiddenField ID="CapitaniaPuerto" runat="server"></asp:HiddenField>
                       <asp:TextBox ID="CapitaniaPuertoReadOnly" Width="300px" runat="server" ReadOnly="true" CssClass="campoDeshabilitado"></asp:TextBox> 
           ...
           <asp:Panel id="PanelBotonCreacion" runat="server" Visible="false">
               ...
               <asp:UpdatePanel ID="UpdatePanelGuardarUnidadEspacial" UpdateMode="Conditional" runat="server">
               <ContentTemplate>
               <asp:Panel ID="PanelGuardarUnidadEspacial" Visible="true" runat="server">
               <table class="form" cellpadding="0px" cellspacing="0px" width="100%">   
               <tr>
               ...
               <asp:Panel ID="PanelModificaConcesion" Visible="false" runat="server">
                   ...
                   <tr>
                        <td class="col1" colspan="4" align="center">
                            ...
                            AlternateText="Modificar ECMPO" ToolTip="Modificar Concesión" onclick="CrearConcesion_Click" 
                            CausesValidation="true" ValidationGroup="grupo1" style="width: 20px" />
                            <span class="item">Modificar ECMPO</span>
                        </td>
                    </tr>
                    </table>
