<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarSolicitudModificacionECMPO.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionECMPO.administrarSolicitudModificacionECMPO" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Solicitudes de Modificación ECMPO</span></td>
    </tr>
    </table>
    <hr style="width:100%;" />
        ...
        <ContentTemplate>      
                    ...
                    <asp:GridView ID="GridSolicitudesAdm"  
                       ...
                       <Columns>
                            ...
                            <asp:TemplateField HeaderText="Estado">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("estadoActual.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Estado">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("estadoActual.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Opciones" ItemStyle-Width="100px">
                                <ItemTemplate>
                    ...
                    <asp:GridView ID="GridViewRechazada"  
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Estado">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("estadoActual.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Estado">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("estadoActual.descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Opciones" ItemStyle-Width="100px">
                                <ItemTemplate>
