<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudExperimentalesConcesion.aspx.cs" 
Inherits="SubPesca.Solicitudes.ExperimentalesConcesion.administrarSolicitudExperimentalesConcesion" Theme="admin_style" %>

<%@ Reference Page="inicioSolicitudExperimentalesConcesion.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Solicitudes  
            Experimentales Concesión</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Solicitudes <span id="titulo_modulo0">Experimentales 
            <span id="titulo_modulo1">Concesión</span> </span></legend>
        ...
        <ContentTemplate>                        
            <asp:Panel ID="PanelEnTramite"  Visible="true" runat="server">
                    ...
                    <asp:GridView ID="GridSolicitudesAdm"  
                       ...
                       Width="100%">
                        <Columns>
                            <asp:TemplateField HeaderText="Num. Identificador Solicitud">
                                <ItemTemplate>
