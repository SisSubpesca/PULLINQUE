...
CodeBehind="datosCentroExperimentalesConcesion.aspx.cs" Inherits="SubPesca.Solicitudes.ExperimentalesConcesion.datosCentroExperimentalesConcesion" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Solicitud Experimentales Concesión</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Solicitud 
                <span id="titulo_modulo0">Experimentales Concesión</span></legend>
                ...
                <table class="form" cellpadding="0px" cellspacing="0px">
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="PanelCodigoCentro" runat="server" Visible="true">
                            ...
                            <tr>
                               <td class="col1"><span class="item">Codigo Centro</span></td>
                               <td class="col2"><span class="item">:</span></td>
                               <td class="col3"><asp:TextBox ID="CodigoCentro" MaxLength="10" Width="160px" runat="server" CausesValidation="false" ReadOnly="true" CssClass="campoDeshabilitado"></asp:TextBox></td>
                            </tr>
