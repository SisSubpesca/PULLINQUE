<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ingresarSolicitudRelocalizacionRESA.aspx.cs"
Inherits="SubPesca.Solicitudes.RelocalizacionRESA.ingresarSolicitudRelocalizacionRESA" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Trámite de Relocalización RESA Nº PERT: <asp:Label ID="numeroPert" runat="server"></asp:Label></span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanelDatosCentroSectorCero" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>   
                            <asp:Panel ID="PanelDatosCentroSectorCero" Visible="false" runat="server">
                                ...
                                <tr>
                                    <td class="col1"><span class="item">Informes Relocalización RESA</span></td>
                                    <td class="col2"><span class="item">:</span></td>
                                    <td class="col3" colspan="4"><span class="item"><asp:Label ID="informeRelocalizacionRESA" runat="server"></asp:Label></span></td>
                                </tr>
        ...
        <asp:UpdatePanel ID="UpdatePanelOrigen" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <asp:Panel ID="PanelOrigen"  Visible="false" runat="server">
                    ...
                    <asp:UpdatePanel id="panelMensajeOrigen" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:ValidationSummary ID="ValidationSummary3" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList" ValidationGroup="validacionOrigen" />
                    </ContentTemplate>
                    </asp:UpdatePanel>
                        ...
                        <tr>
                            ...
                            <td class="col3">
                                <asp:ListBox ID="preferencias" runat="server" SelectionMode="Multiple"></asp:ListBox>
                                  ...
                                  controltovalidate="preferencias"
                                  validationgroup="grupoOrigen"
                                  errormessage="Seleccione preferencia de relocalización"
                                  Display="None"
                                  runat="Server">
                                </asp:requiredfieldvalidator>
                            </td>
                            ...
                            <ContentTemplate>   
                                <asp:Panel ID="PanelDatosCentroOrigen" Visible="false" runat="server">
                                    ...
                                    <tr>
                                        <td class="col1"><span class="item">Informes Relocalización RESA</span></td>
                                        <td class="col2"><span class="item">:</span></td>
                                        <td class="col3" colspan="4"><span class="item"><asp:Label ID="informeRelocalizacionOrigenRESA" runat="server"></asp:Label></span></td>
                                    </tr>
                                        ...
                                        <ContentTemplate>   
                                            <asp:Panel ID="PanelDatosCentroDestino" Visible="false" runat="server">
                                                ...
                                                <tr>
                                                    <td class="col1"><span class="item">Informes Relocalización RESA</span></td>
                                                    <td class="col2"><span class="item">:</span></td>
                                                    <td class="col3" colspan="4"><span class="item"><asp:Label ID="informeRelocalizacionDestinoRESA" runat="server"></asp:Label></span></td>
                                                </tr>
    ...
    <fieldset>
        ...
        <tr>
            <td class="col1" align="center">
                ...
                <asp:Button ID="ButtonGuardarTramite" runat="server" Text="Guardar" 
                    CausesValidation="false" onclick="GuardarTramite_Click" style="height: 26px"  />
            </td>
        </tr>
        </table>
