<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesRelocalizacionRESA.Master" AutoEventWireup="true" CodeBehind="unidadEspacialRelocalizacionRESA.aspx.cs"
Inherits="SubPesca.Solicitudes.RelocalizacionRESA.unidadEspacialRelocalizacionRESA"  Theme="admin_style" %> 
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacialRelocalizacionRESA");
    </script>
