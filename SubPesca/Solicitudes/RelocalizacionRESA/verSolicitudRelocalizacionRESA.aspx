<%@ Page Language="C#"  MasterPageFile="~/Administrador/SitioAdmin.Master"  AutoEventWireup="true" CodeBehind="verSolicitudRelocalizacionRESA.aspx.cs" 
Inherits="SubPesca.Solicitudes.RelocalizacionRESA.verSolicitudRelocalizacionRESA" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Ver Trámite de Relocalización RESA Nº PERT: <asp:Label ID="numeroPert" runat="server"></asp:Label></span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
...
<asp:UpdatePanel ID="UpdatePanelMensajesValidaciones" UpdateMode="Conditional" runat="server">
   <ContentTemplate>    
    ...
    <fieldset>
        <legend>Trámite de Relocalización RESA</legend>
        <br />
            ...
            <ContentTemplate>
                ...
                <tr>
                    ...
                    <td class="col3">
                        ...
                        <asp:RadioButton Enabled="false" ID="esSectorCeroOpcion1" runat="server" GroupName="grupoSector0" Text="Si" AutoPostBack="true" OnCheckedChanged="esSectorCeroOpcionChecked"/>
                        <asp:RadioButton Enabled="false" ID="esSectorCeroOpcion2" runat="server" GroupName="grupoSector0" Text="No" AutoPostBack="true" OnCheckedChanged="esSectorCeroOpcionChecked"/>
            ...
            <ContentTemplate>
                <asp:Panel ID="PanelSectorCero"  Visible="false" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox  ID="CodigoSiepSectorCero"   runat="server" MaxLength="40" Columns="40" AutoPostBack="true" OnTextChanged="CodigoSiepSectorCero_OnTextChanged" ReadOnly="true"></asp:TextBox></td>
                    </tr>
                    </table>
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox  ID="HectareasSectorCero" MaxLength="10" Width="100px"  runat="server" ReadOnly="true"></asp:TextBox></td>
                    </tr>
                    </table>
                ...
                <asp:Panel ID="PanelOrigen"  Visible="false" runat="server">
                    ...
                    <asp:ValidationSummary ID="ValidationSummary1" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList" ValidationGroup="grupoOrigen" />
                        ...
                        <tr>
                            <td class="col1"><span class="item">Código del Centro</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:TextBox  ID="CodigoSiepOrigen" runat="server" ValidationGroup="grupoOrigen"  MaxLength="40" Columns="40" OnTextChanged="CodigoSiepOrigen_OnTextChanged" AutoPostBack="true" ReadOnly="true"></asp:TextBox></td>
                        </tr>
                        </table>
                        ...
                        <tr>
                            ...
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3"><asp:TextBox  ID="superficieRelocalizadaOrigen" MaxLength="10" Width="100px"  runat="server" ValidationGroup="grupoOrigen" ReadOnly="true"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="col1"><span class="item">Preferencia de Relocalización</span></td>
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3">
                                <asp:ListBox ID="preferencias" runat="server" SelectionMode="Multiple" Enabled="false"></asp:ListBox>
                            </td>
                        </tr>
                        </table>
                        ...
                        <asp:UpdatePanel ID="UpdatePanelBotonOrigen" UpdateMode="Conditional" runat="server">
                            <ContentTemplate>                        
                                <asp:Panel ID="PanelBotonOrigen"  Visible="false" runat="server">
                            ...
                            <ContentTemplate>                        
                                <asp:Panel ID="PanelGridOrigen"  Visible="true" runat="server">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="50px">
                                            <ItemTemplate>

                                                <asp:ImageButton ID="gModificar" Visible="true" runat="server" CausesValidation="false" CommandName="Modificar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "index") %>' 
                ...
                <asp:Panel ID="PanelDestino"  Visible="false" runat="server">
                    ...
                    <asp:ValidationSummary ID="ValidationSummary2" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList" ValidationGroup="grupoDestino" />
                        ...
                        <tr>
                            ...
                            <td class="col2"><span class="item">:</span></td>
                            <td class="col3">
                                <asp:RadioButton Enabled="false" ID="opcionCrea" runat="server" GroupName="grupoTipoRelocalizacion" Text="Crea"  AutoPostBack="true" OnCheckedChanged="tipoRelocalizacionOpcionChecked"  />
                                <asp:RadioButton Enabled="false" ID="opcionFusiona" runat="server" GroupName="grupoTipoRelocalizacion" Text="Fusiona"    AutoPostBack="true" OnCheckedChanged="tipoRelocalizacionOpcionChecked"/>
                            </td>
                        </tr>
                        </table>
                            ...
                            <ContentTemplate>
                                <asp:Panel ID="PanelCentroDestino"  Visible="false" runat="server" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="col2"><span class="item">:</span></td>
                                        <td class="col3"><asp:TextBox  ID="codigoSiepCentroDestino"   runat="server" MaxLength="40" Columns="40" OnTextChanged="CodigoSiepDestino_OnTextChanged" AutoPostBack="true" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                    </table>
        ...
        <asp:UpdatePanel ID="UpdatePanelBotonSector" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelBotonSector"  Visible="false" runat="server">
                    ...
                    <tr>
                        <td class="col1" align="center">
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                                AlternateText="Guardar Sector" ToolTip="Guardar Sector" onclick="GuardarSector_Click" />
