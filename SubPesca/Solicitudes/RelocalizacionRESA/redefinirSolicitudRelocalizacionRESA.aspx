<%@ Page Language="C#"  MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="redefinirSolicitudRelocalizacionRESA.aspx.cs" 
Inherits="SubPesca.Solicitudes.RelocalizacionRESA.redefinirSolicitudRelocalizacionRESA" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Redefinir Trámite de Relocalización RESA Nº PERT: <asp:Label ID="numeroPert" runat="server"></asp:Label></span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
