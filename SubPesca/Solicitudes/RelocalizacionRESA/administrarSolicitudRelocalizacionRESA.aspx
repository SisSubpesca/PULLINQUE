<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudRelocalizacionRESA.aspx.cs"
 Inherits="SubPesca.Solicitudes.RelocalizacionRESA.administrarSolicitudRelocalizacionRESA" Theme="admin_style" %>

<%@ Reference Page="erroresTramiteRelocalizacionRESA.aspx" %>
<%@ Reference Page="ingresarSolicitudRelocalizacionRESA.aspx" %>
<%@ Reference Page="redefinirSolicitudRelocalizacionRESA.aspx" %>
<%@ Reference Page="~/Solicitudes/Relocalizacion/ingresarSolicitudRelocalizacion.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Relocalizaci&oacute;n RESA</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Relocalizaci&oacute;n RESA</legend>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="120px">
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="gIntercambiar" Visible="false" runat="server" CausesValidation="false" CommandName="cambiarTipo" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idTramiteRel") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/exchange.png" Height="20px" AlternateText="Cambiar a Relocalizacion Ley" ToolTip="Cambiar a Relocalizacion Ley" />
