...
{
    public partial class identificacionSolicitanteRelocalizacionRESA : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.IDENTIFICACION_SOLICITANTE_RELOCALIZACION_CREA_RESA };
            }
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.IDENTIFICACION_SOLICITANTE_RELOCALIZACION_FUSIONA_RESA };
            }
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.IDENTIFICACION_SOLICITANTE_RELOCALIZACION_SECTOR_CERO_RESA };
            }
        ...
        protected void GridViewSolicitudesPendientes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            switch (e.CommandName)
            {
                case "Ver":
                    ...
                    Response.Redirect("~/Solicitudes/RelocalizacionRESA/verDocumentoRelocalizacionRESA.aspx?idRequerimiento=" + idRequerimiento);
        ...
        protected void GridSolicitante_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "Ver":
                    Response.Redirect("~/Mantenedores/Titulares/detalleTitular.aspx?rutPersona=" + e.CommandArgument + "&bp=54");
                    break;
            };
        }
