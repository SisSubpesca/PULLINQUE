<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="preIngresarSolicitudRelocalizacionRESA.aspx.cs" 
Inherits="SubPesca.Solicitudes.RelocalizacionRESA.preIngresarSolicitudRelocalizacionRESA" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Solicitud de Relocalización RESA</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
