...
{
    public partial class unidadEspacialRelocalizacionRESA : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.UNIDAD_ESPACIAL_RELOCALIZACION_CREA_RESA };
            }
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.UNIDAD_ESPACIAL_RELOCALIZACION_FUSIONA_RESA };
            }
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.UNIDAD_ESPACIAL_RELOCALIZACION_SECTOR_CERO_RESA };
            }
        ...
        {
            SolicitudConcesion solicitudRelocalizacion = (SolicitudConcesion)Session[ViewState["solicitudSession"].ToString()];
            ...
            if (solicitudRelocalizacion != null && solicitudRelocalizacion.idSolConcesion > 0)
            {
                ...
                //SECTOR
                DetalleSector aDetalleSector = relocalizacionRESAService.obtenerDetalleSector_SolicitudRESA(solicitudRelocalizacion.idSolConcesion);
                ...
                else
                {
                    ...
                    if (aDetalleSector.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_CREA_RESA && unidadEspacial.centrosDeCultivo != null)
                    {
        ...
        protected void VerificarCodigoCentro(object sender, EventArgs e)
        {
            ...
            if (!CodigoCentro.Text.Trim().Equals(""))
            {
                ...
                //SECTOR
                SolicitudConcesion solicitudRelocalizacion = (SolicitudConcesion)Session[paginas.solicitudRelocalizacionSessionRESA];
                DetalleSector aDetalleSector = relocalizacionRESAService.obtenerDetalleSector_SolicitudRESA(solicitudRelocalizacion.idSolConcesion);

                if (aDetalleSector != null && aDetalleSector.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_CREA_RESA)
                {
