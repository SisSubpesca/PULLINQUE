<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudModificacionCentroFaenamiento.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionCentroFaenamiento.administrarSolicitudModificacionCentroFaenamiento" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Solicitudes de Modificación de Centro de 
            Faenamiento</span>
        </td>
    </tr>
    </table>
                    ...
                    <asp:GridView ID="GridViewRechazada"  
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SubTipo Tramite">
                                <ItemTemplate>
                                     <asp:Label ID="Label1" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("tipoModificacionesTram[0].descripcion")) %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField HeaderText="Estado">
                                <ItemTemplate>
