<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ingresarSolicitudModificacionCentroFaenamiento.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionCentroFaenamiento.ingresarSolicitudModificacionCentroFaenamiento" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Nueva Solicitud de Modificación de Centro de Faenamiento</span>
            </td>
        </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <fieldset>
        ...
        <br />
            ...
            <tr>
                <td 
                        class="col1" rowspan="5"><span class="item">Tipo de Modificación</span></td><td class="col2" 
                        rowspan="5"><span class="item">:</span></td><td class="col3" align="left">
                   
                        <asp:CheckBox ID="Especie" runat="server" Text="Renovación" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3">
                   
                        <asp:CheckBox ID="ProyectoTecnico" runat="server" Text="Proyecto Técnico / Especie" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3">
                   
                        <asp:CheckBox ID="ampliacionSuperficie" runat="server" Text="Ampliación Superficie" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3">
                   
                        <asp:CheckBox ID="reduccionSuperficie" runat="server" Text="Reducción Superficie" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3">
                   
                        <asp:CheckBox ID="regularizacion" runat="server" Text="Regularización" oncheckedchanged="TiposModificacion_CheckedChanged" AutoPostBack="true" /></td>
            </tr>
            ...
            <tr>
                ...
                <td class="col3">
                    <asp:TextBox  ID="NumPert" runat="server" MaxLength="10" Columns="10" onKeyUp="return onlyNumeric(this);"></asp:TextBox> *
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorNumPert" runat="server" ControlToValidate="NumPert"  ValidationGroup="InicioModificacion"
                                 ErrorMessage="Ingrese Nº PERT" ForeColor="Red" Display="Static" InitialValue=""></asp:RequiredFieldValidator>

                    <asp:CompareValidator ID="CompareValidatorNumPert" ControlToValidate="NumPert" ForeColor="Red" Display="Dynamic" runat="server" ErrorMessage="El Nº PERT debe ser Numérico." Type="Integer" Operator="DataTypeCheck"></asp:CompareValidator>          
           ...
           <asp:UpdatePanel ID="UpdatePanelFechaDesde" UpdateMode="Conditional" runat="server">
            ...
            <td class="col3"><asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <div class="calendario">
                    <div class="calendario_textbox">               
            ...
            <ContentTemplate>
             <tr>
                <td class="col1"><span class="item">&nbsp;</span></td><td class="col2"><span class="item">&nbsp;</span></td><td 
                        class="col3"><span class="item"><asp:Button ID="Guardar" runat="server" 
                        Text="Generar"  CausesValidation="true" ValidationGroup="InicioModificacion" OnClientClick="return validatePre('InicioModificacion');"
                        onclick="Guardar_Click" /></span></td>
            </tr>
            </ContentTemplate>
            </asp:UpdatePanel>
            </asp:Panel>
