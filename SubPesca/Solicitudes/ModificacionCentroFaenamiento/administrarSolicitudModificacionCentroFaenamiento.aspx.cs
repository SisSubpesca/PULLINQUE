...
{
    public partial class administrarSolicitudModificacionCentroFaenamiento : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_SOLICITUD_MODIFICACION_FAENAMIENTO };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "SubtipoTramite":
                    ...
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Reducción de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Especie", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Proyecto Técnico", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Regularización", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)));
        ...
        protected void GridSolicitudesAdm_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)Session["Filtro_SolicModificacionCentroFaenamiento"];
            ...
            Session["Filtro_SolicModificacionCentroFaenamiento"] = solicitudFiltro;
        ...
        protected void CargaGrilla()
        {
            ...
            solicitudFiltro.tipoUnidadEspacial = new ParametroGenerico(rbTipo.UNID_ESPACIAL_MOD_CENTRO_FAENAMIENTO);
            solicitudFiltro.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO);
            ...
            if (respSolicitudesAutorizadas.Count > 0)
            {
            ...
            if (respSolicitudesRechazadas.Count > 0)
            {
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Ver":
                    ...
                    Session["SolicitudModificacionCentroFaenamiento"] = (SolicitudConcesion)solicitudVer;
                    Response.Redirect("~/Solicitudes/ModificacionCentroFaenamiento/identificacionTitularModificacionCentroFaenamiento.aspx");
        ...
        protected void GridConcesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Redefinir":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/ModificacionCentroFaenamiento/redefinirTramiteModificacionFaenamiento.aspx?idSolConces=" + idSolConces);
                    break;
                ...
                case "ErroresSolicitud":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/ModificacionCentroFaenamiento/erroresTramiteModificacionCentroFaenamiento.aspx?idSolConces=" + idSolConces);
                    break;
        ...
        private void eliminarSolicitudModificacion(int idSolConces)
        {
            ...
            bool resp = solicitudModificacionService.eliminarSolicitudModificacionFaenamiento(idSolConces, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
        ...
        protected void GridConcesAdm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (boton_modificar != null)
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.INGRESAR_SOLICITUD_MODIFICACION_FAENAMIENTO }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.EDITAR))
                    {
        ...
        protected void ExportarGrilla1_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "solicitudModificacionCentroFaenamientoEnTramite";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudModificacionCentroFaenamientoEnTramite":
                    GridConcesAdm.Columns.RemoveAt(10);
                    grilla = GridConcesAdm;
                    ngrilla = "solicitudModificacionCentroFaenamientoEnTramite.xls";
                    break;
        ...
        {
            GridView grilla = new GridView();
            string nom_grilla = "solicitudModificacionCentroFaenamientoAprobadas";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudModificacionCentroFaenamientoAprobadas":
                    GridSolicitudesAdm.Columns.RemoveAt(10);
                    grilla = GridSolicitudesAdm;
                    ngrilla = "solicitudModificacionCentroFaenamientoAprobadas.xls";
                    break;
        ...
        {
            GridView grilla = new GridView();
            string nom_grilla = "solicitudModificacionCentroFaenamientoRechazadas";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudModificacionCentroFaenamientoRechazadas":
                    GridViewRechazada.Columns.RemoveAt(10);
                    grilla = GridViewRechazada;
                    ngrilla = "solicitudModificacionCentroFaenamientoRechazadas.xls";
                    break;
