...
{
    public partial class informesResolucionesModificacionCentroFaenamiento : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (despliegueMenuSeccionList != null && despliegueMenuSeccionList.Count > 0)
                {
                    ...
                    if (PanelAntecedentesComplementarios.Visible || PanelCertificadoOperacion.Visible || PanelAntecedentesComplementariosObservacion.Visible)
                    {
        ...
        protected void FlujoSEA_change(object sender, EventArgs e)
        {
            ...
            List<DespliegueMenuSeccion> despliegueMenuSeccionList = despliegueMenuSeccionDA.ListarDespliegueMenuSeccion_UE(rbMenu.INFORME_AMBIENTAL_MODIFICACION, 0, rbTipo.UNID_ESPACIAL_MOD_CENTRO_FAENAMIENTO);
