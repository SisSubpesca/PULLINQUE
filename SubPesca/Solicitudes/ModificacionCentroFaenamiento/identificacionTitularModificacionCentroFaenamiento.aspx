<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionCentroFaenamiento.Master" CodeBehind="identificacionTitularModificacionCentroFaenamiento.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionCentroFaenamiento.identificacionTitularModificacionCentroFaenamiento" Theme="admin_style" %>
...
<asp:Content ID="FormularioIngresoSolicitante" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Identificación del Titular de Centro de Faenamiento</span>
            </td>
        </tr>
    </table>
    ...
    <asp:Panel ID="PanelDatosSolicitante" Visible="false" runat="server">
    ...
    <asp:Panel ID="PanelSolicitudesPendientes" Visible="false" runat="server">

    <fieldset>
        
        <legend>Solicitudes Pendientes asociadas a los Titulares</legend>
