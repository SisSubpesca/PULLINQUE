<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionCentroFaenamiento.Master" 
CodeBehind="antecedDelSectorModificacionCentroFaenamiento.aspx.cs" Inherits="SubPesca.Solicitudes.ModificacionCentroFaenamiento.antecedDelSectorModificacionCentroFaenamiento" Theme="admin_style" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
<%@ Register src="../Registrar/antecedDelSectorComponente.ascx" tagname="antecedDelSectorComponente" tagprefix="uc0" %>        
