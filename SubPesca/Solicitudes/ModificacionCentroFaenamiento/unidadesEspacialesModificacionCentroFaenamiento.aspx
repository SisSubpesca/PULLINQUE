<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionCentroFaenamiento.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesModificacionCentroFaenamiento.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionCentroFaenamiento.unidadesEspacialesModificacionCentroFaenamiento" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Modificación de Centro de Faenamiento</span>
            </td>
        </tr>
    </table>
               ...
               <ContentTemplate>
                   ...
                   <tr>
                        <td class="col1" colspan="4" align="center">
                            ...
                            AlternateText="Modificar Faenamiento" ToolTip="Modificar Concesión" onclick="CrearConcesion_Click" 
                            CausesValidation="true" ValidationGroup="grupo1" style="width: 20px" />
                            <span class="item">Modificar Faenamiento</span>
                        </td>
                    </tr>
                    </table>
    ...
    <script type="text/javascript">
        invoca_calendarios("modFaenamiento");
    </script>
