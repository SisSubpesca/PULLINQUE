<%@ Page Language="C#"  MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="redefinirTramiteModificacionFaenamiento.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionCentroFaenamiento.redefinirTramiteModificacionFaenamiento" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Redefinir Tr&aacute;mite de Modificac&oacute;n de Centro de Faenamiento</span>
            </td>
        </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <fieldset>
        ...
        <br />
            ...
            <tr>
                ...
                <td class="col3" align="left"><asp:CheckBox ID="Especie" runat="server" Text="Renovación" AutoPostBack="true"/></td>
            </tr>
            <tr>
                <td class="col3"><asp:CheckBox ID="ProyectoTecnico" runat="server" Text="Proyecto Técnico / Especie" AutoPostBack="true"/></td>
            </tr>
            <tr>
