<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesAcopio.Master" AutoEventWireup="true" 
CodeBehind="unidadEspacialAcopio.aspx.cs" Inherits="SubPesca.Solicitudes.Acopio.unidadEspacialAcopio" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Creación de Centro de Acopio</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        ...
        <br /> 
                        ...
                        <td class="col1" colspan="4" align="center">
                             ...
                             <asp:ImageButton ID="CrearConcesionButton" runat="server" 
                                 ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                                   AlternateText="Crear Acopio" ToolTip="Crear Concesión" onclick="CrearConcesion_Click" 
                                   CausesValidation="true" ValidationGroup="grupo1" style="width: 20px" />
                            <span class="item">Crear Acopio</span>&nbsp;&nbsp;<asp:ImageButton 
                ...
                <asp:Panel id="PanelMensajePendientes" runat="server" Visible="false">
                    <table class="form" cellpadding="0px" cellspacing="0px" width="100%">   
                    <tr>
                        <td class="col1" colspan="4" align="center"><span style="color:#772222;">Advertencia: Aun existen documentos pendientes que no permiten la Creación del Centro de Acopio, sin embargo puede guardar la información contenida en esta página (El Centro no se creará)</span></td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacialAcopio");
    </script>
