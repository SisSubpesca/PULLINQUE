<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="inicioSolicitudAcopio.aspx.cs" 
Inherits="SubPesca.Solicitudes.Acopio.inicioSolicitudAcopio" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <fieldset>
        <legend>Datos de la Solicitud de Centros de Acopio</legend>
        <br />
