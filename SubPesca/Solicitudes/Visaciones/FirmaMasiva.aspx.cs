...
{
    public partial class FirmaMasiva : System.Web.UI.Page
    {
        ...
        protected void CargaGrilla()
        {
            ...
            try
            {
                ...
                visacionMasivaFiltro.buscaVisaOFirma = 2; //busca firmas
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Page.IsValid)
                    {
                        ...
                        {
                            ((VisacionMasiva)itemSeleccionado.Value).esFirmaJefatura = true;
