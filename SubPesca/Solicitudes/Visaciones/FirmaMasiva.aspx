<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="FirmaMasiva.aspx.cs" 
Inherits="SubPesca.Solicitudes.Visaciones.FirmaMasiva" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Firma Masiva</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <asp:UpdatePanel ID="UpdatePanelMensajesValidaciones" UpdateMode="Conditional" runat="server">
     ...
     <asp:Panel ID="FormularioBusqueda" runat="server" Visible="true">
        ...
        <table class="form" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="col1"><span class="item">Tema Firma</span></td>
            <td class="col2"><span class="item">:</span></td>
            <td class="col3">
        ...
        <tr>
            ...
            <td class="col3">
                ...
                <asp:Panel ID="Panel2" CssClass="Content_msgGrilla_s" Visible="true" runat="server">
                      Información: Los Perts deben tener requerimientos de firma abiertos.
                </asp:Panel>
            </td>
        </tr>
        </table>
                ...
                <asp:TemplateField ItemStyle-Width="100px">
                    ...
                    <HeaderTemplate>
                        <asp:RadioButtonList RepeatLayout="Flow" RepeatDirection="Horizontal"  ID="chkboxSelectAll2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="chkboxSelectAll_CheckedChanged" CellPadding="0" CellSpacing="0" BorderWidth="0">
                            <asp:ListItem Value="1" Text="Firma"></asp:ListItem> <asp:ListItem Value="2" Text="Corrige"></asp:ListItem>
                        </asp:RadioButtonList>
                    </HeaderTemplate>
