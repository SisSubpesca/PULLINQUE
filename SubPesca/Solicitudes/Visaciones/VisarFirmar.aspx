<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="VisarFirmar.aspx.cs"
 Inherits="SubPesca.Solicitudes.Visaciones.VisarFirmar" Theme="admin_style" %> 
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Visar Masiva</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <asp:UpdatePanel ID="UpdatePanelMensajesValidaciones" UpdateMode="Conditional" runat="server">
     ...
     <asp:Panel ID="FormularioBusqueda" runat="server" Visible="true">
        ...
        <table class="form" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="col1"><span class="item">Tema Visación</span></td>
            <td class="col2"><span class="item">:</span></td>
            <td class="col3">
        ...
        <tr>
            ...
            <td class="col2"><span class="item"></span></td>
            <td class="col3">
                <asp:UpdatePanel ID="UpdatePanelMensajeVisacion14TER" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                <asp:Panel ID="PanelMensajeVisacion14TER" CssClass="Content_msgGrilla" Visible="false" runat="server">
        ...
        <tr>
            ...
            <td class="col3">
                ...
                <asp:Panel ID="Panel2" CssClass="Content_msgGrilla_s" Visible="true" runat="server">
                       Información: Los Perts deben tener requerimientos de visación abiertos.
                </asp:Panel>
            </td>
        </tr>
        </table>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridTramite" runat="server" 
                ...
                <asp:TemplateField ItemStyle-Width="100px">
                    ...
                    <HeaderTemplate>
                        <asp:RadioButtonList RepeatLayout="Flow" RepeatDirection="Horizontal"  ID="chkboxSelectAll2" runat="server" AutoPostBack="true" OnSelectedIndexChanged="chkboxSelectAll_CheckedChanged" CellPadding="0" CellSpacing="0" BorderWidth="0">
                            <asp:ListItem Value="1" Text="Visa"></asp:ListItem> <asp:ListItem Value="2" Text="Corrige"></asp:ListItem>
                        </asp:RadioButtonList>
                    </HeaderTemplate>
                    
                    <ItemTemplate>
                        <asp:RadioButtonList RepeatLayout="Flow" RepeatDirection="Horizontal" ID="chkEmp" runat="server">
                                <asp:ListItem Value="1" Text="Visa"></asp:ListItem> <asp:ListItem Value="2" Text="Corrige"></asp:ListItem>
                        </asp:RadioButtonList>
                        ...
                        <asp:HiddenField runat="server" ID="HiddenIdSubRequerimiento" Value='<%#Eval("requerimiento.id") %>' />
                    ...
                    <asp:TemplateField HeaderText="Requerimiento">
                        <ItemTemplate>
                            <%# System.Web.HttpUtility.HtmlEncode((string)Eval("requerimiento.descripcion"))%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Numero Pert/Identificador">
                        <ItemTemplate>
            ...
            <asp:Panel ID="PanelBotones" runat="server" Visible="false">
                ...
                <asp:Button ID="ButtonExportar" runat="server" Visible="false" Text="Exportar a Excel" CssClass="exportar_grilla" OnClick="ExportarGrillaReposicion_Click" /> 

                <asp:HiddenField ID="TipoTramiteHidden" runat="server" />
                <asp:HiddenField ID="TipoTramiteDescHidden" runat="server" />

                <asp:HiddenField ID="TipoVisacionHidden" runat="server" />
                <asp:HiddenField ID="TipoVisacionDescHidden" runat="server" />
