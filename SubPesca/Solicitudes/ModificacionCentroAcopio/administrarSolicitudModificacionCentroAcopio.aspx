<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarSolicitudModificacionCentroAcopio.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionCentroAcopio.administrarSolicitudModificacionCentroAcopio" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Solicitudes de Modificación de Centro de Acopio</span></td>
    </tr>
    </table>
    <hr style="width:100%;" />
