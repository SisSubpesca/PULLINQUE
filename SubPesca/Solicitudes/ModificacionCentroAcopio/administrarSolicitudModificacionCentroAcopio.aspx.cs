...
{
    public partial class administrarSolicitudModificacionCentroAcopio : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_SOLICITUD_MODIFICACION_CENTRO_DE_ACOPIO };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "SubtipoTramite":
                    ...
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Reducción de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Especie", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Proyecto Técnico", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Regularización", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)));
        ...
        protected void GridSolicitudesAdm_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)Session["Filtro_SolicModificacionCentroAcopio"];
            ...
            Session["Filtro_SolicModificacionCentroAcopio"] = solicitudFiltro;
        ...
        protected void CargaGrilla()
        {
            ...
            solicitudFiltro.tipoUnidadEspacial = new ParametroGenerico(rbTipo.UNID_ESPACIAL_MOD_CENTRO_ACOPIO);
            solicitudFiltro.tipoTramite = new ParametroGenerico(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO);
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Ver":
                    ...
                    Session["SolicitudModificacionCentroAcopio"] = (SolicitudConcesion)solicitudVer;
                    Response.Redirect("~/Solicitudes/ModificacionCentroAcopio/identificacionTitularModificacionCentroAcopio.aspx");
        ...
        protected void GridConcesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Redefinir":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/ModificacionCentroAcopio/redefinirTramiteModificacionAcopio.aspx?idSolConces=" + idSolConces);
                    break;
                ...
                case "ErroresSolicitud":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/ModificacionCentroAcopio/erroresTramiteModificacionCentroAcopio.aspx?idSolConces=" + idSolConces);
                    break;
        ...
        private void eliminarSolicitudModificacion(int idSolConces)
        {
            ...
            bool resp = solicitudModificacionService.eliminarSolicitudModificacionAcopio(idSolConces, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
        ...
        protected void GridSolicitudesAdm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (boton_eliminar != null)
                {
                    ...
                    {
                        boton_eliminar.Attributes.Add("onclick", "javascript:return" + "confirm('¿Está seguro que desea eliminar la Solicitud de Modificación?')");
        ...
        protected void GridConcesAdm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (boton_modificar != null)
                {
                    if (permisosService.tieneAccesoA2(new int[] { rbSeccionUnidadEspacial.INGRESAR_SOLICITUD_MODIFICACION_CENTRO_DE_ACOPIO }, (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.EDITAR))
                    {
