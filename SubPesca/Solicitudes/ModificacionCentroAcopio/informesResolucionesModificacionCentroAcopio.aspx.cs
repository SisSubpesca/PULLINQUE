...
{
    public partial class informesResolucionesModificacionCentroAcopio : System.Web.UI.Page
    {
        ...
        protected void FlujoSEA_change(object sender, EventArgs e)
        {
            ...
            List<DespliegueMenuSeccion> despliegueMenuSeccionList = despliegueMenuSeccionDA.ListarDespliegueMenuSeccion_UE(rbMenu.INFORME_AMBIENTAL_MODIFICACION, 0, rbTipo.UNID_ESPACIAL_MOD_CENTRO_ACOPIO);
