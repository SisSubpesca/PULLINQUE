<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="bancoNatural.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.bancoNatural" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="../Registrar/checkRequiereBancoNatural.ascx"                        tagname="checkRequiereBancoNatural"                           tagprefix="uc0" %>

<!-- check requiere banco natural -->
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
<ContentTemplate> 

        <asp:Panel ID="Panel2"  Visible="true" runat="server">
            <uc0:checkRequiereBancoNatural ID="checkRequiereBancoNatural" runat="server" />
        </asp:Panel>
