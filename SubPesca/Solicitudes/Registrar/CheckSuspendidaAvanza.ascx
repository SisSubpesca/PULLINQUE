<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckSuspendidaAvanza.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.CheckSuspendidaAvanza" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Solicitud Suspendida Continúa Tramitación</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Continuar Tramitación de Solicitud Suspendida?</span></td>
