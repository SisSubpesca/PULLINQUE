<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkRechazoExpConcesion.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkRechazoExpConcesion" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Decisión Sectorialista Rechazo</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Decisión Sectorialista Rechaza por Carta o Resolución</span></td>
