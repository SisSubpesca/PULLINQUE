<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkDecisionUGP.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkDecisionUGP" %>
    ...
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <tr>
                    <td class="col1"><span class="item">Avanza el Trámite</span></td>
