<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkAvanzaSMA.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkAvanzaSMA" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Avanzar sin esperar respuesta de la SMA</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Avanzar sin esperar respuesta de la SMA?</span></td>
