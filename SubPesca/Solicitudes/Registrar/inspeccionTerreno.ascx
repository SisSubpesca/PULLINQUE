<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="inspeccionTerreno.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.inspeccionTerreno" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="../Registrar/checkRequiereInspeccionTerreno.ascx"                        tagname="checkRequiereInspeccionTerreno"                           tagprefix="uc0" %>

<!-- check requiere inspeccion de terreno -->
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
<ContentTemplate> 

        <asp:Panel ID="Panel2"  Visible="true" runat="server">
            <uc0:checkRequiereInspeccionTerreno ID="checkRequiereInspeccionTerreno" runat="server" />
        </asp:Panel>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Inspección en Terreno</legend>
        <br />
            ...
            <ContentTemplate>                        
                <asp:Panel ID="PanelTipoDocumento"  Visible="false" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:DropDownList ID="TipoDocumento" AutoPostBack="true" runat="server" OnSelectedIndexChanged="TipoDocumento_change"></asp:DropDownList> *
                        </td>
                    </tr>
                    </table>
                </asp:Panel>
