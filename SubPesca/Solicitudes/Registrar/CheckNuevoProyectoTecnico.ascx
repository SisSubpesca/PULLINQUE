<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckNuevoProyectoTecnico.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.CheckNuevoProyectoTecnico" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Requerimiento de nuevo Proyecto Técnico</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Se Requiere el ingreso de un nuevo proyecto Técnico</span></td>
