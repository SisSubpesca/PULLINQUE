<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkDecisionUGPMulltiple.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkDecisionUGPMulltiple" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Decisión Sectorialista UGP</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Tipo de Flujo a seguir</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3" style="margin-left: 40px">
                        <span class="item">
                            <asp:DropDownList ID="CheckCombo" AutoPostBack="true" runat="server"></asp:DropDownList> 
                        </span>
                    </td>
                </tr>
                <tr>
