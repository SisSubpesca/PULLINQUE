<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkPlanos.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkPlanos" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Decisión IT UOT Planos</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Requiere nuevo IT UOT Planos 14 ter?</span></td>
