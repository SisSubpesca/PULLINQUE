<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="resolucionSSPDevolucionSSFFAA.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.resolucionSSPDevolucionSSFFAA" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="../Registrar/checkDevolucionMarina.ascx"                        tagname="checkDevolucionMarina"                           tagprefix="uc0" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Devolución SSFFAA</legend>
        <br />
...
<br />        
    ...
    <ContentTemplate> 
            ...
            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc0:checkDevolucionMarina ID="checkDevolucionMarina" runat="server" />
            </asp:Panel>
