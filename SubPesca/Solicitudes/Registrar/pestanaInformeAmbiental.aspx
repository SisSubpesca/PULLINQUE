<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioCatastroUnidades.Master" AutoEventWireup="true" CodeBehind="pestanaInformeAmbiental.aspx.cs" 
Inherits="SubPesca.Solicitudes.Registrar.pestanaInformeAmbiental"  Theme="admin_style" %>
...
<%@ Register src="CheckNuevoProyectoTecnico.ascx"           tagname="checkNuevoProyectoTecnico"                 tagprefix="uc14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true"></asp:ToolkitScriptManager>
        ...
        <asp:UpdatePanel ID="UpdatePanelInformacionSolicitud" UpdateMode="Conditional" runat="server">
            ...
            <asp:Panel ID="PanelCheckNuevoProyectoTecnico"  Visible="true" runat="server">
                <uc14:checkNuevoProyectoTecnico ID="checkNuevoProyectoTecnico" runat="server" />
            </asp:Panel>
