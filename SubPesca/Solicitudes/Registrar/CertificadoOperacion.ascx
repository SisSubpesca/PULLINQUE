<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="certificadoOperacion.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.certificadoOperacion" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Certificado de Registro de Operación</legend>
        <br />
