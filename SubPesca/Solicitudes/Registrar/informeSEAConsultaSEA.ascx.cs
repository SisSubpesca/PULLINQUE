...
{
    public partial class informeSEAConsultaSEA : System.Web.UI.UserControl
    {
        ...
        int dbSeccion = rbSeccion.NOTIFICACION_SMA;
        String labelDocumentos = "Documentos Notificación SMA";
        bool esInformesResoluciones = true;

        Funciones funciones = new Funciones();
        EnviarCorreo enviarCorreo = new EnviarCorreo();

        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.NOTIFICACION_SMA);
