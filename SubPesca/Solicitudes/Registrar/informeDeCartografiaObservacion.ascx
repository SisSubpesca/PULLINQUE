<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeDeCartografiaObservacion.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeDeCartografiaObservacion" %>
