...
namespace SubPesca.Solicitudes.Registrar
{
    ...
    /**
    * campo en rbDecisionUsuario (idTipoRechazoSol)
    **/
    public partial class checkRechazoExpConcesion : System.Web.UI.UserControl
    {
        ...
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar") || funciones.retornaModulo().Equals("Concesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.RELOCALIZACION_CREA);
                    UpdatePanelCheck.Update();
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.RELOCALIZACION_FUSIONA);
                    UpdatePanelCheck.Update();
                }
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.RELOCALIZACION_SECTOR_CERO);
                    UpdatePanelCheck.Update();
                }

                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_RELOCALIZACION };
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.RELOCALIZACION_CREA_RESA);
                    UpdatePanelCheck.Update();
                }
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.RELOCALIZACION_FUSIONA_RESA);
                    UpdatePanelCheck.Update();
                }
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.RELOCALIZACION_SECTOR_CERO_RESA);
                    UpdatePanelCheck.Update();
                }

                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_RELOCALIZACION_RESA };

            }
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_ACOPIO };
                ViewState["solicitudSession"] = paginas.solicitudAcopioSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO);
                UpdatePanelCheck.Update();

            }
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_FAENAMIENTO };
                ViewState["solicitudSession"] = paginas.solicitudFaenamientoSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO);
                UpdatePanelCheck.Update();
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_AMERB };
                ViewState["solicitudSession"] = paginas.solicitudAmerbSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB);
                UpdatePanelCheck.Update();

            }
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_EXPERIMENTALES_AMERB };
                ViewState["solicitudSession"] = paginas.solicitudExperimentalesAmerbSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB);
                UpdatePanelCheck.Update();
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_EXPERIMENTALES_CONCESION };
                ViewState["solicitudSession"] = paginas.solicitudExperimentalesConcesionSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION);
                UpdatePanelCheck.Update();
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_ECMPO };
                ViewState["solicitudSession"] = paginas.solicitudECMPOSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                UpdatePanelCheck.Update();

            }
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_COLECTOR };
                ViewState["solicitudSession"] = paginas.solicitudColectorSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_RECHAZO_EXP_CONCESION, rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA);
                UpdatePanelCheck.Update();
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    {
                        if (solicitudModificacionService.despligueSeccionesMenu(solicitudConcesion, despliegueMenuSeccionList, rbSeccion.CHECK_RECHAZO_EXP_CONCESION))
                        {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_MOD_AMERB };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_MOD_ACOPIO };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_MOD_FAENAMIENTO };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_MOD_ECMPO };
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_RECHAZO_EXP_CONCESION_MOD_CONCESION };
                }
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                CheckCombo.Items.Add(new ListItem("Carta", rbTipo.EXP_CON_RECHAZO_CARTA.ToString()));
                CheckCombo.Items.Add(new ListItem("Resolución", rbTipo.EXP_CON_RECHAZO_RESOLUCION.ToString()));
                ...
                if (checks.tipoRechazoSol != null && checks.tipoRechazoSol.id > 0)
                {
                    CheckCombo.SelectedValue = checks.tipoRechazoSol.id.ToString();
                }
        ...
        protected void Check_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (solicitud != null)
            {
                ...
                if (solicitudConcesionService.ActualizaSolicitud_IdTipoRechazoSol(solicitud.idSolConcesion, Convert.ToInt32(CheckCombo.SelectedValue)))
                {
                    ...
                    solicitud.tipoRechazoSol = new ParametroGenerico(Convert.ToInt32(CheckCombo.SelectedValue));
