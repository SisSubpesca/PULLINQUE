...
{
    public partial class informeSEAInformeUnidadAmbiental : System.Web.UI.UserControl
    {
        ...
        int dbSeccion = rbSeccion.INFORME_AMBIENTALES_MO;
        String labelDocumentos = "Documentos Informes Ambientales de MO";
        bool esInformesResoluciones = true;

        Funciones funciones = new Funciones();
        EnviarCorreo enviarCorreo = new EnviarCorreo();

        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.INFORME_AMBIENTALES_MO);
        ...
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_RELOCALIZACION_CREA };
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_RELOCALIZACION_FUSIONA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_RELOCALIZACION_SECTOR_CERO };
                }
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_RELOCALIZACION_CREA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_RELOCALIZACION_FUSIONA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_RELOCALIZACION_SECTOR_CERO_RESA };
                }
            ...
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_ACOPIO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_FAENAMIENTO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Amerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_EXPERIMENTALES_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesConcesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_EXPERIMENTALES_CONCESION };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ECMPO"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_ECMPO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_COLECTOR };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_AMERB_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_AMERB_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_AMERB_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_AMERB_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_AMERB_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_ACOPIO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_ACOPIO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_FAENAMIENTO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_ECMPO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_ECMPO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_ECMPO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_ECMPO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CONCESION_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CONCESION_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CONCESION_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_UNIDAD_AMBIENTAL_MOD_CONCESION_REGULARIZACION;
                            contador++;
                        }
                    }
        ...
        private List<String> validarIngresoRequerimiento(int idTipoIO, Requerimiento requerimiento)
        {
            ...
            if (idTipoIO == rbTipo.RESPUESTA_A_UN_REQUERIMIENTO)
            {
                ...
                else
                {
                    ...
                    //SI ES UN DOCUMENTO COMPLEMENTARIO, NO SE DEBE SELECCIONAR NINGUN CHECK ADICIONAL, YA QUE EL DOCUMENTO PRINCIPAL YA INDICO QUE FUE LO QUE SE RESPONDIO
                    if ((Convert.ToInt32(TipoDocumento.SelectedValue) == rbTipo.RESOLUCION_COMPLEMENTARIA || Convert.ToInt32(TipoDocumento.SelectedValue) == rbTipo.INFORME_COMPLEMENTARIO))
                    {
                        ...
                        {
                            errores.Add("No seleccione temas adicionales a los indicados en el documento que esta complementando");
                        }
                        else {

                            if (Convert.ToInt32(DocumentoPrincipal.SelectedValue) < 0)
                            {
                                errores.Add("Seleccione el documento que esta complementando");
                            }
                            else
                            {

                                //ESTOS REGISTROS VIENEN SIN EL ID, PARA QUE SE PUEDAN VOLVER A INGRESAR A LA BASE DE DATOS Y NO ACTUALIZAR

                                List<DocumentoAmbito> documentosRespondidosPrincipal = requerimientoService.buscarTemasContestadosDocumentoPrincipal(Convert.ToInt32(NRequerimiento.SelectedValue), Convert.ToInt32(DocumentoPrincipal.SelectedValue));

                                if (documentosRespondidosPrincipal.Count() > 0)
                                {
                                    requerimiento.ambitoTipo = documentosRespondidosPrincipal;
                                }
                                else
                                {
                                    errores.Add("El documento que esta complementando no respondio temas en el requerimiento seleccionado");
                                }
                            }
                        }
                    }
            ...
            if (hashIdTipoDocumento != null)
            {
                ...
                if (idTipoIO == rbTipo.RESPUESTA_A_UN_REQUERIMIENTO)
                {
                    ...
                    //TODOS LOS DOCUMENTOS COMPARTEN LA MISMA COMBINACION DE VALIDACION
        ...
        protected void ListViewEntradaRespuestaRequerimiento_Carga()
        {
            ...
            if (Convert.ToInt32(NRequerimiento.SelectedValue) > 0)
            {
                ...
                //SI ES UN DOCUMENTO COMPLEMENTARIO, APARECERA LO QUE CONTESTO EN EL DOCUMENTO PRINCIPAL

               
                if (Convert.ToInt32(TipoDocumento.SelectedValue) == rbTipo.INFORME_COMPLEMENTARIO || Convert.ToInt32(TipoDocumento.SelectedValue) == rbTipo.RESOLUCION_COMPLEMENTARIA)
                {
                    respu = requerimientoService.buscarTemasContestadosDocumentoPrincipal(Convert.ToInt32(NRequerimiento.SelectedValue), Convert.ToInt32(DocumentoPrincipal.SelectedValue));
