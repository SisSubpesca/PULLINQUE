...
{
    public partial class CheckNuevoProyectoTecnico : System.Web.UI.UserControl
    {
        ...
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar") || funciones.retornaModulo().Equals("Concesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.RELOCALIZACION_CREA);
                    UpdatePanelCheck.Update();
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.RELOCALIZACION_FUSIONA);
                    UpdatePanelCheck.Update();
                }
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.RELOCALIZACION_SECTOR_CERO);
                    UpdatePanelCheck.Update();
                }

                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_RELOCALIZACION };
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.RELOCALIZACION_CREA_RESA);
                    UpdatePanelCheck.Update();
                }
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.RELOCALIZACION_FUSIONA_RESA);
                    UpdatePanelCheck.Update();
                }
                ...
                {
                    PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.RELOCALIZACION_SECTOR_CERO_RESA);
                    UpdatePanelCheck.Update();
                }

                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_RELOCALIZACION_RESA };

            }
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_ACOPIO };
                ViewState["solicitudSession"] = paginas.solicitudAcopioSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO);
                UpdatePanelCheck.Update();

            }
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_FAENAMIENTO };
                ViewState["solicitudSession"] = paginas.solicitudFaenamientoSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO);
                UpdatePanelCheck.Update();
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_AMERB };
                ViewState["solicitudSession"] = paginas.solicitudAmerbSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB);
                UpdatePanelCheck.Update();

            }
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_EXPERIMENTALES_AMERB };
                ViewState["solicitudSession"] = paginas.solicitudExperimentalesAmerbSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB);
                UpdatePanelCheck.Update();
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_EXPERIMENTALES_CONCESION };
                ViewState["solicitudSession"] = paginas.solicitudExperimentalesConcesionSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION);
                UpdatePanelCheck.Update();
            ...
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_ECMPO };
                ViewState["solicitudSession"] = paginas.solicitudECMPOSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);
                UpdatePanelCheck.Update();

            }
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_COLECTOR };
                ViewState["solicitudSession"] = paginas.solicitudColectorSession;
                PanelCheck.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.CHECK_PROYECTO_TECNICO, rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA);
                UpdatePanelCheck.Update();
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    {
                        if (solicitudModificacionService.despligueSeccionesMenu(solicitudConcesion, despliegueMenuSeccionList, rbSeccion.CHECK_PROYECTO_TECNICO))
                        {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_MOD_AMERB };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_MOD_ACOPIO };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_MOD_FAENAMIENTO };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_MOD_ECMPO };
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CHECK_NUEVO_PT_MOD_CONCESION };
                }
            }
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (checks.requiereNuevoPT != null && checks.requiereNuevoPT.id > 0)
                {
                    CheckCombo.SelectedValue = checks.requiereNuevoPT.id.ToString();
                }
        ...
        protected void Check_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (solicitud != null)
            {
                ...
                if (solicitudConcesionService.ActualizaSolicitud_NuevoProyectoTecnico(solicitud.idSolConcesion, Convert.ToInt32(CheckCombo.SelectedValue)))
                {
                    ...
                    solicitud.requiereNuevoPT = new ParametroGenerico(Convert.ToInt32(CheckCombo.SelectedValue));
