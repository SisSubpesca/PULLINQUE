<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioCatastroUnidades.Master" AutoEventWireup="true" enableEventValidation="false" CodeBehind="antecedDelSector.aspx.cs" 
Inherits="SubPesca.Solicitudes.Registrar.antecedDelSector" Theme="admin_style" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
<%@ Register src="antecedDelSectorComponente.ascx" tagname="antecedDelSectorComponente" tagprefix="uc0" %>        
