<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkTipoEvaluacionAmbiental.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkTipoEvaluacionAmbiental" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Tipo de Evaluación Ambiental</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Tipo de Evaluación Ambiental</span></td>
