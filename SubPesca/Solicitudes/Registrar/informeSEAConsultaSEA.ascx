<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeSEAConsultaSEA.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeSEAConsultaSEA" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>


<%@ Register src="../Registrar/checkPertinenciaSMA.ascx"                        tagname="checkPertinenciaSMA"                           tagprefix="uc0" %>
<%@ Register src="../Registrar/checkAvanzaSMA.ascx"                             tagname="checkAvanzaSMA"                                tagprefix="uc0" %>
<%@ Register src="../Registrar/checkTipoEvaluacionAmbiental.ascx"               tagname="checkTipoEvaluacionAmbiental"                  tagprefix="uc0" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
      ...
      <!-- check consulta SMA -->
        ...
        <ContentTemplate> 
                ...
                <asp:Panel ID="Panel2"  Visible="true" runat="server">
                    <uc0:checkPertinenciaSMA ID="checkPertinenciaSMA" runat="server" />
                </asp:Panel>
    ...
    <fieldset>
        ...
        <legend>Notificación SMA</legend>
        <br />
    ...
    <asp:UpdatePanel ID="UpdatePanelGridRequerimiento" UpdateMode="Conditional" runat="server">
        ...
        <ContentTemplate> 
                ...
                <asp:Panel ID="Panel3"  Visible="true" runat="server">
                    <uc0:checkAvanzaSMA ID="checkAvanzaSMA" runat="server" />
                </asp:Panel>
           ...
           <!-- check tipo evaluacion ambiental -->
        <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
        <ContentTemplate> 

                <asp:Panel ID="Panel4"  Visible="true" runat="server">
                    <uc0:checkTipoEvaluacionAmbiental ID="checkTipoEvaluacionAmbiental" runat="server" />
                </asp:Panel>
