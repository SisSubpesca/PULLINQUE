...
{
    public partial class bancoNatural : System.Web.UI.UserControl
    {
        ...
        int dbPestana = rbPestana.BANCO_NATURAL;
        int dbSeccion = rbSeccion.BANCO_NATURAL;
        String labelDocumentos = "Documentos Banco Natural";
        bool esInformesResoluciones = true;

        Funciones funciones = new Funciones();
        EnviarCorreo enviarCorreo = new EnviarCorreo();

        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.BANCO_NATURAL);
