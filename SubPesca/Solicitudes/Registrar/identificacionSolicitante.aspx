<%@ Page    Language="C#" MasterPageFile="~/Solicitudes/SitioCatastroUnidades.Master" AutoEventWireup="true"  CodeBehind="identificacionSolicitante.aspx.cs" 
            Inherits="SubPesca.Solicitudes.Registrar.identificacionSolicitante" Theme="admin_style" %>
...
<asp:Content ID="FormularioIngresoSolicitante" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <asp:HiddenField ID="N_PERT" runat="server"></asp:HiddenField>
    ...
    <fieldset>
        ...
        <table class="form" cellpadding="0px" cellspacing="0px">
            ...
            <!-- Campo Cup añadido -->
            <tr>
                <td class="col1"><span class="item">CUP (Código Único de Proyecto)</span></td>
                <td class="col2"><span class="item">:</span></td>
                <td class="col3">
                    <div class="tooltip-container">
                        <asp:TextBox ID="CUP" MaxLength="40" Width="200px" runat="server"></asp:TextBox>
                        <asp:ImageButton ID="imgCup" runat="server" ImageUrl="~/App_Themes/admin_style/images/info.gif" Height="20px" AlternateText="" ToolTip="Con el Código Único de Proyecto (CUP) podrás hacer seguimiento de todos los permisos relacionados a tu proyecto de inversión. Para obtenerlo debes ingresar a https://super.gob.cl" CausesValidation="false" />
                        </span>
                    </div>
                </td>
            </tr>
        ...
        <asp:GridView 
           ...
           <Columns>
               ...
               <asp:TemplateField HeaderText="Estado" SortExpression="nombreEstadoAsociacion" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                ...
                <asp:TemplateField HeaderText="CUP" SortExpression="cup" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                <%# DataBinder.Eval(Container, "DataItem.cup")%>
       ...
       <asp:UpdatePanel ID="UpdatePanelArrendatarios" UpdateMode="Conditional" runat="server">

        <ContentTemplate>                        

        <asp:Panel ID="PanelArrendatarios"  Visible="true" runat="server">
       ...
       <asp:UpdatePanel ID="UpdatePanelSolicitudesPendientes" UpdateMode="Conditional" runat="server">
        ...
        <asp:GridView 
           ...
           <Columns>
               ...
               <asp:TemplateField HeaderText="Nº Pert/Identificador Solicitud" SortExpression="numPert" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
