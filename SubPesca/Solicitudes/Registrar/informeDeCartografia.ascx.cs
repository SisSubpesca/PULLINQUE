...
{
    public partial class informeDeCartografia : System.Web.UI.UserControl
    {
        ...
        int dbPestana = rbPestana.INFORME_CARTOGRAFIA;
        int dbSeccion = rbSeccion.ITC_UOT;
        String labelDocumentos = "Documentos Evaluación Unidad Ordenamiento Territorial";
        ...
        //String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.ITC_UOT);
        String erroresSumary = "ValidationSummaryErrores";



        public static informeDeCartografia Instance { get; set; }

        public informeDeCartografia()
        {
            Instance = this;
        }
        ...
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_RELOCALIZACION_CREA };
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_RELOCALIZACION_FUSIONA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_RELOCALIZACION_SECTOR_CERO };
                }
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_RELOCALIZACION_CREA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_RELOCALIZACION_FUSIONA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_RELOCALIZACION_SECTOR_CERO_RESA };
                }
            ...
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_ACOPIO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_FAENAMIENTO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Amerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_EXPERIMENTALES_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesConcesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_EXPERIMENTALES_CONCESION };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ECMPO"))
            {
                ...
                validacionDocumentacion.aplicaExperimentalesAmerb = 1;
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_ECMPO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_COLECTOR };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_AMERB_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_AMERB_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_AMERB_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_AMERB_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_AMERB_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_ACOPIO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_ACOPIO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_FAENAMIENTO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_ECMPO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_ECMPO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_ECMPO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_ECMPO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CONCESION_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CONCESION_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CONCESION_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.INFORME_CARTOGRAFIA_MOD_CONCESION_REGULARIZACION;
                            contador++;
                        }
                    }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Request.Params["__EVENTTARGET"] == "ctl00$rightbody$informeDeCartografia$cerrar_agregarGrupoSusp")
                {
        ...
        private void CargarListaRequerimientos(Usuario.Serializable usuario_logeado, int IdSolicitud)
        {
            ...
            //RECARGANDO LA CHECK DE PERMITE AVANZAR POR EL CAMINO DEL APRUEBA 
            UpdatePanel UpdatePanelCheck = CheckSupeditaAvanzaAprueba.Instance.UpdatePanelInfo;
            CheckSupeditaAvanzaAprueba.Instance.RecargarInformacion();
        ...
        private List<String> validarIngresoRequerimiento(int idTipoIO, Requerimiento requerimiento)
        {
            ...
            if (validacionDocumentacion != null)
            {
                ...
                if (ResultadoSupeditado.Items.Count > 1)
                {
                    ...
                    {
                        errores.Add("Seleccione Resultado Tipo Supeditado");
                    }
                }
                ...
                if (Convert.ToInt32(Tipo.SelectedValue) > 0 && validacionDocumentacion.verificaAmpPlazo == 1)
                {
                    ...
                    if (!cumple)
                    {
                        errores.Add("No existe un requerimiento al cual se le pueda solicitar una ampliación de plazo.");
                    }
                }
        ...
        protected void Resultado_change(object sender, EventArgs e)
        {
            ...
            ////LOS DOCUMENTOS CON RESULTADO SUPEDITADO TIENEN EL CAMPO TIPO DE SUPEDITADO
            //if ((Convert.ToInt32(TipoDocumento.SelectedValue) != rbTipo.RESOLUCION_COMPLEMENTARIA && 
            ...
            //{
            //    List<ParametroGenerico> tipoSupeditadosList = requerimientoService.ListarPosiblesRespuestasSupeditadasSubRequerimiento(Convert.ToInt32(Resultado.SelectedValue));

            //    if (tipoSupeditadosList != null && tipoSupeditadosList.Count > 0)
            //    {

            //        ResultadoSupeditado.Items.Clear();
            //        ResultadoSupeditado.DataSource = tipoSupeditadosList;
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
               ...
               /* Buscamos asociacion con un grupo suspendido para quitar la vigencia */
                int resultadoInforme = Convert.ToInt32(Resultado.SelectedItem.Value);

                if (resultadoInforme == rbEstadosGenerales.APRUEBA)
                {
                    SolicitudConcesion _SolicitudConcesion = (Datos.Entidades.SolicitudConcesion)Session[ViewState["solicitudSession"].ToString()];
                    /* se debe verificar si existen asociaciones dentro de los grupos suspendidos si es asi ingresarlas para dejarlas no vigentes
                      de caso contrario no deberia realizar nada*/
                    requerimiento.asocGrupoSolicitudList = grupoSuspendidoDA.ListarAsocGrupoSolicitud_Mantenedor(0, _SolicitudConcesion.idSolConcesion, 0);

                    if (requerimiento.asocGrupoSolicitudList != null && requerimiento.asocGrupoSolicitudList.Count > 0)
                    {
                        foreach (AsocGrupoSolicitud _asocGrupoSolicitud in requerimiento.asocGrupoSolicitudList)
                        {
                            _asocGrupoSolicitud.estadoVigencia = new ParametroGenerico(rbEstadosGenerales.NO_VIGENTE);
                            _asocGrupoSolicitud.solicitudConcesion = (Datos.Entidades.SolicitudConcesion)Session[ViewState["solicitudSession"].ToString()];
                            _asocGrupoSolicitud.accion = accion.ELIMINAR;
                        }
                    }
                }
        ...
        protected void GuardarSupeditado_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //{
                ...
                {
                    Page.Validators.Add(new ValidationError(erroresSumary, "Seleccione Tipo Supeditado."));
                }
            //}
            ...
            if (Page.IsValid)
            {
                ...
                dependenciaSupeditados.resultadoId = Convert.ToInt32(Resultado.SelectedItem.Value);
        ...
        protected void GuardarPendiente_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //{
                ...
                {
                    Page.Validators.Add(new ValidationError(erroresSumary, "Seleccione Tipo Pendiente."));
                }
            //}
