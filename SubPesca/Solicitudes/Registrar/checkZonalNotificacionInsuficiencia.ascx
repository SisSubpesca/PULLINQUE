<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkZonalNotificacionInsuficiencia.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkZonalNotificacionInsuficiencia" %>
    ...
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <legend>Decisión Sectorialista Zonal - Notificación por Insuficiencia</legend>
                <br />
