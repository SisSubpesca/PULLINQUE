<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="inspeccionTerrenoObservacion.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.inspeccionTerrenoObservacion" %>
