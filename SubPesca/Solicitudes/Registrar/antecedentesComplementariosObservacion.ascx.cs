...
{
    public partial class antecedentesComplementariosObservacion : System.Web.UI.UserControl
    {
        Datos.Entidades.Usuario.Serializable usuario_logeado = new Datos.Entidades.Usuario.Serializable(); // Usuario logueado en el sistema
        ObsPestaniaInformeDA obsPestaniaInformeDA = new ObsPestaniaInformeDA();
        PermisosService permisosService = new PermisosService();
        int dbTipo = rbTipo.ANTEC_COMPLEMENTARIOS;
        ...
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_CREA };
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_FUSIONA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_SECTOR_CERO };
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_CREA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_FUSIONA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_SECTOR_CERO_RESA };
                }
            ...
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_ACOPIO };
            ...
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_FAENAMIENTO };
            ...
            else if (funciones.retornaModulo().Equals("Amerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_AMERB };
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_EXPERIMENTALES_AMERB };
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesConcesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_EXPERIMENTALES_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("ECMPO"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_ECMPO };
            ...
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_COLECTOR };
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_AMERB_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_AMERB_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_AMERB_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_AMERB_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_AMERB_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_ACOPIO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_ACOPIO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_FAENAMIENTO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_ECMPO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_ECMPO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_ECMPO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_ECMPO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CONCESION_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CONCESION_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CONCESION_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.OBSERVACIONES_ANTECEDENTES_COMPLEMENTARIOS_MOD_CONCESION_REGULARIZACION;
                            contador++;
                        }
                    }
