<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="resolucionSSP.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.resolucionSSP" %>
...
<asp:UpdatePanel ID="UpdatePanelFormularioIngreso" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:UpdatePanel ID="UpdatePanelMensajeResolSSP" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <asp:Panel ID="PanelMensajeResolSSP"  Visible="false" runat="server">
                 ...
                 <td class="col3">
                 <div class="msgGrilla_div2">
                    Se ha ingresado la resolución de SSP aprueba, siendo que no  posee IT DAC que aprueba. </div></td></tr></table></asp:Panel></ContentTemplate></asp:UpdatePanel><asp:UpdatePanel ID="UpdatePanelErroresInferior" UpdateMode="Conditional" runat="server">
        <ContentTemplate>   
