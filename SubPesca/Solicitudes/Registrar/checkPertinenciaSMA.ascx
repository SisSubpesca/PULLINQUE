<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkPertinenciaSMA.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkPertinenciaSMA" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Pertinencia Consulta SMA</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Pertinencia Consulta SMA</span></td>
