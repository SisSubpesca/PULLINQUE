<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeSEACartaAmbiental.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeSEACartaAmbiental" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>


<%@ Register src="checkNuevoITCMOUOT.ascx"                        tagname="checkNuevoITCMOUOT"                            tagprefix="uc0" %><%@ Register src="checkTramitaUOT.ascx"                           tagname="checkTramitaUOT"                               tagprefix="uc0" %><%@ Register src="checkNuevoITCCPSUOT.ascx"                       tagname="checkNuevoITCCPSUOT"                           tagprefix="uc0" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Antecedentes Ambientales de MO</legend>
        <br />
...
<asp:UpdatePanel ID="UpdatePanelFormularioIngreso" UpdateMode="Conditional" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanelGridRequerimiento" UpdateMode="Conditional" runat="server">
        <ContentTemplate>                        
           ...
           <!-- check primer ITC CPS UOT --><asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="PanelCheck"  Visible="true" runat="server">
                <uc0:checkTramitaUOT ID="checkTramitaUOT" runat="server" />
            </asp:Panel>
    ...
    <!-- check segundo ITC CPS UOT -->
    <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel3"  Visible="true" runat="server">
                <uc0:checkNuevoITCCPSUOT ID="checkNuevoITCCPSUOT" runat="server" />
            </asp:Panel>
    ...
    <!-- check nuevo ITC MO UOT -->
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc0:checkNuevoITCMOUOT ID="checkNuevoITCMOUOT" runat="server" />
            </asp:Panel>
