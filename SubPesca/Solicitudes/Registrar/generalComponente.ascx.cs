...
{
    public partial class generalComponente : System.Web.UI.UserControl
    {
        ...
        int dbPestana = rbPestana.REFERENCIA_GLOBAL;
        int dbSeccion = rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA;
        bool esInformesResoluciones = false;


        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA);
        ...
        protected void Page_Init(object sender, System.EventArgs e)
        {
            ...
            */
            ...
            string script = "invoca_calendarios(\"general\");";
        ...
        protected void setearModulo()
        {
            ...
            ViewState["labelDocumentos"] = "Documentos Referencia Global Sernapesca";
            ...
            if (funciones.retornaModulo().Equals("Registrar"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_CONCESION };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_RELOCALIZACION_CREA };
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_RELOCALIZACION_CREA };
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_RELOCALIZACION_FUSIONA };
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_RELOCALIZACION_FUSIONA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_RELOCALIZACION_SECTOR_CERO };
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_RELOCALIZACION_SECTOR_CERO };
                }
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_RELOCALIZACION_CREA_RESA };
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_RELOCALIZACION_CREA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_RELOCALIZACION_FUSIONA_RESA };
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_RELOCALIZACION_FUSIONA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_RELOCALIZACION_SECTOR_CERO_RESA };
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_RELOCALIZACION_SECTOR_CERO_RESA };
                }
            ...
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_ACOPIO };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_ACOPIO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_FAENAMIENTO };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_FAENAMIENTO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;

            }
            else if (funciones.retornaModulo().Equals("Amerb"))
            {
                ViewState["labelDocumentos"] = "Documentos Referencia Global";
                
                Sernapesca01.Visible = false;
                Sernapesca02.Visible = false;
                Sernapesca03.Visible = false;
                Sernapesca04.Visible = false;
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_AMERB };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_EXPERIMENTALES_AMERB };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_EXPERIMENTALES_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesConcesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_EXPERIMENTALES_CONCESION };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_EXPERIMENTALES_CONCESION };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ECMPO"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_ECMPO };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_ECMPO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ...
                ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = new int[] { rbSeccionUnidadEspacial.GENERAL_DATOS_COLECTOR };
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.GENERAL_COLECTOR };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    int[] tiposModificacionDatos = new int[solicitudConcesion.tipoModificacionesTram.Count];
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_AMERB_AMPLIA_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_AMERB_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_ESPECIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_AMERB_ESPECIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_AMERB_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_PT)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_AMERB_PT;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_AMERB_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_AMERB_REDUCE_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_AMERB_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REGULARIZACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_AMERB_REGULARIZACION;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_AMERB_REGULARIZACION;
                            contador++;
                        }
                    }

                    ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"] = tiposModificacionDatos;
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_ACOPIO_ESPECIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_ACOPIO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_ACOPIO_PT;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_ACOPIO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_FAENAMIENTO_PT;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_FAENAMIENTO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_ESPECIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_ECMPO_ESPECIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_ECMPO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_PT)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_ECMPO_PT;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_ECMPO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_ECMPO_REDUCE_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_ECMPO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REGULARIZACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_ECMPO_REGULARIZACION;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_ECMPO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_ESPECIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CONCESION_ESPECIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CONCESION_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_PT)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CONCESION_PT;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CONCESION_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CONCESION_REDUCE_SUPERFICIE;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CONCESION_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                            tiposModificacionDatos[contador] = rbSeccionUnidadEspacial.GENERAL_DATOS_MOD_CONCESION_REGULARIZACION;
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.GENERAL_MOD_CONCESION_REGULARIZACION;
                            contador++;
                        }
                    }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                string script1 = "calendario('" + Fecha.ClientID + "','" + fechaImgDinamica.ClientID + "');";
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scriptCalentario" + Fecha.ClientID, script1.ToString(), true);
            }

            if (PanelNuevaFecha.Visible == true)
            {
                string script1 = "calendario('" + NuevaFecha.ClientID + "','" + nuevaFechaImgDinamica.ClientID + "');";
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scriptCalentario" + NuevaFecha.ClientID, script1.ToString(), true);
            }

            if (PanelFechaCI.Visible == true)
            {
                string script1 = "calendario('" + FechaCI.ClientID + "','" + fechaCIImgDinamica.ClientID + "');";
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "scriptCalentario" + FechaCI.ClientID, script1.ToString(), true);
            }
            ...
            if (!Page.IsPostBack)
            {
                ...
                //SECCION DATOS GENERAL
                if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA_DATOS_SOLICITUD"], this.usuario_logeado, solicitudConcesion, rbAccion.EDITAR))
                {
                    FechaRecepcion.ReadOnly = false;
                    FechaIngresoTramite.ReadOnly = false;
                    //imgFechaRecepcion.Visible = true;
                    //imgFechaIngresoTramite.Visible = true;

                    PanelCalendario.Visible = true;
                    PanelCalendario2.Visible = true;
                    BotonesDatosSolicitud.Visible = true;
                }
                else
                {
                    FechaRecepcion.ReadOnly = true;
                    FechaIngresoTramite.ReadOnly = true;
                    //imgFechaRecepcion.Visible = false;
                    //imgFechaIngresoTramite.Visible = false;
                    PanelCalendario.Visible = false;
                    PanelCalendario2.Visible = false;
                    BotonesDatosSolicitud.Visible = false;
                }
                ...
                //SECCCIONES QUE DEBEN APARECER PARA LA RELOCALIZACION
                if (solicitudConcesion != null && solicitudConcesion.tipoTramite != null)
                {

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_CONCESION_ACUICULTURA)
                    {
                        ...
                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = true;

                    }


                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION)
                    {
                        ...
                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, aDetalleSector.tipoRelocalizacion.id);
                        

                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, aDetalleSector.tipoRelocalizacion.id);
                        

                       
                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA)
                    {
                    ...
                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO);

                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO);

                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB);

                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_ECMPO);

                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB);

                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION);

                    }

                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA)
                    {

                        //DATOS SOLICITUD
                        PanelGeneral.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.DATOS_SOLICITUD_ACUICULTURA, rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA);


                        //REFERENCIA GLOBAL
                        PanelReferenciaGlobal.Visible = despliegueSeccionService.ObtieneDespliegueSeccion(rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA, rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA);

                    }

                    /* Modificación utiliza su propia tabla para el manejo de las secciones visibles */
                    if (solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_MODIFICACION || solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB || solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO || solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO || solicitudConcesion.tipoTramite.id == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_ECMPO ) 
                    {

                        List<DespliegueMenuSeccion> despliegueMenuSeccionList = despliegueMenuSeccionDA.ListarDespliegueMenuSeccion(rbMenu.REFERENCIA_GLOBAL_MODIFICACION, 0);

                        //DATOS SOLICITUD
                        if (solicitudModificacionService.despligueSeccionesMenu(solicitudConcesion, despliegueMenuSeccionList, rbSeccion.DATOS_SOLICITUD_ACUICULTURA))
                        {
                            if (!solicitudModificacionService.tieneSoloTipoModificacionRegularizacion(solicitudConcesion))
                            {
                                PanelGeneral.Visible = true;
                            }
                        }
                        ...
                        //REFERENCIA GLOBAL
                        if (solicitudModificacionService.despligueSeccionesMenu(solicitudConcesion, despliegueMenuSeccionList, rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA))
                        {
                            PanelReferenciaGlobal.Visible = true;
                        }
                    }
                ...
                CargarListaRequerimientos(usuario_logeado, Convert.ToInt32(IdSolicitud.Value));
                ...
                //Carga Las secciones Información General y Sección Fechas
                CargaInformacionGralSolicitud();
                CargaSeccionFechasGral(solicitudConcesion);
            }
        }


        private void CargaInformacionGralSolicitud()
        {
            PanelInformacionSolicitud.Visible = true;
            UpdatePanelInformacionSolicitud.Update();
        }


        /**
         * Método que Carga las Fechas de Recepción y de Tramitación de una Solicitud de Concesión de Acuicultura. 
         */
        private void CargaSeccionFechasGral(SolicitudConcesion solicitudConcesion)
        {
            //FechaRecepcionGral.Text = Convert.ToString(solicitudConcesion.fechaRecepcion);
            //FechaIngresoTramiteGral.Text = Convert.ToString(solicitudConcesion.fechaIngresoTramite);

            String fechaRecepcion = FechaUtils.formatearFecha(solicitudConcesion.fechaRecepcion);
            String fechaIngresoTramite = FechaUtils.formatearFecha(solicitudConcesion.fechaIngresoTramite);

            FechaRecepcion.Text = fechaRecepcion;
            FechaIngresoTramite.Text = fechaIngresoTramite;
        }
        ...
        public void NumeroCI_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!NumeroCI.Text.Trim().Equals("") && !FechaCI.Text.Trim().Equals(""))
                {
                    ...
                    List<SolicitudConcesion> solicitudes = requerimientoService.ObtenerSolicitudPorCIusado(Convert.ToInt32(IdSolicitud.Value), Convert.ToInt32(NumeroCI.Text.Trim()), anio);
        ...
        private void controlarCamposLogicos(int idTipoIO)
        {
            ...
            if (idTipoIO == rbTipo.RESPUESTA_A_UN_REQUERIMIENTO)
            {
                ...
                DataTable data = requerimientoService.ListarRequerimientosIdSolicitud(Convert.ToInt32(IdSolicitud.Value), dbSeccion, Convert.ToInt32(Origen.SelectedValue), Convert.ToInt32(TipoDocumento.SelectedValue));
                if (data != null)
                {
        ...
        private List<String> validarIngresoRequerimiento(int idTipoIO, Requerimiento requerimiento)
        {
            ...
            if (validacionDocumentacion != null)
            {
                ...
                if (Convert.ToInt32(Tipo.SelectedValue) > 0 && validacionDocumentacion.verificaAmpPlazo == 1)
                {
                    ...
                    reqPlazo.idSolicitud = Convert.ToInt32(IdSolicitud.Value);
        ...
        protected void TipoDocumento_change(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(TipoDocumento.SelectedValue) > 0)
            {
                ...
                if (Convert.ToInt32(TipoDocumento.SelectedValue) == rbTipo.INFORME_COMPLEMENTARIO || Convert.ToInt32(TipoDocumento.SelectedValue) == rbTipo.RESOLUCION_COMPLEMENTARIA)
                {
                    ...
                    {
                        DataTable data = requerimientoService.ListarRequerimientosIdSolicitudPrinc(Convert.ToInt32(IdSolicitud.Value), this.dbSeccion, 0, rbTipo.INFORME_PRINCIPAL);
                    ...
                    {
                        DataTable data = requerimientoService.ListarRequerimientosIdSolicitudPrinc(Convert.ToInt32(IdSolicitud.Value), this.dbSeccion, 0, rbTipo.RESOLUCION_PRINCIPAL);
        ...
        protected void GridViewSalidaDocumentoAsociado_Agregar()
        {
            ...
            List<String> errores = ingresarDocumentoValidacion.validaAdicionDocumentoAsociado(documentoAmbito, List_Documentos_Asociados, Convert.ToInt32(IdSolicitud.Value));
        ...
        protected void GridRequerimiento_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "Ver":
                    Response.Redirect(ViewState["URL_VER"].ToString() + idRequerimiento + "&Origen=1");
                    break;
                case "Administrar":
                    Response.Redirect(ViewState["URL_ADMINISTRAR_DOCUMENTO"].ToString() + idRequerimiento + "&Origen=1");
                    break;
                case "Evaluar":
                    Response.Redirect(ViewState["URL_EVALUAR"].ToString() + idRequerimiento + "&Origen=1");
                    break;
                case "Eliminar":
        ...
        protected void GridRequerimiento_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                HeaderCell.Text = ViewState["labelDocumentos"].ToString();
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (requerimiento.solicitud.idSolConcesion != Convert.ToInt32(IdSolicitud.Value))
                {
        ...
        protected void GuardarDatosGralSolicitud_Click(object sender, ImageClickEventArgs e)
        {
            SolicitudConcesionService solicitudConcesService = new SolicitudConcesionService();
            SolicitudConcesion solicitudInicial = solicitudDA.ObtieneSolicitudConcesion(Convert.ToInt32(IdSolicitud.Value), ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
            if (solicitudInicial != null)
            {
                
                if (solicitudInicial.tipoTramite != null && solicitudInicial.tipoTramite.id == rbTipo.TIPO_TRAMITE_MODIFICACION)
                {
                    solicitudInicial = solicitudDA.ObtieneSolicitudConcesionMod(Convert.ToInt32(IdSolicitud.Value), ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
                }
                
                solicitudInicial = this.generarFechas(solicitudInicial, FechaRecepcion.Text, FechaIngresoTramite.Text);

                List<String> listErroresSolicitud = generalValidacion.validaGeneral(solicitudInicial);

                if (listErroresSolicitud.Count <= 0)
                {
                    if (solicitudConcesService.guardarSolicitudConcesion(solicitudInicial, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario))
                    {

                        Session[ViewState["solicitudSession"].ToString()] = (SolicitudConcesion)solicitudInicial;

                        msgGrillaGral_1.Text = "Se han guardado los Datos Generales de la Solicitud exitosamente.";
                        msgGrillaGral_1.Focus();
                        Content_msgGrillaGral_1.Visible = true;
                    }
                    else
                    {
                        msgGrillaGral_1.Text = "No se ha guardado los Datos Generales de la Solicitud.";
                        msgGrillaGral_1.Focus();
                        Content_msgGrillaGral_1.Visible = true;
        ...
        protected void LimpiarFechas_Click(object sender, ImageClickEventArgs e)
        {
            FechaRecepcion.Text = "";
