<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeSEACartaTitular.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeSEACartaTitular" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
  ...
  <fieldset>
          ...
          <asp:UpdatePanel ID="UpdatePanelDatosSEA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>   
                <asp:Panel ID="PanelDatosSEA" CssClass="Content_msgGrilla" Visible="false" runat="server">
                    <div class="msgGrilla_div2">
                        <asp:Label ID="ErrroDatosSEA" runat="server"></asp:Label>
                    </div>
                </asp:Panel>
            </ContentTemplate>
        </asp:UpdatePanel>
        ...
        <tr>
            <td>&nbsp;IdSometimientoSEA: <asp:TextBox ID="IdSometimientoSEA" runat="server"></asp:TextBox></td>
        </tr>
        </table>

        <legend>Datos SEA</legend>
        <br />
        

        <asp:UpdatePanel ID="UpdatePanelFechaSometimiento" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelPanelFechaSometimiento"  Visible="true" runat="server">
                    <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td class="col1"><span class="item">Fecha Sometimiento</td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3">

                            <div class="calendario">
                                <div class="calendario_textbox">               
                                    <asp:TextBox ID="FechaSometimiento" Columns="8" Width="80px" runat="server"></asp:TextBox>
                                    <asp:MaskedEditExtender ID="MaskedEditExtender4" runat="server" TargetControlID="FechaSometimiento"
                                ...
                                <div class="calendario_icono">
                                    <asp:Image src="../../App_Themes/admin_style/images/calendar.png" id="imgFechaSometimiento" alt="Calendario" runat="server" style="vertical-align: middle" />&nbsp;<asp:Label ID="Label1" runat="server"></asp:Label>
                                </div>
                                <asp:CustomValidator ID="CustomValidator1" ControlToValidate="FechaSometimiento" ErrorMessage="Fecha" ClientValidationFunction="validaFechaDDMMAAAA" 
                                    Display="static" Font-Size="10" runat="server"><asp:Literal ID="Literal2" runat="server" Text="<%$Resources:spanish.language,fechaNoValida%>"/></asp:CustomValidator></div>
                        </td>
                    </tr>
                    </table>
                </asp:Panel>
        ...
        <asp:UpdatePanel ID="UpdatePanelNombreProyectoSEA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelNombreProyectoSEA"  Visible="true" runat="server">
                    <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td class="col1"><span class="item">Nombre Proyecto SEA</td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="NombreProyectoSEA" runat="server" Width="300px"></asp:TextBox></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanelIdSEA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelIdSEA"  Visible="true" runat="server">
                    <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td class="col1"><span class="item">ID SEA</td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="IdSEA" runat="server"  Width="300px"></asp:TextBox></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanelNcarpeta" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelNcarpeta"  Visible="true" runat="server">
                    <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td class="col1"><span class="item">N° Carpeta SEA/DAC</td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="Ncarpeta" runat="server"  Width="100"></asp:TextBox></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanelLinkSEA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelLinkSEA"  Visible="true" runat="server">
                    <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td class="col1"><span class="item">Link SEA</td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="LinkSEA" runat="server"  Width="300px"></asp:TextBox></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanelCategoriaSEA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelCategoriaSEA"  Visible="true" runat="server">
                    <table class="form" cellpadding="0px" cellspacing="0px">
                    <tr>
                        <td class="col1"><span class="item">Categoria CPS</td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="CategoriaSEA" runat="server"  Width="300px"></asp:TextBox></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
            <ContentTemplate>              
                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Consultores Ambientales</td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:DropDownList ID="ConsultorAmbiental" AutoPostBack="true" runat="server" OnSelectedIndexChanged="FlujoDocumental_change"></asp:DropDownList></td>
                </tr>
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
            <ContentTemplate>              
                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Entidades de Análisis</td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:DropDownList ID="EntidadAnalisis" AutoPostBack="true" runat="server" OnSelectedIndexChanged="FlujoDocumental_change"></asp:DropDownList></td>
                </tr>
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>
      ...
      <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
            <ContentTemplate>              
                <table class="form" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="col1"><span class="item">Entidades de Muestreo</td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:DropDownList ID="EntidadMuestreo" AutoPostBack="true" runat="server" OnSelectedIndexChanged="FlujoDocumental_change"></asp:DropDownList></td>
                </tr>
                </table>
            </ContentTemplate>
        </asp:UpdatePanel>

        <asp:UpdatePanel ID="UpdatePanelButtonDatosSEA" UpdateMode="Conditional" runat="server">
        <ContentTemplate>              
        <asp:Panel ID="PanelButtonDatosSEA" runat="server">
            <table class="form" cellpadding="0px" cellspacing="0px">
            <tr>
                <td class="col1"><span class="item"></span></td>
                <td class="col2"><span class="item"></span></td>
                <td class="col3"><asp:Button ID="ButtonDatosSEA" runat="server" Text="Guardar"  CausesValidation="true" onclick="ButtonDatosSEA_Click" ValidationGroup="SometimientoSEA" /></td>
            </tr>
            </table>
        </asp:Panel>
        </ContentTemplate>
    ...
    <fieldset>
        ...
        <legend>Antecedentes Ambientales</legend>
        <br />
