<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="antecedentesComplementarios.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.antecedentesComplementarios" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>


<%@ Register src="../Registrar/checkZonalNotificacionInsuficiencia.ascx"                     tagname="checkZonalNotificacionInsuficiencia"                        tagprefix="uc1" %>
<%@ Register src="../Registrar/checkCentralNotificacionInsuficiencia.ascx"                     tagname="checkCentralNotificacionInsuficiencia"                        tagprefix="uc1" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Antecedentes Complementarios</legend>
        <br />
...
<br />        
    ...
    <!-- check decision zonal - notificacion por insuficiencia -->
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel3"  Visible="true" runat="server">
                <uc1:checkZonalNotificacionInsuficiencia ID="checkZonalNotificacionInsuficiencia" runat="server" />
            </asp:Panel>

    </ContentTemplate>
    </asp:UpdatePanel>       

   <!-- check decision central - notificacion por insuficiencia -->
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc1:checkCentralNotificacionInsuficiencia ID="checkCentralNotificacionInsuficiencia" runat="server" />
            </asp:Panel>
