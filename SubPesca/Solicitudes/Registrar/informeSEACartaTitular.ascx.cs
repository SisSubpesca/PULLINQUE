...
namespace SubPesca.Solicitudes.Registrar
{
    ...
    public partial class informeSEACartaTitular : System.Web.UI.UserControl
    {


        public static informeSEACartaTitular Instance { get; set; }
        ...
        int dbSeccion = rbSeccion.ANTECEDENTES_AMBIENTALES;
        String labelDocumentos = "Documentos Antecedentes Ambientales"; 
        bool esInformesResoluciones = true;

        Funciones funciones = new Funciones();
        EnviarCorreo enviarCorreo = new EnviarCorreo();

        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.ANTECEDENTES_AMBIENTALES);


        public informeSEACartaTitular()
        {
            Instance = this;
        }

        
        public GridView gridViewRequerimiento
        {
            get { return GridRequerimiento; }
            set { GridRequerimiento = value; }
        }

        public UpdatePanel updatePanelRequerimiento
        {
            get { return UpdatePanelGridRequerimiento; }
            set { UpdatePanelGridRequerimiento = value; }
        }
        ...
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_RELOCALIZACION_CREA };
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_RELOCALIZACION_FUSIONA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_RELOCALIZACION_SECTOR_CERO };
                }
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_RELOCALIZACION_CREA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_RELOCALIZACION_FUSIONA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_RELOCALIZACION_SECTOR_CERO_RESA };
                }
            ...
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_ACOPIO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_FAENAMIENTO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Amerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_EXPERIMENTALES_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesConcesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_EXPERIMENTALES_CONCESION };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ECMPO"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_ECMPO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.CARTA_TITULAR_COLECTOR };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_AMERB_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_AMERB_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_AMERB_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_AMERB_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_AMERB_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_ACOPIO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_ACOPIO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_FAENAMIENTO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_ECMPO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_ECMPO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_ECMPO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_ECMPO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CONCESION_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CONCESION_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CONCESION_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.CARTA_TITULAR_MOD_CONCESION_REGULARIZACION;
                            contador++;
                        }
                    }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (FechaSometimiento.Visible == true)
            //{
            //    string script = "calendario('" + FechaSometimiento.ClientID + "','" + imgFechaSometimiento.ClientID + "');";
            //    ScriptManager.RegisterStartupScript(Parent.Page, Parent.Page.GetType(), "scriptCalentario" + FechaSometimiento.ClientID, script.ToString(), true);
            //}
            ...
            if (!Page.IsPostBack)
            {
                ...
                CargaDatosSEA(Convert.ToInt32(IdSolicitud.Text), solicitudConcesion);

            }

        }

        private void CargaDatosSEA(int idSolConcesion, SolicitudConcesion solicitudConcesion)
        {
            SometimientoSEA sometimientoSEA = sometimientoSEA_DA.ObtenerSometimientoSEA(idSolConcesion);

            if (sometimientoSEA != null)
            {
                IdSometimientoSEA.Text = sometimientoSEA.idSometimientoSEA.ToString();

                if (sometimientoSEA.fechaSometimiento != null && sometimientoSEA.fechaSometimiento != default(DateTime))
                {
                    FechaSometimiento.Text = FechaUtils.formatearFechaSinHora(sometimientoSEA.fechaSometimiento);
                }

                if (sometimientoSEA.nombreProySEA != null)
                {
                    NombreProyectoSEA.Text = sometimientoSEA.nombreProySEA;
                }

                if (sometimientoSEA.idSEA != null)
                {
                    IdSEA.Text = sometimientoSEA.idSEA;
                }

                if (sometimientoSEA.numCarpetaSEA != null)
                {
                    Ncarpeta.Text = sometimientoSEA.numCarpetaSEA;
                }

                if (sometimientoSEA.linkSEA != null)
                {
                    LinkSEA.Text = sometimientoSEA.linkSEA;
                }

                if (sometimientoSEA.categoriaSEA != null)
                {
                    CategoriaSEA.Text = sometimientoSEA.categoriaSEA;
                }

                if (sometimientoSEA.consultorAmbiental != null)
                {
                    ConsultorAmbiental.SelectedValue = sometimientoSEA.consultorAmbiental.numInscripcion.ToString();
                }

                if (sometimientoSEA.entidadAnalisis != null)
                {
                    EntidadAnalisis.SelectedValue = sometimientoSEA.entidadAnalisis.numEntidad.ToString();
                }

                if (sometimientoSEA.muestreadorAmb != null)
                {
                    EntidadMuestreo.SelectedValue = sometimientoSEA.muestreadorAmb.numEntidad.ToString();
                }
                ...
                if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], this.usuario_logeado, solicitudConcesion, rbAccion.EDITAR))
                {
                    FechaSometimiento.Enabled = true;
                    NombreProyectoSEA.Enabled = true;
                    IdSEA.Enabled = true;
                    Ncarpeta.Enabled = true;
                    LinkSEA.Enabled = true;
                    CategoriaSEA.Enabled = true;
                    ConsultorAmbiental.Enabled = true;
                    EntidadAnalisis.Enabled = true;
                    EntidadMuestreo.Enabled = true;

                    imgFechaSometimiento.Visible = true;
                    PanelButtonDatosSEA.Visible = true;
                }
                else {


                    FechaSometimiento.Enabled = false;
                    NombreProyectoSEA.Enabled = false;
                    IdSEA.Enabled = false;
                    Ncarpeta.Enabled = false;
                    LinkSEA.Enabled = false;
                    CategoriaSEA.Enabled = false;
                    ConsultorAmbiental.Enabled = false;
                    EntidadAnalisis.Enabled = false;
                    EntidadMuestreo.Enabled = false;

                    imgFechaSometimiento.Visible = false;
                    PanelButtonDatosSEA.Visible = false;
        ...
        protected void ButtonDatosSEA_Click(object sender, EventArgs e)
        {

            try
            {
                ErrroDatosSEA.Text = "";
                PanelDatosSEA.Visible = false;
                UpdatePanelDatosSEA.Update();

                SometimientoSEA sometimiento = new SometimientoSEA();
                sometimiento.idSolConcesion = Convert.ToInt32(IdSolicitud.Text);

                if (!IdSometimientoSEA.Text.Trim().Equals(""))  //ya existe un registro en la base de datos
                {
                    sometimiento.idSometimientoSEA = Convert.ToInt32(IdSometimientoSEA.Text);
                }

                if (!FechaSometimiento.Text.Trim().Equals(""))
                {
                    sometimiento.fechaSometimiento = Convert.ToDateTime(FechaSometimiento.Text);
                }

                if (!NombreProyectoSEA.Text.Trim().Equals(""))
                {
                    sometimiento.nombreProySEA = NombreProyectoSEA.Text;
                }

                if (!IdSEA.Text.Trim().Equals(""))
                {
                    sometimiento.idSEA = IdSEA.Text;
                }

                if (!Ncarpeta.Text.Trim().Equals(""))
                {
                    sometimiento.numCarpetaSEA = Ncarpeta.Text;
                }

                if (!LinkSEA.Text.Trim().Equals(""))
                {
                    sometimiento.linkSEA = LinkSEA.Text;
                }

                if (!CategoriaSEA.Text.Trim().Equals(""))
                {
                    sometimiento.categoriaSEA = CategoriaSEA.Text;
                }

                if (Convert.ToInt32(ConsultorAmbiental.SelectedValue) > 0)
                {
                    ConsultorAmbiental consultorAmbiental = new ConsultorAmbiental();
                    consultorAmbiental.numInscripcion = Convert.ToInt32(ConsultorAmbiental.SelectedValue);
                    sometimiento.consultorAmbiental = consultorAmbiental;
                }

                if (Convert.ToInt32(EntidadAnalisis.SelectedValue) > 0)
                {
                    EntidadMuestreador entidadAnalisis = new EntidadMuestreador();
                    entidadAnalisis.numEntidad = Convert.ToInt32(EntidadAnalisis.SelectedValue);
                    sometimiento.entidadAnalisis = entidadAnalisis;
                }

                if (Convert.ToInt32(EntidadMuestreo.SelectedValue) > 0)
                {
                    EntidadMuestreador muestreadorAmb = new EntidadMuestreador();
                    muestreadorAmb.numEntidad = Convert.ToInt32(EntidadMuestreo.SelectedValue);
                    sometimiento.muestreadorAmb = muestreadorAmb;
                }


                bool resp = requerimientoService.GuardarSometimientoSEA(sometimiento);


                if (resp)
                {

                    IdSometimientoSEA.Text = sometimiento.idSometimientoSEA.ToString();

                    ErrroDatosSEA.Text = "Información Registrada con éxito";
                    PanelDatosSEA.Visible = true;
                    UpdatePanelDatosSEA.Update();
                  
                }
                else
                {
                    ErrroDatosSEA.Text = "Ha ocurrido un error al intentar realizar la acción solicitada";
                    PanelDatosSEA.Visible = true;
                    UpdatePanelDatosSEA.Update();
        ...
        protected void Initialize_Comboboxs()
        {
            ...
            Carga_Combobox("ConsultorAmbiental");
            ConsultorAmbiental.SelectedValue = "0";

            Carga_Combobox("EntidadAnalisis");
            EntidadAnalisis.SelectedValue = "0";

            Carga_Combobox("EntidadMuestreo");
            EntidadMuestreo.SelectedValue = "0";
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "ConsultorAmbiental":

                    ConsultorAmbiental.Items.Clear();
                    ConsultorAmbiental.Items.Insert(0, new ListItem("-- Seleccione --", "0"));


                    List<ConsultorAmbiental> respConsultorAmbiental = mantenedorDA.ListarConsultorAmbiental_Mantenedor(null);

                    if (respConsultorAmbiental != null)
                    {
                        foreach (ConsultorAmbiental item in respConsultorAmbiental)
                        {
                            ConsultorAmbiental.Items.Add(new ListItem(item.nombre, Convert.ToString(item.numInscripcion)));
                        }
                    }

                    ConsultorAmbiental.DataBind();

                    break;

                case "EntidadAnalisis":

                    EntidadAnalisis.Items.Clear();
                    EntidadAnalisis.Items.Insert(0, new ListItem("-- Seleccione --", "0"));

                    List<EntidadMuestreador> respEntidadAnalisis = mantenedorDA.ListarEntidadAnalisis_Listar(null);

                    if (respEntidadAnalisis != null)
                    {
                        foreach (EntidadMuestreador item in respEntidadAnalisis)
                        {
                            EntidadAnalisis.Items.Add(new ListItem(item.razonSocial, Convert.ToString(item.numEntidad)));
                        }
                    }

                    EntidadAnalisis.DataBind();

                    break;

                case "EntidadMuestreo":

                    EntidadMuestreo.Items.Clear();
                    EntidadMuestreo.Items.Insert(0, new ListItem("-- Seleccione --", "0"));

                    List<EntidadMuestreador> respEntidadMuestreo = mantenedorDA.ListarMuestreadorAmbiental_Listar(null);

                    if (respEntidadMuestreo != null)
                    {
                        foreach (EntidadMuestreador item in respEntidadMuestreo)
                        {
                            EntidadMuestreo.Items.Add(new ListItem(item.razonSocial, Convert.ToString(item.numEntidad)));
                        }
                    }

                    EntidadMuestreo.DataBind();
        ...
        protected void GridViewSalidaDocumentoAsociado_Agregar()
        {
            ...
            else
            {
                ...
                /* Se debe desplegar mensaje de alerta cuando se envie la carta sometimiento SEA/RCA (30) */

                if (documentoAmbito.tipo.id == 30)
                {
                    SolicitudConcesion solicitudConcesion = (Datos.Entidades.SolicitudConcesion)Session[ViewState["solicitudSession"].ToString()];
