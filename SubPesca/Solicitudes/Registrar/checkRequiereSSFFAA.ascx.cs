...
{
    public partial class checkRequiereSSFFAA : System.Web.UI.UserControl
    {
        Datos.Entidades.Usuario.Serializable usuario_logeado = new Datos.Entidades.Usuario.Serializable(); // Usuario logueado en el sistema
        private Funciones funciones = new Funciones();
        private DespliegueSeccionService despliegueSeccionService = new DespliegueSeccionService();
        private SolicitudModificacionService solicitudModificacionService = new SolicitudModificacionService();
        private SolicitudConcesionService solicitudConcesionService = new SolicitudConcesionService();
        private PermisosService permisosService = new PermisosService();


        //Aplica solo para solicitudes de modificacion de concesion del tipo especie y/o proyecto tecnico
        //utiliza el permiso de ingreso de la pestaña Resolucion SSFFAA
        protected void setearModulo()
        {
            ...
            if (funciones.retornaModulo().Equals("Registrar"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_CONCESION };
            ...
            else if (funciones.retornaModulo().Equals("Relocalizacion"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_RELOCALIZACION_CREA };
                }
                if (solicitudConcesion != null && solicitudConcesion.sectorRelocalizacion.tipoRelocalizacion.id == rbTipo.RELOCALIZACION_FUSIONA)
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_RELOCALIZACION_FUSIONA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_RELOCALIZACION_SECTOR_CERO };
                }
            ...
            else if (funciones.retornaModulo().Equals("RelocalizacionRESA"))
            {
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_RELOCALIZACION_CREA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_RELOCALIZACION_FUSIONA_RESA };
                }
                ...
                {
                    ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_RELOCALIZACION_SECTOR_CERO_RESA };
                }
            ...
            else if (funciones.retornaModulo().Equals("Acopio"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_ACOPIO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Faenamiento"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_FAENAMIENTO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Amerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesAmerb"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_EXPERIMENTALES_AMERB };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ECMPO"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_ECMPO };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ExperimentalesConcesion"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_EXPERIMENTALES_CONCESION };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("Colector"))
            {
                ...
                ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_COLECTOR };
                ViewState["validacionDocumentacion"] = validacionDocumentacion;
            ...
            else if (funciones.retornaModulo().Equals("ModificacionAmerb"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_AMERB_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_AMERB_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_AMERB_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_AMERB_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_AMERB_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_AMERB_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroAcopio"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_ACOPIO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_ACOPIO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_ACOPIO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionCentroFaenamiento"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_FAENAMIENTO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_FAENAMIENTO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CENTRO_FAENAMIENTO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else if (funciones.retornaModulo().Equals("ModificacionECMPO"))
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_ECMPO_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_ECMPO_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_ECMPO_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_ECMPO_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_ECMPO_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_ECMPO_REGULARIZACION;
                            contador++;
                        }
                    }
            ...
            else
            {
                ...
                if (solicitudConcesion != null)
                {
                    ...
                    foreach (ParametroGenerico tipoModificacion in solicitudConcesion.tipoModificacionesTram)
                    {
                        ...
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CONCESION_AMPLIA_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_ESPECIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CONCESION_ESPECIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_PT)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CONCESION_PT;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CONCESION_REDUCE_SUPERFICIE;
                            contador++;
                        }
                        if (tipoModificacion.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                            tiposModificacion[contador] = rbSeccionUnidadEspacial.RESOLUCION_SSFFAA_MOD_CONCESION_REGULARIZACION;
                            contador++;
                        }
                    }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (solicitud.tipoTramite.id == rbTipo.TIPO_TRAMITE_MODIFICACION && solicitud.tipoModificacionesTram != null)
                {

                    bool modEspeciePT = true;
                    
                    foreach(ParametroGenerico tipoMod in solicitud.tipoModificacionesTram)
                    {
                        if (tipoMod.id == rbTipo.MOD_CONCESION_AMPLIA_SUPERFICIE || tipoMod.id == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE || tipoMod.id == rbTipo.MOD_CONCESION_REGULARIZACION)
                        {
                    ...
                    if (solicitud != null && solicitud.tipoTramite != null && solicitud.tipoTramite.id == rbTipo.TIPO_TRAMITE_MODIFICACION && modEspeciePT)
                    {
                        ...
                        if (checks.omiteSSFFAA != null && checks.omiteSSFFAA.id > 0)
                        {
                            CheckCombo.SelectedValue = checks.omiteSSFFAA.id.ToString();
                        }
        ...
        protected void Check_Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (solicitud != null)
            {
                ...
                if (solicitudConcesionService.ActualizaSolicitud_RequiereSSFFAA(solicitud.idSolConcesion, Convert.ToInt32(CheckCombo.SelectedValue)))
                {

                    ErroresSuperior.Text = "Actualización realizada con éxito.";
                    PanelErroresSuperior.Visible = true;
                    UpdatePanelErroresSuperior.Update();

                    solicitud.omiteSSFFAA = new ParametroGenerico(Convert.ToInt32(CheckCombo.SelectedValue));
