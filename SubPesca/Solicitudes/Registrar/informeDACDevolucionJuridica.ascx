<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeDACDevolucionJuridica.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeDACDevolucionJuridica" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="../Registrar/checkDevolucionJuridica.ascx"                        tagname="checkDevolucionJuridica"                           tagprefix="uc0" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Devolución División Juridica</legend>
        <br />
...
<br />        
    ...
    <!-- check devolucion juridica -->
    <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc0:checkDevolucionJuridica ID="checkDevolucionJuridica" runat="server" />
            </asp:Panel>
