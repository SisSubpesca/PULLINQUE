<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="generalComponente.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.generalComponente" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
<%@ Register src="informacionSolicitud.ascx"                   tagname="informacionSolicitud"                 tagprefix="uc1" %>




<%@ Register src="../Registrar/checkCultivoExperimental.ascx"               tagname="checkCultivoExperimental"                  tagprefix="uc1" %>
<%@ Register src="../Registrar/checkFirmaYSeguimiento.ascx"                 tagname="checkFirmaYSeguimiento"                    tagprefix="uc1" %>
<%@ Register src="../Registrar/checkDecisionZonal.ascx"                     tagname="checkDecisionZonal"                        tagprefix="uc1" %>
<%@ Register src="../Registrar/checkDecisionCentral.ascx"                   tagname="checkDecisionCentral"                      tagprefix="uc1" %>
<%@ Register src="../Registrar/checkVerificaAntecedentes.ascx"              tagname="checkVerificaAntecedentes"                 tagprefix="uc1" %>
<%@ Register src="../Registrar/checkRechazoExpConcesion.ascx"               tagname="checkRechazoExpConcesion"                  tagprefix="uc1" %>
<%@ Register src="../Registrar/CheckSuspendidaAvanza.ascx"                  tagname="CheckSuspendidaAvanza"                     tagprefix="uc1" %>
  ...
  <asp:HiddenField ID="IdSolicitud" runat="server"></asp:HiddenField>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
<span id="titulo_modulo">Referencia Global <asp:panel ID="Sernapesca01" Visible="true" runat="server" style="display:inline;">Sernapesca</asp:panel></span></span>
            </td>
        </tr>
    </table>
    ...
    <hr style="width:100%;" />
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelGeneral" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <table>
                <tr>
                    <td class="col1"><span class="item">Fecha de Recepción <asp:panel ID="Sernapesca03" Visible="true" runat="server" style="display:inline;">Sernapesca</asp:panel></span></td>
                ...
                <tr>
                    <td class="col1"><span class="item">Fecha de Ingreso a Trámite <asp:panel ID="Sernapesca04" Visible="true" runat="server" style="display:inline;">Sernapesca</asp:panel></span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="style1">
            ...
            <ContentTemplate>
                <div class="calendario">
                    ...
                    <asp:Panel ID="PanelCalendario2" Visible="false" runat="server">
                        <div class="calendario_icono">
                ...
                <asp:Panel ID="BotonesDatosSolicitud" runat="server">
                    <tr>
                        <td class="col1" colspan="3" align="center"><asp:ImageButton ID="GuardarDatosGralSolicitud" 
                            runat="server" 
                            ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                            AlternateText="Guardar Datos Solicitud" 
                            ToolTip="Guardar Datos Solicitud" 
                            onclick="GuardarDatosGralSolicitud_Click" 
                            CausesValidation="true" ValidationGroup="grupo1" 
                        />
                        <span class="item">Guardar Datos Solicitud</span>&nbsp;&nbsp;<asp:ImageButton  ID="LimpiarFechas" runat="server" AlternateText="Limpiar Fechas" Height="20px"  ImageUrl="~/App_Themes/admin_style/images/clean.png"  onclick="LimpiarFechas_Click" ToolTip="Limpiar Fechas" />
                        </td>
                        <td class="col3"></td>
                    </tr>
                </asp:Panel>
...
<%--
    ...
    <asp:UpdatePanel ID="UpdatePanelReferenciaGlobal" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
        <asp:Panel ID="PanelReferenciaGlobal" runat="server" Visible="false">

        
            <fieldset>
   

            <legend>Referencia Global <asp:panel ID="Sernapesca02" Visible="true" runat="server" style="display:inline;">Sernapesca</asp:panel></legend>
            <br />
            ...
            <asp:UpdatePanel ID="UpdatePanelErroresInferior" UpdateMode="Conditional" runat="server">
                <ContentTemplate>   
                    <asp:Panel ID="PanelErroresInferior" CssClass="Content_msgGrilla" Visible="false" runat="server">
                        <div class="msgGrilla_div2">
                            <asp:Label ID="ErroresInferior" runat="server"></asp:Label></div></asp:Panel></ContentTemplate></asp:UpdatePanel><br /><asp:UpdatePanel ID="UpdatePanelGridRequerimiento" UpdateMode="Conditional" runat="server">
                <ContentTemplate>                        
            ...
            <script type="text/javascript">
                invoca_calendarios("general");
                      ...
                      </asp:Panel></ContentTemplate></asp:UpdatePanel><!-- check forma de convencio y seguimiento --><asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc1:checkFirmaYSeguimiento ID="checkFirmaYSeguimiento" runat="server" />
            </asp:Panel>

    </ContentTemplate>
    </asp:UpdatePanel>

    <!-- check decision zonal -->
    <asp:UpdatePanel ID="UpdatePanel3" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel3"  Visible="true" runat="server">
                <uc1:checkDecisionZonal ID="checkDecisionZonal" runat="server" />
            </asp:Panel>
    ...
    <!-- check decision central -->
    <asp:UpdatePanel ID="UpdatePanel4" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel4"  Visible="true" runat="server">
                <uc1:checkDecisionCentral ID="checkDecisionCentral" runat="server" />
            </asp:Panel>
    ...
    <!-- check cultivo experimental -->
    <asp:UpdatePanel ID="UpdatePanelCheck2" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="PanelCheck2"  Visible="true" runat="server">
                <uc1:checkCultivoExperimental ID="checkCultivoExperimental" runat="server" />
            </asp:Panel>
    ...
    <!-- check verifica antecedentes -->
    <asp:UpdatePanel ID="UpdatePanel5" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel5"  Visible="true" runat="server">
                <uc1:checkVerificaAntecedentes ID="checkVerificaAntecedentes" runat="server" />
            </asp:Panel>
    ...
    <!-- check rechazo experimental de Concesion -->
    <asp:UpdatePanel ID="UpdatePanel6" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel6"  Visible="true" runat="server">
                <uc1:checkRechazoExpConcesion ID="checkRechazoExpConcesion" runat="server" />
            </asp:Panel>
    ...
    <!-- check avanza suspendido flujo -->
    <asp:UpdatePanel ID="UpdatePanelCheckSuspendidaAvanza" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel7"  Visible="true" runat="server">
                <uc1:CheckSuspendidaAvanza ID="CheckSuspendidaAvanza" runat="server" />
            </asp:Panel>
