<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="antecedentesURB.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.antecedentesURB" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    

<%@ Register src="../Registrar/checkDecisionUGP.ascx"                   tagname="checkDecisionUGP"                      tagprefix="uc1" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Antecedentes URB</legend>
        <br />
...
<asp:UpdatePanel ID="UpdatePanelFormularioIngreso" UpdateMode="Conditional" runat="server">
    ...
    <ContentTemplate> 
            ...
            <asp:Panel ID="PanelCheck2"  Visible="true" runat="server">
                <uc1:checkDecisionUGP ID="checkDecisionUGP" runat="server" />
            </asp:Panel>
