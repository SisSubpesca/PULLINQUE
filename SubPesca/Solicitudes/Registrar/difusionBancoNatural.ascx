<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="difusionBancoNatural.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.difusionBancoNatural" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="../Registrar/checkRequiereDifusionBanco.ascx"                        tagname="checkRequiereDifusionBanco"                           tagprefix="uc0" %>

<!-- check requiere difusion banco natural -->
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
<ContentTemplate> 

        <asp:Panel ID="Panel2"  Visible="true" runat="server">
            <uc0:checkRequiereDifusionBanco ID="checkRequiereDifusionBanco" runat="server" />
        </asp:Panel>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Difusión Banco Natural</legend>
        <br />
