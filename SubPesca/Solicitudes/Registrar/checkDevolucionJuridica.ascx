<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkDevolucionJuridica.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkDevolucionJuridica" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Tipo de procesamiento para la devolución de jurídica</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Tipo de procesamiento para la devolución de juridica</span></td>
