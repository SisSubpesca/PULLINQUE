<%@ Page    Language="C#" MasterPageFile="~/Solicitudes/SitioCatastroUnidades.Master" AutoEventWireup="true"  CodeBehind="general.aspx.cs" 
Inherits="SubPesca.Solicitudes.Registrar.general" Theme="admin_style" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
<%@ Register src="generalComponente.ascx" tagname="generalComponente" tagprefix="uc0" %>          
