<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkVerificaAntecedentes.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkVerificaAntecedentes" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Solicitante cumple con antecedentes</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Solicitante cumple con Antecedentes?</span></td>
