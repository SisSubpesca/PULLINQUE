<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkRequiereDifusionBanco.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkRequiereDifusionBanco" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>¿Omitir Difusión de Banco Natural?</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Omitir Difusión de Banco Natural</span></td>
