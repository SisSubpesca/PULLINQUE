<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkCertificadoOperacion.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkCertificadoOperacion" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Certificado de Operación</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Verificó vigencia del Certificado de operación?</span></td>
