<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkTramitaUOT.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkTramitaUOT" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Requiere evaluación UOT</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Generar ITC CPS e INFAS UOT</span></td>
