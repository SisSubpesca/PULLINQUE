...
//using SubPesca.Documentos;



namespace SubPesca.Solicitudes.Registrar
{
    public partial class inspeccionTerreno : System.Web.UI.UserControl
    {
        ...
        int dbPestana = rbPestana.INSPECCION_TERRENO;
        int dbSeccion = rbSeccion.INSPECCION_TERRENO;
        String labelDocumentos = "Documentos Inspección en Terreno";
        bool esInformesResoluciones = true;

        Funciones funciones = new Funciones();
        EnviarCorreo enviarCorreo = new EnviarCorreo();

        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.INSPECCION_TERRENO);
        ...
        {
            //GenerarDocumentoPlantilla documento = new GenerarDocumentoPlantilla();
