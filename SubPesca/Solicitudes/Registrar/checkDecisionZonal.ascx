<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkDecisionZonal.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkDecisionZonal" %>
    ...
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <legend>Decisión Sectorialista Zonal</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Envio SSP Central?</span></td>
