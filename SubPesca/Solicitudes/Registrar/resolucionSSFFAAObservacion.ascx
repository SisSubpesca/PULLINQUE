<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="resolucionSSFFAAObservacion.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.resolucionSSFFAAObservacion" %>
