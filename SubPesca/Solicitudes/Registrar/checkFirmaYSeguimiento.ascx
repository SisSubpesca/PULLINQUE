<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkFirmaYSeguimiento.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkFirmaYSeguimiento" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Firma de Convenio y Seguimiento de datos del trámite</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Firma de convenio?</span></td>
                ...
                <tr>
                    <td class="col1"><span class="item">¿Seguimiento de datos del trámite?</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3" style="margin-left: 40px">
                        <span class="item">
                            <asp:DropDownList ID="CheckCombo1" AutoPostBack="true" runat="server">  
                                <asp:ListItem Value="-1">Seleccione</asp:ListItem>
                                <asp:ListItem Value="65">Si</asp:ListItem>
                                <asp:ListItem Value="66">No</asp:ListItem>
                            </asp:DropDownList> 
