<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="planos.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.planos" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="../Registrar/checkPlanos.ascx"                             tagname="checkPlanos"                                tagprefix="uc0" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Antecedentes Planos</legend>
        <br />
...
<br />        
    ...
    <ContentTemplate> 
            ...
            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc0:checkPlanos ID="checkPlanos" runat="server" />
            </asp:Panel>
