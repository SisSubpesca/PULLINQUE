<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ingresarDocumentoComponente.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.ingresarDocumentoComponente" %>
...
<%@ Register Tagprefix="uc0" src="informacionSolicitud.ascx"  tagname="informacionSolicitud" %>              
    ...
    <asp:UpdatePanel ID="UpdatePanelMensajesValidaciones" UpdateMode="Conditional" runat="server">
       <ContentTemplate>    
           <asp:panel ID="Panel1" runat="server">
                ...
                <asp:ValidationSummary ID="ValidationSummary" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList"  ValidationGroup="grupo1" />
            </asp:panel>
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <asp:Panel ID="PanelFormularioIngreso" Visible="false" runat="server">
            ...
            <ContentTemplate>                        
                <asp:Panel ID="PanelNumero"  Visible="false" runat="server">
                    ...
                    <tr>
                        ...
                        <asp:Literal ID="NumeroLiteral" runat="server" Text="<%$Resources:spanish.language,numero%>"/></span></td>
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox autocomplete="tel-extension" ID="Numero" runat="server" onChange="return onlyNumeric(this)" onKeyUp="return onlyNumeric(this)" MaxLength="8"></asp:TextBox>&nbsp;<asp:Label ID="RequeridoNumero" runat="server"></asp:Label></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
            ...
            <ContentTemplate>                        
                <asp:Panel ID="PanelResultado"  Visible="false" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td><td class="col3"><asp:DropDownList ID="Resultado" runat="server" AutoPostBack="true"  OnSelectedIndexChanged="Resultado_change"></asp:DropDownList> *</td></tr></table></asp:Panel></ContentTemplate></asp:UpdatePanel><asp:UpdatePanel ID="UpdatePanelMensajeAsociarPendiente" UpdateMode="Conditional" runat="server">
            <ContentTemplate>   
            ...
            <tr>
                <td class="col1"><span class="item">Tipo Pendiente</span></td><td class="col2"><span class="item">:</span></td><td class="col3">
                    ...
                    <asp:ImageButton ID="agregarGrupoSuspendido" 
                        ...
                        OnClientClick="javascript:abre_dialogo('agregarGrupoSusp','3')"  />
                </td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <asp:ImageButton ID="GuardarSupeditado" Visible="true" runat="server" 
                        ImageUrl="../../App_Themes/admin_style/images/add.png" Height="20px" 
                        AlternateText="Guardar Supeditado" ToolTip="Guardar Supeditado" CausesValidation="true"
      ...
      <asp:UpdatePanel ID="UpdatePanelMensajeResolSSFFAA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
            ...
            <ContentTemplate>
                <asp:Panel ID="PanelMensajeResolSSP"  Visible="false" runat="server">
                 ...
                 <td class="col3">
                 <div class="msgGrilla_div2">
                    Se ha ingresado la resolución de SSP aprueba, siendo que no  posee IT DAC que aprueba. </div></td></tr></table></asp:Panel></ContentTemplate></asp:UpdatePanel></asp:Panel></ContentTemplate></asp:UpdatePanel><asp:UpdatePanel ID="UpdatePanelErroresInferior" UpdateMode="Conditional" runat="server">
        <ContentTemplate>   
            <asp:Panel ID="PanelErroresInferior" CssClass="Content_msgGrilla" Visible="false" runat="server">
                <div class="msgGrilla_div2">
                    <asp:Label ID="ErroresInferior" runat="server"></asp:Label></div></asp:Panel></ContentTemplate></asp:UpdatePanel><asp:UpdatePanel ID="UpdatePanelGridRequerimiento" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                      ...
                      <asp:GridView 
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField Visible="true">
                                <ItemTemplate>
                                    <asp:Label HeaderText="idEstadoVigencia" ID="hidden3" runat="server" Visible="true" Text='<%# (DataBinder.Eval(Container.DataItem, "idEstadoVigRequerimiento") == DBNull.Value? DataBinder.Eval(Container.DataItem, "idEstadoVigencia"): DataBinder.Eval(Container.DataItem, "idEstadoVigRequerimiento")) %>'></asp:Label><asp:Label HeaderText="idDocGeneral" ID="hidden1" runat="server" Visible="true" Text='<%# (DataBinder.Eval(Container.DataItem, "idDocGeneral") == DBNull.Value? DataBinder.Eval(Container.DataItem, "idDocGeneralResp") : DataBinder.Eval(Container.DataItem, "idDocGeneral")) %>'></asp:Label><asp:Label HeaderText="rowspan" ID="hidden4" runat="server" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem, "columnas") %>'></asp:Label></ItemTemplate></asp:TemplateField><asp:TemplateField Visible="true">
                                <ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="Fecha"          DataField="fechaReq" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"  DataFormatString="{0:dd/MM/yyyy }" HtmlEncode="false" /> 
                            ...
                            <asp:BoundField HeaderText="Fecha"              DataField="fechaResp"    SortExpression="fechaResp"    ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"  />
                            ...
                            <asp:BoundField HeaderText="Fecha C.I"          DataField="fechaRespCI"  SortExpression="fechaRespCI"    ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center"  />
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="160px">
                                <ItemTemplate>
        ...
        <div class="content_dialog">
            <div class="top">
               ...
               <asp:LinkButton ID="LinkButton1" CssClass="cerrar" OnClientClick="javascript:close_dialog('agregarGrupoSusp');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
                
                <fieldset>
                    <legend>Agregar Grupo Suspendidouspendido/legend>                    <iframe id="iframe_agregarGrupoSusp" src="" width="500px" height="300px" frameborder="0" scrolling="no"></iframe>
                </fieldset>
