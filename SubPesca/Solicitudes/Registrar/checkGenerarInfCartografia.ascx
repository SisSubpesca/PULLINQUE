<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkGenerarInfCartografia.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkGenerarInfCartografia" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Consulta Evaluación UOT</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Evalua UOT?</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3" style="margin-left: 40px">
                        <span class="item">
                            <asp:DropDownList ID="CheckCombo" AutoPostBack="true" runat="server">  
                                <asp:ListItem Value="-1">Seleccione</asp:ListItem>
                                <asp:ListItem Value="63">Si</asp:ListItem>
                                <asp:ListItem Value="64">No</asp:ListItem>
                            </asp:DropDownList> 
                        </span>
                    </td>
                </tr>
