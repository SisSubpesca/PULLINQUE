<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkNuevoITCMOUOT.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkNuevoITCMOUOT" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Nuevo ITC MO UOT</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Se debe generar un nuevo ITC MO UOT?</span></td>
