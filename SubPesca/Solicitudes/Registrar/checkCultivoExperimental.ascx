<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkCultivoExperimental.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkCultivoExperimental" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Cultivo Experimental</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Tiene Cultivo Experimental?</span></td>
