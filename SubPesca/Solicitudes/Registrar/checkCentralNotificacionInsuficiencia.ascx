<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkCentralNotificacionInsuficiencia.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkCentralNotificacionInsuficiencia" %>
    ...
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <legend>Decisión Sectorialista Central - Notificación por Insuficiencia</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Evaluación Respuesta del Titular</span></td>
