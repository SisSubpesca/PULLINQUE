<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeSEAInformeUnidadAmbiental.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeSEAInformeUnidadAmbiental" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Informes Ambientales de MO</legend>
        <br />
