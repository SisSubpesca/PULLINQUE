<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeSEARCA.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeSEARCA" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Resolución Calificación Ambiental</legend>
        <br />
