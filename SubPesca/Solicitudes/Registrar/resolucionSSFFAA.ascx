<%@ Control Language="C#" AutoEventWireup="true"   CodeBehind="resolucionSSFFAA.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.resolucionSSFFAA"   %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>


<%@ Register src="../Registrar/checkRequiereSSFFAA.ascx"                        tagname="checkRequiereSSFFAA"                           tagprefix="uc0" %>

<!-- check requiere SSFFAA -->
<asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
<ContentTemplate> 

        <asp:Panel ID="Panel2"  Visible="true" runat="server">
            <uc0:checkRequiereSSFFAA ID="checkRequiereSSFFAA" runat="server" />
        </asp:Panel>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Resolución SSFFAA</legend>
        <br />
     ...
     <asp:UpdatePanel ID="UpdatePanelMensajeResolSSFFAA" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <asp:Panel ID="PanelMensajeResolSSFFAA"  Visible="false" runat="server">
                 ...
                 <td class="col3">
                 <div class="msgGrilla_div2">
                    Se ha ingresado la resolución de SSFFAA aprueba, siendo que no  posee resol SSP que aprueba. </div></td></tr></table></asp:Panel></ContentTemplate></asp:UpdatePanel><asp:UpdatePanel ID="UpdatePanelErroresInferior" UpdateMode="Conditional" runat="server">
        <ContentTemplate>   
