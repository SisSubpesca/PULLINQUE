<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkTramitaUTS.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkTramitaUTS" %>
    ...
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <tr>
                    <td class="col1"><span class="item">¿Tramita UAGPA?</span></td>
