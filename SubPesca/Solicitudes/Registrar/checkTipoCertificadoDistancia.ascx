<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkTipoCertificadoDistancia.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkTipoCertificadoDistancia" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Tipo de Certificado de Distancia</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Tipo de certificado de Distancia</span></td>
