<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkDecisionCentral.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkDecisionCentral" %>
    ...
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                ...
                <legend>Decisión Sectorialista Central</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Devuelve mediante carta?</span></td>
