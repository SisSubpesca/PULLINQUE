<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="capitaniaPuerto.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.capitaniaPuerto" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>


<%@ Register src="../Registrar/checkTipoCertificadoDistancia.ascx"                        tagname="checkTipoCertificadoDistancia"                           tagprefix="uc0" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
 ...
 <fieldset>
        <legend>Capitania de Puerto</legend>
        <br />
        ...
        <table class="form" cellpadding="0px" cellspacing="0px">
            <tr>
                ...
                <td class="col3"><asp:DropDownList ID="CapitaniaDePuerto" AutoPostBack="true" runat="server"></asp:DropDownList></td>
            </tr>
            <tr>
                <td class="col1"></td>
                <td class="col2"></td>
                <td class="col3">
                    <asp:ImageButton ID="GuardarCapitaniaPuerto" runat="server" src="../../App_Themes/admin_style/images/add.png" onclick="GuardarCapitaniaPuerto_Click"  />
                    <span class="item">Guardar Capitanía de Puerto</span>
                </td>
            </tr>
        </table>
 ...
 <fieldset>
        ...
        <legend>Antecedentes de Capitania de Puerto</legend>
        <br />
        
        <asp:Panel ID="PanelIdSolicitud" Visible="false" runat="server">
        <table class="form" cellpadding="0px" cellspacing="0px" style="display:none;">
          <tr><td>&nbsp;IdSolicitud: <asp:TextBox ID="IdSolicitud" runat="server"></asp:TextBox></td>
        </tr>
        </table>
        </asp:Panel>
...
<asp:UpdatePanel ID="UpdatePanelFormularioIngreso" UpdateMode="Conditional" runat="server">
            ...
            <ContentTemplate>                        
                <asp:Panel ID="PanelNumero"  Visible="false" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td>
                        <td class="col3"><asp:TextBox ID="Numero" autocomplete="tel-extension" runat="server" MaxLength="12"></asp:TextBox>&nbsp;<asp:Label ID="RequeridoNumero" runat="server"></asp:Label></td>
                    </tr>
                    </table>
                </asp:Panel>
            </ContentTemplate>
    ...
    <asp:UpdatePanel ID="UpdatePanelGridRequerimiento" UpdateMode="Conditional" runat="server">
      ...
      <!-- check tipo certificado de distancia --><asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
    <ContentTemplate> 

            <asp:Panel ID="Panel2"  Visible="true" runat="server">
                <uc0:checkTipoCertificadoDistancia ID="checkTipoCertificadoDistancia" runat="server" />
            </asp:Panel>
