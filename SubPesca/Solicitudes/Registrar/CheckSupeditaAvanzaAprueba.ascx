<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckSupeditaAvanzaAprueba.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.CheckSupeditaAvanzaAprueba" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Continuar tramitación a pesar de tener un IT UOT Pendiente o IT UOT Supeditado</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">¿Avanzar por camino aprueba?</span></td>
