...
namespace SubPesca.Solicitudes.Registrar
{
    ...
    public partial class resolucionSSFFAA : System.Web.UI.UserControl
    {
        ...
        int dbPestana               = rbPestana.RESOLUCION_SSFFAA;
        int dbSeccion               = rbSeccion.RESOLUCION_SSFFAA;
        String labelDocumentos      = "Documentos Resolución SSFFAA";
        bool esInformesResoluciones = true;

        String erroresSumary = "ValidationSummary" + Convert.ToString(rbSeccion.RESOLUCION_SSFFAA);
