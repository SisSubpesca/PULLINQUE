<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="informeDAC.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.informeDAC" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>


<asp:UpdatePanel ID="UpdatePanelInformDAC" UpdateMode="Conditional" runat="server">
<ContentTemplate> 
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Informe Técnico DAC</legend>
        <br />
...
<asp:UpdatePanel ID="UpdatePanelFormularioIngreso" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
                    ...
                    <tr>
                        ...
                        <td class="col3">
                            ...
                            <div class="calendario">
                                ...
                                <asp:CustomValidator ID="ccFecha" ControlToValidate="Fecha" ErrorMessage="Fecha" ClientValidationFunction="validaFechaDDMMAAAA" Display="static" Font-Size="10" runat="server"><asp:Literal ID="FechaNoValidaLiteral" runat="server" Text="<%$Resources:spanish.language,fechaNoValida%>"></asp:Literal></asp:CustomValidator>
                            </div>
                        </td>
                    </tr>
                    </table>
                    ...
                    <tr>
                        ...
                        <td class="col3">
                            ...
                            <div class="calendario">
                                ...
                                <asp:CustomValidator ID="ccNuevaFecha" ControlToValidate="NuevaFecha" ErrorMessage="Fecha" ClientValidationFunction="validaFechaDDMMAAAA" Display="static" Font-Size="10" runat="server"><asp:Literal ID="NuevaFechaNoValidaLiteral" runat="server" Text="<%$Resources:spanish.language,fechaNoValida%>"></asp:Literal></asp:CustomValidator>
                            </div>
                        </td>
                    </tr>
                    </table>
                    ...
                    <tr>
                        ...
                        <td class="col2"><span class="item">:</span></td><td class="col3">
                            ...
                            <div class="calendario">
                                ...
                                <asp:CustomValidator ID="cvFechaCI" ControlToValidate="FechaCI" ErrorMessage="Fecha" ClientValidationFunction="validaFechaDDMMAAAA" Display="static" Font-Size="10" runat="server"><asp:Literal ID="FechaCINoValidaLiteral" runat="server" Text="<%$Resources:spanish.language,fechaNoValida%>"></asp:Literal></asp:CustomValidator>
        ...
        <asp:UpdatePanel ID="UpdatePanelMensajeITDACAprueba" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <asp:Panel ID="PanelMensajePlanosITDACAprueba"  Visible="false" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="col3">
                            <div class="msgGrilla_div2">
                            Se ha ingresado IT DAC aprueba, siendo que no tiene documento, con el resultado aprueba anteriores para el ingreso de este documento.
                            </div>
                        </td>
                    </tr>
                    </table>
