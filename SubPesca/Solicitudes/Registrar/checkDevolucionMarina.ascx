<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="checkDevolucionMarina.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.checkDevolucionMarina" %>
...
<asp:UpdatePanel ID="UpdatePanelCheck" UpdateMode="Conditional" runat="server">
    <ContentTemplate>              
        ...
        <asp:Panel ID="PanelCheck" Visible="false" runat="server">
            ...
            <fieldset>
                <legend>Tipo de procesamiento para la devolución de marina</legend>
                <br />
                ...
                <tr>
                    <td class="col1"><span class="item">Tipo de procesamiento para la devolución de marina</span></td>
