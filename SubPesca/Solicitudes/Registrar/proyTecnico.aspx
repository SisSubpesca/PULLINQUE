<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioCatastroUnidades.Master" AutoEventWireup="true" CodeBehind="proyTecnico.aspx.cs" 
Inherits="SubPesca.Solicitudes.Registrar.proyTecnico" Theme="admin_style" %>
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="proyTecnicoComponente.ascx"                   tagname="proyTecnicoComponente"                 tagprefix="uc01" %>
