<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="planosInformeTecnicoUOT.ascx.cs" Inherits="SubPesca.Solicitudes.Registrar.planosInformeTecnicoUOT" %>
...
<asp:UpdatePanel ID="UpdatePanelErroresSuperior" UpdateMode="Conditional" runat="server">
    ...
    <fieldset>
        ...
        <legend>Informe Técnico Planos U.O.T.</legend>
        <br />
