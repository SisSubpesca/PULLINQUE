...
CodeBehind="unidadEspacialExperimentalesAmerb.aspx.cs" Inherits="SubPesca.Solicitudes.ExperimentalesAmerb.unidadEspacialExperimentalesAmerb" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Creación de Experimental AMERB</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos de Acuicultura Experimental Amerb</legend>
        ...
        <br /> 
                        ...
                        <td class="col1" colspan="4" align="center">
                             ...
                             <asp:ImageButton ID="CrearConcesionButton" runat="server" 
                                 ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                                   AlternateText="Crear Experimental Amerb" ToolTip="Crear Concesión" onclick="CrearConcesion_Click" 
                                   CausesValidation="true" ValidationGroup="grupo1" />
                            <span class="item">Crear Experimental Amerb</span>&nbsp;&nbsp;<asp:ImageButton 
                ...
                <asp:Panel id="PanelMensajePendientes" runat="server" Visible="false">
                    <table class="form" cellpadding="0px" cellspacing="0px" width="100%">   
                    <tr>
                        <td class="col1" colspan="4" align="center"><span style="color:#772222;">Advertencia: Aun existen documentos pendientes que no permiten la Creación Experimental Amerb, sin embargo puede guardar la información contenida en esta página (El Centro no se creará)</span></td>
                    </tr>
                    <tr>
