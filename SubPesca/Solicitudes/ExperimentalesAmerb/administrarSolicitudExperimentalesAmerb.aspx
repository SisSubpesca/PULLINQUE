<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudExperimentalesAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ExperimentalesAmerb.administrarSolicitudExperimentalesAmerb" Theme="admin_style" %>

<%@ Reference Page="inicioSolicitudExperimentalesAmerb.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Solicitudes de 
            Experimentales Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <asp:UpdatePanel ID="UpdatePanelMensajesValidaciones" UpdateMode="Conditional" runat="server">
       <ContentTemplate>    
           <asp:panel ID="Panel1" runat="server">
                <asp:ValidationSummary ID="ValidationSummaryErrores" CssClass="valSum" style="color:#772222;" runat="server" HeaderText="Ingrese valores válidos en los siguientes campos:" DisplayMode="BulletList"   ValidationGroup="FormBusquedaAmerb" />
            </asp:panel>
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Solicitudes de 
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Codigo Amerb">
                                <ItemTemplate>
                                     <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("datosSolicitudUE.amerbVista.id")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
    ...
    <script type="text/javascript">
        invoca_calendarios("administrarSolicitudExperimentalesAmerb");
    </script></asp:Content>