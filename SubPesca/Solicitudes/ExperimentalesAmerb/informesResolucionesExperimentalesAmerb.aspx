<%@ Page Language="C#"  MasterPageFile="~/Solicitudes/SitioSolicitudesExperimentalesAmerb.Master" AutoEventWireup="true" CodeBehind="informesResolucionesExperimentalesAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ExperimentalesAmerb.informesResolucionesExperimentalesAmerb" Theme="admin_style" %>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true"></asp:ToolkitScriptManager>
     ...
     <fieldset>
        ...
        <tr>
            ...
            <td>
                <asp:Panel  ID="PanelInfCartografia" Visible="true" runat="server">
        ...
        <div id="seccion6" style="display:none;">
            ...
            <asp:Panel ID="PanelInformeSEA"  Visible="true" runat="server">
                <fieldset>
