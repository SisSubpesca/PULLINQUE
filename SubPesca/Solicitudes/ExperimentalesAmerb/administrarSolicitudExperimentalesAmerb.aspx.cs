...
{
    public partial class administrarSolicitudExperimentalesAmerb : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINSITRAR_SOLICITUD_EXPERIMENTAL_AMERB };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "Estado":
                    Estado.Items.Clear();
                    //falta saber el numero de recurso para la obtencion de los estados solo de experimentales amerb
                    Estado.DataSource = reporteDA.ListarEstadosPorTipoTramite(535);
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (solicitudFiltro.fechaRangoFiltro1 != null && solicitudFiltro.fechaRangoFiltro2 != null)
            {
                ...
                {
                    Page.Validators.Add(new ValidationError("FormBusquedaAmerb", "\"Fecha Ingreso Trámite Desde\" debe ser posterior a \"Fecha Ingreso Trámite Hasta\""));
                ...
                else
                {
                    ...
                    {
                        Page.Validators.Add(new ValidationError("FormBusquedaAmerb", "El rango máximo de búsqueda es de 3 meses"));
                    }
                }
            }
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudExperimentalesAmerbAdmin(solicitudFiltro);
        ...
        protected void eliminarSolicitud(int SolCon)
        {
