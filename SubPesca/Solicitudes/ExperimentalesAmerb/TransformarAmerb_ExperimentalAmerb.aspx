<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="TransformarAmerb_ExperimentalAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ExperimentalesAmerb.TransformarAmerb_ExperimentalAmerb" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Traspasar Solicitud Amerb en Experimental Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
        ...
        <tr>
            ...
            <td class="col3">
                <asp:Panel ID="PanelBotonIngresar" Visible="false" runat="server">
                    <asp:Button ID="Filtrar" runat="server" OnClick="Guardar_Click" Text="Traspasar a Experimental" CausesValidation="true" ValidationGroup="grupo1"/>
                </asp:Panel>
            </td>
        </tr>
        </table>
