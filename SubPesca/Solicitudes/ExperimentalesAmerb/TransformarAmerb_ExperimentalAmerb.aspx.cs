...
{
    public partial class TransformarAmerb_ExperimentalAmerb : System.Web.UI.Page
    {
        ...
        String mensaje = "";
        SolicitudConcesion SolicitudAmerb =  new SolicitudConcesion();
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            SolicitudAmerb = (SolicitudConcesion)Session["SolicitudCentroAmerb"];
            //SolicitudAmerb.coordenadaGeografica
            ...
            if (SolicitudAmerb.coordenadaGeografica != null)
            {
                solicitudInicial.coordenadaGeografica = new List<CoordenadaGeografica>();
                solicitudInicial.coordenadaGeografica = SolicitudAmerb.coordenadaGeografica;
            }
            ...
            {
                if (experimentalesAmerbService.TransformarSolicitudAmerbExperimentalAmerb(solicitudInicial, SolicitudAmerb, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario))
                {
