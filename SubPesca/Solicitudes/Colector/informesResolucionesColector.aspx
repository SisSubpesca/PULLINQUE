<%@ Page Language="C#"  MasterPageFile="~/Solicitudes/SitioSolicitudesColector.Master" AutoEventWireup="true" CodeBehind="informesResolucionesColector.aspx.cs" 
Inherits="SubPesca.Solicitudes.Colector.informesResolucionesColector" Theme="admin_style" %>
        ...
        <div id="seccion6" style="display:none;">
            ...
            <asp:UpdatePanel ID="UpdatePanelInformeSEA" runat="server"  UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="PanelInformeSEACartaAmbiental"  Visible="true" runat="server">
