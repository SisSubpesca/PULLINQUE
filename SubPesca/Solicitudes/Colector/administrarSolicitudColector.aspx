<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudColector.aspx.cs"
 Inherits="SubPesca.Solicitudes.Colector.administrarSolicitudColector" Theme="admin_style" %>

<%@ Reference Page="inicioSolicitudColector.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Solicitudes de Colector de Semillas</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Solicitudes de Colectores de Semilla</legend>
