...
{
    public partial class identificacionSolicitanteColector : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.IDENTIFICACION_SOLICITANTE_COLECTOR };
        ...
        */
                ...
                if (solicitanteService.VerPersona(solicitante.rut, 0) != null)
                {
                    ...
                    if (solicitanteService.existeSolicitante(IdSolicitud.Value, solicitante.rut, 0) == null)
                    {
                        ...
                        if (resp)
                        {
                            ...
                            msgGrilla.Text = "Se ha asociado el Solicitante de forma exitosa a la solicitud de colector de semillas.";
                            Content_msgGrilla.Visible = true;
                            LimpiarCamposSolicitante();

                            try {

                                enviarCorreo.alertaTitularColectorExistente(Convert.ToInt32(IdSolicitud.Value), solicitante.rut);
                        ...
                        {
                            msgGrilla.Text = "No se ha asociado el Solicitante a la solicitud de colector de semillas.";
                            Content_msgGrilla.Visible = true;
                        }
                    }
                    else
                    {
                        msgGrilla.Text = "El Solicitante ya se encuentra asociado a la solicitud de colector de semillas.";
                        Content_msgGrilla.Visible = true;
                        LimpiarCamposSolicitante();
                    }
                    Ico_msgGrillaGral_1.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
        ...
        protected void GridSolicitante_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                case "Ver":
                    Response.Redirect("~/Mantenedores/Titulares/detalleTitular.aspx?rutPersona=" + e.CommandArgument + "&bp=7");
                    break;
                case "Eliminar":
        ...
        protected void GridViewSolicitudesPendientes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Ver":
                    ...
                    Response.Redirect("~/Solicitudes/Colector/verDocumentoColector.aspx?idRequerimiento=" + idRequerimiento);
