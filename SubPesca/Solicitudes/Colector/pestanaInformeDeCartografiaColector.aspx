<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesColector.Master" AutoEventWireup="true" CodeBehind="pestanaInformeDeCartografiaColector.aspx.cs"
Inherits="SubPesca.Solicitudes.Colector.pestanaInformeDeCartografiaColector" Theme="admin_style" %>
...
<%@ Register src="../Registrar/evaluacionOrdenamientoTeritorial.ascx" tagname="evaluacionOrdenamientoTerritorial"            tagprefix="uc50" %>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true"></asp:ToolkitScriptManager>
        ...
        <asp:UpdatePanel ID="UpdatePanelInformacionSolicitud" UpdateMode="Conditional" runat="server">
         ...
         <!-- Título de la página -->
            ...
            <asp:Panel ID="PanelEvaluacionOrdenamientoColector"  Visible="true" runat="server">
