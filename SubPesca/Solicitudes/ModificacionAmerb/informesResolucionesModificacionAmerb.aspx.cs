...
{
    public partial class informesResolucionesModificacionAmerb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (despliegueMenuSeccionList != null && despliegueMenuSeccionList.Count > 0)
                {
                    ...
                    if (PanelAntecedentesURB.Visible)
                    {
                        PanelLinkEvaluacionURB.Visible = true;
                    }
                }
                ...
                if (despliegueMenuSeccionList != null && despliegueMenuSeccionList.Count > 0)
                {
                    ...
                    if (PanelExamenPreliminar.Visible)
                    {
                        PanelLinkSuficienciaFormal.Visible = true;
                    }
                }
        ...
        protected void FlujoSEA_change(object sender, EventArgs e)
        {
            ...
            List<DespliegueMenuSeccion> despliegueMenuSeccionList = despliegueMenuSeccionDA.ListarDespliegueMenuSeccion_UE(rbMenu.INFORME_AMBIENTAL_MODIFICACION, 0, rbTipo.UNID_ESPACIAL_ACUICULTURA_EN_AMERB);
