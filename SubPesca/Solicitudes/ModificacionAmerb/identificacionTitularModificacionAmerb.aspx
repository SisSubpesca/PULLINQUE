<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionAmerb.Master" AutoEventWireup="true" CodeBehind="identificacionTitularModificacionAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionAmerb.identificacionTitularModificacionAmerb" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Identificación del Titular de Acuicultura en Amerb</span>
            </td>
        </tr>
    </table>
