<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionAmerb.Master" AutoEventWireup="true" CodeBehind="datosModificacionAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionAmerb.datosModificacionAmerb" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Datos del Trámite de Modificación de Amerb</span>
            </td>
        </tr>
    </table>
        ...
        <br />
            ...
            <asp:Panel ID="PanelDatosInicio" Visible="false" runat="server">
                ...
                <tr>
                    ...
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:Label ID="numeroCI" autocomplete="tel-extension" runat="server"></asp:Label></td>
                </tr>
                <tr>
                    <td class="col1"><span class="item">Fecha CI</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:Label ID="fechaCI" runat="server"></asp:Label></td>
                </tr>

                <tr>
                    <td class="col1"><span class="item">Lugar de Ingreso</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3"><asp:Label ID="oficina" runat="server"></asp:Label></td>
                </tr>
   ...
   <asp:Panel ID="PanelDatosSol" Visible="false" runat="server">
    ...
    <ContentTemplate> 
            ...
            <asp:Panel ID="Panel3"  Visible="true" runat="server">
                <uc0:checkTramitaUTS ID="checkTramitaUTS1" runat="server" />
            </asp:Panel>
