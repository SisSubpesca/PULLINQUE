<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionAmerb.Master" AutoEventWireup="true" 
CodeBehind="unidadesEspacialesModificacionAmerb.aspx.cs" Inherits="SubPesca.Solicitudes.ModificacionAmerb.unidadesEspacialesModificacionAmerb" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Modificación de Centro de Acuicultura en AMERB</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos del Centro de Cultivo en AMERB</legend>
              ...
              <%--  <asp:UpdatePanel ID="UpdatePanelCapitaniaDePuerto" UpdateMode="Conditional" runat="server">
                ...
                <tr>
                    ...
                    <td class="col3">
                        ...
                        <asp:DropDownList ID="PlazoNominal" runat="server" CausesValidation = "true"></asp:DropDownList>                  
                ...
                <asp:UpdatePanel ID="UpdatePanelPlazoNominalVencimiento" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                ...
                <div class="calendario">
                    <div class="calendario_textbox">               
                        <asp:TextBox ID="PlazoVencimiento" Columns="8" Width="120px" runat="server"></asp:TextBox>
                   
                    </div>

                    <asp:Panel ID="PanelPlazoVencimiento" Visible="true" runat="server">
                        <div class="calendario_icono">
                    ...
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorPlazoVencimiento" runat="server" ControlToValidate="PlazoVencimiento"  ValidationGroup="grupo1"
                        ErrorMessage="Plazo de Vencimiento" Display="Static">*</asp:RequiredFieldValidator>

                    <asp:RegularExpressionValidator 
                        ID="RegularExpressionValidatorPlazoVencimiento" 
                        runat="server"
               ...
               <ContentTemplate>
                   ...
                   <tr>
                        <td class="col1" colspan="4" align="center">
                            ...
                            AlternateText="Modificar Amerb" ToolTip="Modificar Concesión" onclick="CrearConcesion_Click" 
                            CausesValidation="true" ValidationGroup="grupo1" style="width: 20px" />
                            <span class="item">Modificar Amerb</span>
                        </td>
                    </tr>
                    </table>
