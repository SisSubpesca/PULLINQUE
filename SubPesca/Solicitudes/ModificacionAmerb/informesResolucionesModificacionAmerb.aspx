<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionAmerb.Master" AutoEventWireup="true" CodeBehind="informesResolucionesModificacionAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionAmerb.informesResolucionesModificacionAmerb" Theme="admin_style" %>
...
<%@ Register src="../Registrar/examenPreliminar.ascx"                               tagname="examenPreliminar"                      tagprefix="uc35" %>

<%@ Register src="~/Solicitudes/Registrar/informeDeCartografia.ascx"           tagname="informeDeCartografia"                      tagprefix="uc30" %>
<%@ Register src="~/Solicitudes/Modificacion/unidadDeDependencia.ascx"         tagname="unidadDeDependencia"                       tagprefix="uc31" %>
<%@ Register src="~/Solicitudes/Registrar/informeDeCartografiaObservacion.ascx" tagname="informeDeCartografiaObservacion"           tagprefix="uc29" %>

<%@ Register src="~/Solicitudes/Registrar/inspeccionTerreno.ascx"               tagname="inspeccionTerreno"                         tagprefix="uc28" %>
<%@ Register src="~/Solicitudes/Registrar/inspeccionTerrenoCoordenadas.ascx"    tagname="inspeccionTerrenoCoordenadas"              tagprefix="uc31" %>
<%@ Register src="~/Solicitudes/Registrar/inspeccionTerrenoObservacion.ascx"    tagname="inspeccionTerrenoObservacion"              tagprefix="uc27" %>

<%@ Register src="~/Solicitudes/Registrar/bancoNatural.ascx"                    tagname="bancoNatural"                              tagprefix="uc26" %>
<%@ Register src="~/Solicitudes/Registrar/bancoNaturalObservacion.ascx"         tagname="bancoNaturalObservacion"                   tagprefix="uc25" %>

<%@ Register src="~/Solicitudes/Registrar/difusionBancoNatural.ascx"            tagname="difusionBancoNatural"                      tagprefix="uc24" %>
<%@ Register src="~/Solicitudes/Registrar/difusionBancoNaturalObservacion.ascx" tagname="difusionBancoNaturalObservacion"           tagprefix="uc23" %>

<%@ Register src="~/Solicitudes/Registrar/difrol.ascx"                          tagname="difrol"                                    tagprefix="uc22" %>
<%@ Register src="~/Solicitudes/Registrar/difrolObservacion.ascx"               tagname="difrolObservacion"                         tagprefix="uc21" %>


<%@ Register src="~/Solicitudes/Registrar/informeSEACartaTitular.ascx"              tagname="informeSEACartaTitular"                tagprefix="uc19" %>
<%@ Register src="~/Solicitudes/Registrar/informeSEARCA.ascx"                       tagname="informeSEARCA"                         tagprefix="uc18" %>
<%@ Register src="~/Solicitudes/Registrar/informeSEAConsultaSEA.ascx"               tagname="informeSEAConsultaSEA"                 tagprefix="uc17" %>
<%@ Register src="~/Solicitudes/Registrar/informeSEACartaAmbiental.ascx"            tagname="informeSEACartaAmbiental"              tagprefix="uc16" %>
<%@ Register src="~/Solicitudes/Registrar/informeSEAInformeUnidadAmbiental.ascx"    tagname="informeSEAInformeUnidadAmbiental"      tagprefix="uc15" %>
<%@ Register src="~/Solicitudes/Registrar/informeSEAObservacion.ascx"               tagname="informeSEAObservacion"                 tagprefix="uc14" %>

<%@ Register src="~/Solicitudes/Registrar/antecedentesComplementarios.ascx"                 tagname="antecedentesComplementarios"               tagprefix="uc13" %>
<%@ Register src="~/Solicitudes/Registrar/certificadoOperacion.ascx"                        tagname="certificadoOperacion"                      tagprefix="uc33" %>
<%@ Register src="~/Solicitudes/Registrar/antecedentesComplementariosObservacion.ascx"      tagname="antecedentesComplementariosObservacion"    tagprefix="uc12" %>

<%@ Register src="~/Solicitudes/Registrar/planos.ascx"                          tagname="planos"                        tagprefix="uc11" %>
<%@ Register src="~/Solicitudes/Registrar/planosInformeTecnicoUOT.ascx"         tagname="planosInformeTecnicoUOT"       tagprefix="uc10" %>
<%@ Register src="~/Solicitudes/Registrar/planosObservacion.ascx"               tagname="planosObservacion"             tagprefix="uc9" %>

<%@ Register src="~/Solicitudes/Registrar/informeDAC.ascx"                      tagname="informeDAC"                    tagprefix="uc8" %>
<%@ Register src="~/Solicitudes/Registrar/informeDACDevolucionJuridica.ascx"    tagname="informeDACDevolucionJuridica"  tagprefix="uc7" %>
<%@ Register src="~/Solicitudes/Registrar/informeDACObservacion.ascx"           tagname="informeDACObservacion"         tagprefix="uc6" %>
...
<%@ Register src="~/Solicitudes/Registrar/resolucionSSFFAA.ascx"                tagname="resolucionSSFFAA"              tagprefix="uc2" %>
<%@ Register src="~/Solicitudes/Registrar/resolucionSSFFAAObservacion.ascx"     tagname="resolucionSSFFAAObservacion"   tagprefix="uc1" %>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true"></asp:ToolkitScriptManager>
     ...
     <fieldset>
        ...
        <tr>
            ...
            <td>
                <asp:Panel ID="PanelLinkEvaluacionURB" Visible="true" runat="server">
                    <a class="tab1_selected" id="ctl00_rightbody_lnk_EvaluacionURB" onclick="javacript:mostrarPestanas(15);">Evaluación URB</a>
                </asp:Panel>
            </td>

            <td>
                <asp:Panel ID="PanelLinkSuficienciaFormal" Visible="true" runat="server">
                    <a class="tab1" id="ctl00_rightbody_lnk_SuficienciaFormal" onclick="javacript:mostrarPestanas(14);">Suficiencia Formal</a>
                </asp:Panel>
            </td>

            <td>
                <asp:Panel  ID="PanelInfCartografia" Visible="false" runat="server">
                    <a class="tab1" id="ctl00_rightbody_lnk_InfCartografia" onclick="javacript:mostrarPestanas(1);">IT U.O.T.</a>
                </asp:Panel>
            </td>

            <td>
                <asp:Panel  ID="PanelInspTerreno" Visible="false" runat="server">
                    <a class="tab2" id="ctl00_rightbody_lnk_InspTerreno" onclick="javacript:mostrarPestanas(2);">Inspeccion en terreno</a>
                </asp:Panel>
            </td>

            <td>
                <asp:Panel  ID="PanelBancoNat" Visible="false" runat="server">
                    <a class="tab3" id="ctl00_rightbody_lnk_BancoNatural" onclick="javacript:mostrarPestanas(3);">Banco Natural</a>
                </asp:Panel>
            </td>

            <td>
                <asp:Panel  ID="PanelDifBancoNat" Visible="false" runat="server">
            ...
            <td>
               <asp:Panel  ID="PanelInfAmbiental" Visible="false" runat="server">
                    <a class="tab6" id="ctl00_rightbody_lnk_InformeSEA" onclick="javacript:mostrarPestanas(6);">Informe Ambiental</a>
               </asp:Panel>
            </td>

            <td>
               <asp:Panel  ID="PanelAntCompl" Visible="false" runat="server">
            ...
            <td>
                <asp:Panel  ID="PanelResolSSFFAA" Visible="false" runat="server">
         ...
         <div id="seccion15" style="display:;">
        ...
        <div id="seccion14" style="display:none;">
            ...
            <asp:Panel ID="PanelExamenPreliminar"  Visible="true" runat="server">
                <uc35:examenPreliminar ID="examenPreliminar" runat="server" />
            </asp:Panel>
        ...
        <div id="seccion1" style="display:none;">
                ...
                <asp:Panel ID="PanelInforCart"  Visible="false" runat="server">
                    <uc30:informeDeCartografia ID="informeDeCartografia" runat="server" />
                </asp:Panel>
                <asp:Panel ID="PanelunidadDeDependencia"  Visible="false" runat="server">
                    <uc31:unidadDeDependencia ID="unidadDeDependencia" runat="server" />
                </asp:Panel>
                <asp:Panel ID="PanelInforCartObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion2" style="display:none;">
            ...
            <asp:Panel ID="PanelInspeccionTerreno"  Visible="false" runat="server">
                <uc28:inspeccionTerreno ID="inspeccionTerreno" runat="server" />
            </asp:Panel>

            <asp:Panel ID="PanelInspeccionTerrenoCoordenadas"  Visible="false" runat="server">
                <uc31:inspeccionTerrenoCoordenadas ID="inspeccionTerrenoCoordenadas" runat="server" />
            </asp:Panel>

            <asp:Panel ID="PanelInspeccionTerrenoObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion3" style="display:none;">
            ...
            <asp:Panel ID="PanelBancoNatural"  Visible="false" runat="server">
                <uc26:bancoNatural ID="bancoNatural" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelBancoNaturalObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion4" style="display:none;">
            ...
            <asp:Panel ID="PanelDifusionBancoNatural"  Visible="false" runat="server">
                <uc24:difusionBancoNatural   ID="difusionBancoNatural" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelDifusionBancoNaturalObservacion"  Visible="false" runat="server">
         ...
         <div id="seccion5" style="display:none;">
            ...
            <asp:Panel ID="PanelDifrol"  Visible="false" runat="server">
                <uc22:difrol ID="difrol" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelDifrolObservacion"  Visible="false" runat="server">
           ...
           <%-- <!-- check debe evaluarse ambientalmente -->
            ...
            <ContentTemplate> 
                    ...
                    <asp:Panel ID="PanelCheck"  Visible="true" runat="server">
                        <uc1:checkEvaluarseAmbientalmente ID="checkEvaluarseAmbientalmente" runat="server" />
                    </asp:Panel>
...
--%>
            ...
            <asp:Panel ID="PanelInformeSEAObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion7" style="display:none;">
            ...
            <asp:Panel ID="PanelAntecedentesComplementarios"  Visible="false" runat="server">
            ...
            <asp:Panel ID="PanelAntecedentesComplementariosObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion8" style="display:none;">            
            ...
            <asp:Panel ID="PanelPlanos"  Visible="false" runat="server">
                <uc11:planos ID="planos" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelPlanosInformeTecnicoUOT"  Visible="false" runat="server">
                <uc10:planosInformeTecnicoUOT ID="planosInformeTecnicoUOT" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelPlanosObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion9" style="display:none;">         
            ...
            <asp:Panel ID="PanelInformeDAC"  Visible="false" runat="server">
                <uc8:informeDAC ID="informeDAC" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelInformeDACDevolucionJuridica"  Visible="false" runat="server">
                <uc7:informeDACDevolucionJuridica ID="informeDACDevolucionJuridica" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelInformeDACObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion10" style="display:none;">  
            ...
            <asp:Panel ID="PanelResolucionSSP"  Visible="false" runat="server">
                <uc5:resolucionSSP ID="resolucionSSP" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelResolucionSSPDevolucionSSFFAA"  Visible="false" runat="server">
                <uc4:resolucionSSPDevolucionSSFFAA ID="resolucionSSPDevolucionSSFFAA" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelResolucionSSPObservacion"  Visible="false" runat="server">
        ...
        <div id="seccion11" style="display:none;">  
            ...
            <asp:Panel ID="PanelResolucionSSFFAA"  Visible="false"  runat="server">
                <uc2:resolucionSSFFAA ID="resolucionSSFFAA" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelResolucionSSFFAAObservacion"  Visible="false" runat="server">
