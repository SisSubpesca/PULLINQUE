<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacionAmerb.Master" AutoEventWireup="true" CodeBehind="pestanaEvaluacionURBModificacionAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionAmerb.pestanaEvaluacionURBModificacionAmerb"  Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true"></asp:ToolkitScriptManager>
        ...
        <asp:UpdatePanel ID="UpdatePanelInformacionSolicitud" UpdateMode="Conditional" runat="server">
            ...
            <hr style="width:100%;" />
            <asp:Panel ID="PanelAntecedentesURB"  Visible="false" runat="server">
