<%@ Page Language="C#"  MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="redefinirTramiteModificacionAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.ModificacionAmerb.redefinirTramiteModificacionAmerb" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Redefinir Tr&aacute;mite de Modificac&oacute;n de Acuicultura en Amerb</span>
            </td>
        </tr>
    </table>
    <hr style="width:100%;" />
