...
{
    public partial class ingresarSolicitudRelocalizacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack) {
                ...
                TramiteRelocalizacion nuevoTramiteRelocalizacion = (TramiteRelocalizacion)Session["nuevoTramiteRelocalizacion"];
                ...
                else if (nuevoTramiteRelocalizacion != null)
                {
                    ...
                    ViewState["Tramite"] = nuevoTramiteRelocalizacion;
                    numeroPert.Text = Convert.ToString(nuevoTramiteRelocalizacion.numPert);

                    ViewState["Sectores_Tramite"] = (List<DetalleSector>)nuevoTramiteRelocalizacion.sectores;
        ...
        protected void GuardarTramite_Click(object sender, EventArgs e)
        {
            ...
            tramiteRelocalizacion.tipoRelocalizacion = new ParametroGenerico(rbTipo.RELOCALIZACION_LEY);
