<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ingresarSolicitudRelocalizacion.aspx.cs" 
Inherits="SubPesca.Solicitudes.Relocalizacion.ingresarSolicitudRelocalizacion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Generar Trámite de Relocalización Nº PERT: <asp:Label ID="numeroPert" runat="server"></asp:Label></span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
