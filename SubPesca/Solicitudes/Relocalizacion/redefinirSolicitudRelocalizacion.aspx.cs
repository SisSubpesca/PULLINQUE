...
{
    public partial class redefinirSolicitudRelocalizacion : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                List<ParametroGenerico> resp = relocalizacionService.ListarPreferenciaRelocalizacion();
                ...
                if (Request.QueryString["idTramiteRel"] != null)
                {
                    ...
                    if (tramiteRelocalizacion != null && tramiteRelocalizacion.idTramiteRel > 0)
                    {
                        ...
                        ViewState["Sectores_Tramite"] = tramiteRelocalizacion.sectores;
        ...
        protected void MostrarPreferenciasOrigen(string codigoSiep)
        {
            ...
            List<DetalleSector> sectores = (List<DetalleSector>)ViewState["Sectores_Tramite"];
            bool salir = false;
        ...
        protected void GridOrigen_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (PanelBotonOrigen.Visible == true)
                {
        ...
        protected void GridOrigen_Cargar(int index)
        {
            ...
            List<OrigenSector> origenes = (List<OrigenSector>)ViewState["Origenes_Asociados"];
        ...
        protected void GuardarOrigen_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                else
                {
                    ...
                    List<String> errores = tramiteRelocalizacionValidacion.validaIngresoOrigenSector(nuevoOrigen, origenes, false);
                    ...
                    else
                    {
                        ...
                        ViewState["Origenes_Asociados"] = (List<OrigenSector>)origenes;
                        GridOrigen.DataSource = origenes;
                        GridOrigen.DataBind();
                    }
                }
        ...
        protected void ModificarOrigen(int indexModificar)
        {
            ...
            if (Page.IsValid)
            {
                ...
                List<String> errores = tramiteRelocalizacionValidacion.validaModificarOrigenSector(origenModificado, origenes, indexModificar);
        ...
        protected void LimpiarFormularioOrigen()
        {
            ...
            ViewState["Origenes_Asociados"] = null;
        ...
        protected void GridOrigen_Eliminar(int index)
        {
            ...
            foreach (OrigenSector aOrigenSector in origenes)
            {
                if (aOrigenSector.index == index)
                {
                    List<String> errores = tramiteRelocalizacionValidacion.validaEliminacionOrigenSector(aOrigenSector);
                    if (errores.Count > 0)
                    {
                        foreach (String error in errores)
                        {
        ...
        protected void GuardarSector_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                nuevoSector.tramiteRel = (TramiteRelocalizacion)ViewState["Tramite"];
                ...
                if (Page.IsValid)
                {
                    ...
                    if (nuevoSector.esSectorCero)
                    {
                        ...
                        nuevoSector.tipoRelocalizacion = new ParametroGenerico(rbTipo.RELOCALIZACION_SECTOR_CERO, cadenas.RELOCALIZACION_SECTOR_CERO);
                        ...
                        errores = tramiteRelocalizacionValidacion.validaIngresoOrigenSector(origenSector, null, true);
                    ...
                    else
                    {
                        ...
                        nuevoSector.origenes = (List<OrigenSector>)ViewState["Origenes_Asociados"];
                        ...
                        if (opcionCrea.Checked)
                        {
                            nuevoSector.tipoRelocalizacion = new ParametroGenerico(rbTipo.RELOCALIZACION_CREA, cadenas.RELOCALIZACION_CREA);
                        }

                        if (opcionFusiona.Checked)
                        {
                            nuevoSector.tipoRelocalizacion = new ParametroGenerico(rbTipo.RELOCALIZACION_FUSIONA, cadenas.RELOCALIZACION_FUSIONA);
                        }
                    ...
                    {
                        errores = tramiteRelocalizacionValidacion.validaIngresoSectorRelocalizacion(nuevoSector, sectores);
                    }
                    ...
                    if (errores.Count == 0)
                    {
                        ...
                        ViewState["Sectores_Tramite"] = (List<DetalleSector>)sectores;
        ...
        protected void LimpiarFormulario(object sender, EventArgs e)
        {
            ...
            botonGuardarOrigen.Text = "Guardar Origen";
            PanelBotonOrigen.Visible = true;
            UpdatePanelBotonOrigen.Update();

            botonGuardarSector.Text = "Guardar Sector";
            PanelBotonSector.Visible = true;
        ...
        protected void GridSectores_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //TIENE SSP
                HiddenField hidden_SSP = (HiddenField)e.Row.FindControl("gSSP");
                if (hidden_SSP != null && !hidden_SSP.Value.Equals("") && Convert.ToBoolean(hidden_SSP.Value) == false)
                {
                    ...
                    if (boton_modificar != null)
                    {
                        if (permisosService.tieneAccesoA())
                        {
                            boton_modificar.Attributes.Add("onclick", "javascript:return " + "confirm('¿Está seguro que desea modificar este sector? (Todos los documentos en la solicitud de este sector quedaran No Vigentes)')");
                            boton_modificar.Visible = true;
                        }
                    };
        ...
        //GRID SECTOR
        protected void GridSectores_Cargar_Ver(int index)
        {
            ...
            PanelBotonOrigen.Visible = false;
            UpdatePanelBotonOrigen.Update();

            PanelBotonSector.Visible = false;
            UpdatePanelBotonSector.Update();
            ...
            foreach (DetalleSector aDetalleSector in sectores)
            {
                if (aDetalleSector.index == index)
                {
                    ...
                    if (aDetalleSector.esSectorCero)
                    {
                        ...
                        ViewState["Origenes_Asociados"] = (List<OrigenSector>)aDetalleSector.origenes;
                    }
                    else
                    {
        ...
        protected void ModificarSector(int indexModificar)
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (errores == null || errores.Count == 0)
                {
                    errores = tramiteRelocalizacionValidacion.validaModificarSectorRelocalizacion(nuevoSector, sectores, indexModificar);
                }
        ...
        protected void GuardarTramite_Click(object sender, EventArgs e)
        {
            ...
            tramiteRelocalizacion.sectores = (List<DetalleSector>)ViewState["Sectores_Tramite"];


            List<String> errores = tramiteRelocalizacionValidacion.validaTramiteRelocalizacion(tramiteRelocalizacion);


            if (errores.Count == 0)
            {

                if (relocalizacionService.RedefinirTramiteRelocalizacion(tramiteRelocalizacion, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario))
                {
                    this.mensaje = "Tramite redefinido con éxito";
