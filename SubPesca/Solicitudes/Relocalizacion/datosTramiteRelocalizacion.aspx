<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesRelocalizacion.Master" AutoEventWireup="true"
 CodeBehind="datosTramiteRelocalizacion.aspx.cs" Inherits="SubPesca.Solicitudes.Relocalizacion.datosTramiteRelocalizacion" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Datos del Trámite de Relocalización</span>
            </td>
        </tr>
    </table>
