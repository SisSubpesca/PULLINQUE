<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesAmerb.Master" AutoEventWireup="true" 
CodeBehind="unidadEspacialAmerb.aspx.cs" Inherits="SubPesca.Solicitudes.Amerb.unidadEspacialAmerb" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Creación de Acuicultura en AMERB</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        ...
        <br /> 
                ...
                <ContentTemplate>
                    <asp:Panel ID="PanelCodigoCentro" runat="server" Visible="true">
                        ...
                        <tr>
                           ...
                           <td class="col3">
                               <asp:TextBox ID="CodigoCentro" MaxLength="15" Width="80px" runat="server" CausesValidation="true"></asp:TextBox> 
                ...
                <asp:Panel id="PanelBotonCreacion" runat="server" Visible="false">
                    ...
                    <tr>
                        <td class="col1" colspan="4" align="center">
                             ...
                             <asp:ImageButton ID="CrearConcesionButton" runat="server" ImageUrl="~/App_Themes/admin_style/images/add.png" Height="20px" 
                                   AlternateText="Crear Amerb" ToolTip="Crear Concesión" onclick="CrearConcesion_Click" 
                                   CausesValidation="true" ValidationGroup="grupo1" />
                            <span class="item">Crear Amerb</span>&nbsp;&nbsp;<asp:ImageButton 
                ...
                <asp:Panel id="PanelMensajePendientes" runat="server" Visible="false">
                    <table class="form" cellpadding="0px" cellspacing="0px" width="100%">   
                    <tr>
                        <td class="col1" colspan="4" align="center"><span style="color:#772222;">Advertencia: Aun existen documentos pendientes que no permiten la Creación del Centro de Cultivo en AMERB, sin embargo puede guardar la información contenida en esta página (El Centro no se creará)</span></td>
                    </tr>
                    <tr>
