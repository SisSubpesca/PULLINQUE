<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="inicioSolicitudAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.Amerb.inicioSolicitudAmerb" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <fieldset>
        <legend>Datos de la Solicitud de Acuicultura Amerb</legend>
        <br />
    ...
    <script type="text/javascript">
        invoca_calendarios("inicioSolicitudAmerb");
    </script>
