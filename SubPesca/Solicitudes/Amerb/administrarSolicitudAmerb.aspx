<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarSolicitudAmerb.aspx.cs" 
Inherits="SubPesca.Solicitudes.Amerb.administrarSolicitudAmerb" Theme="admin_style" %>

<%@ Reference Page="inicioSolicitudAmerb.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Tr&aacute;mites de Solicitudes de Acuicultura Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Tr&aacute;mites de Solicitudes de Acuicultura Amerb</legend>
    ...
    <tr>
        ...
        <td class="col3" colspan="4">
            <asp:UpdatePanel ID="UpdatePanelNumeroCI" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="NumeroCI" Width="160px" AutoPostBack="true" runat="server" onChange="return onlyNumeric(this)" onKeyUp="return onlyNumeric(this)"  MaxLength="20"></asp:TextBox>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
                ...
                <ContentTemplate>
                    <div class="calendario">
                        <div class="calendario_textbox">               
                            ...
                            <asp:MaskedEditExtender ID="MaskedEditExtender3" runat="server" TargetControlID="FechaCI"
                        ...
                        &nbsp;&nbsp;&nbsp;<asp:CustomValidator ID="CustomValidator2" ControlToValidate="FechaCI"  ClientValidationFunction="validaFechaDDMMAAAA" Display="static" Font-Size="10" runat="server">Fecha no válida</asp:CustomValidator>
    ...
    <tr>
        ...
        <td class="col3" colspan="4">
            <asp:UpdatePanel ID="UpdatePanelAmerb" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="Amerb" Width="160px" AutoPostBack="true" runat="server" onChange="return onlyNumeric(this)" onKeyUp="return onlyNumeric(this)"  MaxLength="20"></asp:TextBox>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
                       ...
                       Width="100%">
                        <Columns>
                            <asp:TemplateField Visible="false">
                                <ItemTemplate>
                                    <asp:Label HeaderText="EstadoTramite" ID="EstadoTramite" runat="server" Visible="false" Text='<%# (DataBinder.Eval(Container, "DataItem.estadoActual.id")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="NumeroCI">
                                <ItemTemplate>
                                     <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode(Eval("datosSolicitudUE.numeroCI")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="FechaCI">
                                <ItemTemplate>
                                     <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode(Eval("datosSolicitudUE.fechaCI")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Codigo Amerb">
                                <ItemTemplate>
                                    <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode(((string)Eval("datosSolicitudUE.codAmerb"))) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="60px">
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="gTerminar" Visible="false" runat="server" CausesValidation="false" CommandName="Terminar" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/cerrar.jpg" Height="20px" AlternateText="Terminar Trámite" ToolTip="Terminar Trámite" />

                                    <asp:ImageButton ID="gExperimental" Visible="false" runat="server" CausesValidation="false" CommandName="Experimental" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/exportar_datos_01.png" Height="20px" AlternateText="Transformar en Experimental" ToolTip="Transformar en Experimental" />
    ...
    <script type="text/javascript">
        ...
        invoca_calendarios("ingresarDocumento_fechaCI");
    </script></asp:Content>