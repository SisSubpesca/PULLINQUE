...
{
    public partial class administrarSolicitudModificacion : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_SOLICITUD_MODIFICACION_CONCESION };
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "SubtipoTramite":
                    ...
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Concesión: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_CONCESION_AMPLIA_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Concesión: Reducción de Superficie", Convert.ToString(rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Concesión: Especie", Convert.ToString(rbTipo.MOD_CONCESION_ESPECIE)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Concesión: Proyecto Técnico", Convert.ToString(rbTipo.MOD_CONCESION_PT)));
                    SubtipoTramite.Items.Add(new ListItem("Solicitud Modificación Concesión: Regularización", Convert.ToString(rbTipo.MOD_CONCESION_REGULARIZACION)));
        ...
        protected void FiltrarCargaGrilla(object sender, EventArgs e)
        {
            ...
            if (!CodigoCentro.Text.Equals("") && Convert.ToInt32(CodigoCentro.Text) > 0)
            {
                 ...
                 solicitudFiltro.unidadEspacial.centrosDeCultivo.codigoCentro = Convert.ToString(CodigoCentro.Text);
            }
        ...
        protected void CargaGrilla()
        {
            ...
            respSolicitudes = solicitudDA.ListarSolicitudConcesionModAdmin_Tramite(solicitudFiltro);
            respSolicitudesAutorizadas = solicitudDA.ListarSolicitudConcesionModAdmin_Aprobada(solicitudFiltro);
            respSolicitudesRechazadas = solicitudDA.ListarSolicitudConcesionModAdmin_Rechazada(solicitudFiltro);
        ...
        protected void GridConcesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "Redefinir":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/Modificacion/redefinirTramiteModificacion.aspx?idSolConces=" + idSolConces);
                    break;
                ...
                case "ErroresSolicitud":
                    ...
                    idSolConces = Convert.ToInt32(e.CommandArgument);
                    Response.Redirect("~/Solicitudes/Modificacion/erroresTramiteModificacion.aspx?idSolConces=" + idSolConces);
                    break;
        ...
        private void eliminarSolicitudModificacion(int idSolConces)
        {
            ...
            bool resp = solicitudModificacionService.eliminarSolicitudModificacion(idSolConces, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
        ...
        protected void ExportarGrilla1_Click(object sender, EventArgs e)
        {
            ...
            string nom_grilla = "solicitudModificacionConcesionEnTramite";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudModificacionConcesionEnTramite":
                    GridConcesAdm.Columns.RemoveAt(10);
                    grilla = GridConcesAdm;
                    ngrilla = "solicitudModificacionConcesionEnTramite.xls";
                    break;
        ...
        {
            GridView grilla = new GridView();
            string nom_grilla = "solicitudModificacionConcesionAprobada";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudModificacionConcesionAprobada":
                    GridSolicitudesAdm.Columns.RemoveAt(10);
                    grilla = GridSolicitudesAdm;
                    ngrilla = "solicitudModificacionConcesionAprobada.xls";
                    break;
        ...
        {
            GridView grilla = new GridView();
            string nom_grilla = "solicitudModificacionConcesionRechazada";
            string ngrilla = "";
            ...
            switch (nom_grilla)
            {
                case "solicitudModificacionConcesionRechazada":
                    GridViewRechazada.Columns.RemoveAt(10);
                    grilla = GridViewRechazada;
                    ngrilla = "solicitudModificacionConcesionRechazada.xls";
                    break;
