<%@ Page Language="C#"  MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="redefinirTramiteModificacion.aspx.cs" 
Inherits="SubPesca.Solicitudes.Modificacion.redefinirTramiteModificacion" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Redefinir Tr&aacute;mite de Modificac&oacute;n de Concesi&oacute;n</span>
            </td>
        </tr>
    </table>
    <hr style="width:100%;" />
