...
{
    public partial class referenciaGlobal : System.Web.UI.Page
    {
        ...
        String labelDocumentos = "Documentos Referencia Global Sernapesca";
        ...
        protected void filtraDocumentos()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                /* Datos Referencia Global Sernapesca */
                if (solicitudModificacionService.despligueSeccionesMenu(solicitudConcesion, despliegueMenuSeccionList, rbSeccion.REFERENCIA_GLOBAL_SERNAPESCA))
                {
                    ...
                    PanelGridRequerimiento.Visible = true;
                ...
                /* Sección Datos Solicitud de Acuicultura */
                if (solicitudModificacionService.despligueSeccionesMenu(solicitudConcesion, despliegueMenuSeccionList, rbSeccion.DATOS_SOLICITUD_ACUICULTURA))
                {
                    if (!solicitudModificacionService.tieneSoloTipoModificacionRegularizacion(solicitudConcesion))
                    {
                        ...
                        PanelGeneralVisibilidad.Visible = true;
        ...
        private void CargaSeccionFechasGral(SolicitudConcesion solicitudConcesion)
        {
            ...
            FechaTextRecepcion.Text = fechaRecepcion;
            FechaTextIngresoTramite.Text = fechaIngresoTramite;
        }
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                case "FlujoDocumental":
                    ...
                    validacionDocumentacion = new ValidacionDocumentacion();
                    validacionDocumentacion.ambito = new ParametroGenerico(Convert.ToInt32(dbPestana));
                    validacionDocumentacion.seccion = new ParametroGenerico(Convert.ToInt32(dbSeccion));
        ...
        protected void Guardar_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                requerimiento.solicitud = (Datos.Entidades.SolicitudConcesion)Session["solicitudModificacion"];
        ...
        protected void GridRequerimiento_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Ver":
                    ...
                    break;
                case "Administrar":
                    Response.Redirect("~/Solicitudes/Modificacion/administrarDocumento.aspx?idRequerimiento=" + idRequerimiento);
                    break;
                case "Evaluar":
                    Response.Redirect("~/Solicitudes/Modificacion/evaluarDocumento.aspx?idRequerimiento=" + idRequerimiento);
                    break;
                case "Eliminar":
        ...
        protected void GuardarDatosGralSolicitud_Click(object sender, ImageClickEventArgs e)
        {
            ...
            SolicitudConcesion solicitudInicial = (Datos.Entidades.SolicitudConcesion)Session["SolicitudModificacion"];

            //SolicitudConcesion solicitudInicial = solicitudDA.ObtieneSolicitudConcesion(Convert.ToInt32(IdSolicitud.Value));
            if (solicitudInicial != null)
            {
                solicitudInicial = this.generarFechas(solicitudInicial, FechaTextRecepcion.Text, FechaTextIngresoTramite.Text);

                List<String> listErroresSolicitud = generalValidacion.validaGeneral(solicitudInicial);

                if (listErroresSolicitud.Count <= 0)
                {
                    if (solicitudModificacionService.guardarSolicitudModificacionConcesion(solicitudInicial, Session["Usuario"] == null ? 0 : ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario))
                    {
                        Session["SolicitudModificacion"] = (SolicitudConcesion)solicitudInicial;

                        msgGrillaGral_1.Text = "Se han guardado la Referencia Global de la Solicitud exitosamente.";
                        msgGrillaGral_1.Focus();
                        Content_msgGrillaGral_1.Visible = true;
                    }
                    else
                    {
                        msgGrillaGral_1.Text = "No se ha guardado la Referencia Global de la Solicitud.";
                        msgGrillaGral_1.Focus();
                        Content_msgGrillaGral_1.Visible = true;
