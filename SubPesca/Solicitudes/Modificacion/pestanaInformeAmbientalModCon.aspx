<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacion.Master" AutoEventWireup="true" CodeBehind="pestanaInformeAmbientalModCon.aspx.cs" 
Inherits="SubPesca.Solicitudes.Modificacion.pestanaInformeAmbientalModCon"  Theme="admin_style" %>
...
<%@ Register src="../Registrar/checkRequiereEvaluacionAmbiental.ascx"                        tagname="checkRequiereEvaluacionAmbiental"                           tagprefix="uc0" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server" EnablePartialRendering="true"></asp:ToolkitScriptManager>
        ...
        <asp:UpdatePanel ID="UpdatePanelInformacionSolicitud" UpdateMode="Conditional" runat="server">
            ...
            <!-- check requiere evaluación ambiental -->
            <asp:UpdatePanel ID="UpdatePanel2" UpdateMode="Conditional" runat="server">
            <ContentTemplate> 

                    <asp:Panel ID="Panel3"  Visible="true" runat="server">
                        <uc0:checkRequiereEvaluacionAmbiental ID="checkRequiereEvaluacionAmbiental" runat="server" />
                    </asp:Panel>
