<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ingresarSolicitudModificacion.aspx.cs" 
Inherits="SubPesca.Solicitudes.Modificacion.ingresarSolicitudModificacion" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Nueva Solicitud de Modificación de Concesión</span>
            </td>
        </tr>
    </table>
    <hr style="width:100%;" />
        ...
        <br />
           ...
           <asp:UpdatePanel ID="UpdatePanelFechaDesde" UpdateMode="Conditional" runat="server">
            ...
            <tr>
                    ...
                    <td class="col3"><span class="item"><asp:Button ID="Guardar" runat="server" Text="Generar"  CausesValidation="true" ValidationGroup="InicioModificacion"  OnClientClick="return validatePre('InicioModificacion');" onclick="Guardar_Click" /></span></td>
            </tr>
            </ContentTemplate>
            </asp:UpdatePanel>
            </asp:Panel>
