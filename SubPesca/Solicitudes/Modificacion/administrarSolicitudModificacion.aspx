<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarSolicitudModificacion.aspx.cs" 
Inherits="SubPesca.Solicitudes.Modificacion.administrarSolicitudModificacion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Solicitudes de Modificación de Concesión</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <tr>
        ...
        <td class="col3" colspan="4">
            ...
            <ContentTemplate>
                <asp:TextBox ID="CodigoCentro" AutoPostBack="true" runat="server"></asp:TextBox>
        ...
        <td class="col3" colspan="4">
            ...
            <ContentTemplate>
                ...
                <cc1:AutoCompleteExtender 
                    ...
                    ServicePath="adminSolicitudModificacion.asmx"
