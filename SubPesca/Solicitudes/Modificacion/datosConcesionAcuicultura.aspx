<%@ Page Language="C#" MasterPageFile="~/Solicitudes/SitioSolicitudesModificacion.Master" AutoEventWireup="true" CodeBehind="datosConcesionAcuicultura.aspx.cs" 
Inherits="SubPesca.Solicitudes.Modificacion.datosConcesionAcuicultura" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Datos del Trámite de Modificación</span>
            </td>
        </tr>
    </table>
       ...
       <asp:UpdatePanel ID="UpdatePanelSolicitudesPendientes" UpdateMode="Conditional" runat="server">
        ...
        <asp:GridView 
           ...
           <Columns>
               ...
               <asp:TemplateField HeaderText="Nº Pert/Identificador de Solicitud" SortExpression="numPert" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
