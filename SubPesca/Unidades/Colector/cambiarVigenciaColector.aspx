<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="cambiarVigenciaColector.aspx.cs" 
Inherits="SubPesca.Unidades.Colector.cambiarVigenciaColector" Theme="admin_style" %>
...
<fieldset>
        ...
        <tr>
        <td class="col1"><span class="item">Identificador de Solicitud</span></td>
