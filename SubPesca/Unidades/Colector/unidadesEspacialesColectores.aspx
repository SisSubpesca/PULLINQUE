<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioColectorSemillas.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesColectores.aspx.cs" 
Inherits="SubPesca.Unidades.Colector.unidadesEspacialesColectores" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Colector de Semillas</span></td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos del Colector de Semillas</legend>
                ...
                <tr>
                    ...
                    <td class="col3">
                       ...
                       <ContentTemplate>
                            ...
                            <asp:TextBox ID="CodigoCentro" MaxLength="15" Width="80px" runat="server" ReadOnly="true" CssClass="campoDeshabilitado" CausesValidation="true"></asp:TextBox> 
