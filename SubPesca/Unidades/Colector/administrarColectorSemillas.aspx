<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarColectorSemillas.aspx.cs" Inherits="SubPesca.Unidades.Colector.administrarColectorSemillas" Theme="admin_style" %>

<%@ Reference Page="~/Solicitudes/Colector/inicioSolicitudColector.aspx" %>
<%@ Reference Page="~/Solicitudes/Colector/unidadEspacialColector.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Colector de Semillas</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Colectores de Semilla</legend>
    ...
    <tr>
        ...
        <td class="col3" colspan="4">
            <asp:UpdatePanel ID="UpdatePanelNumIdentificadorSolicitud" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="NumIdentificadorSolicitud" Width="80px" AutoPostBack="true" runat="server" onChange="return onlyNumeric(this)" onKeyUp="return onlyNumeric(this)" MaxLength="10"></asp:TextBox>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="150px">
                                <ItemTemplate>
                                         <asp:ImageButton ID="gVer" Visible="false" runat="server" CausesValidation="false" CommandName="VerColector" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Colector Semillas" ToolTip="Ver Colector Semillas" />

                                         <asp:ImageButton ID="gModificar" Visible="false" runat="server" CausesValidation="false" CommandName="ModificarColector" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar Colector Semillas" ToolTip="Modificar Colector Semillas" />
    ...
    <script type="text/javascript">
        invoca_calendarios("administrarSolicitudColector");
    </script>
    
    <div id="historialCambioVigenciaColector" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_historialCambioVigenciaColector" CssClass="cerrar" OnClientClick="javascript:close_dialog('historialCambioVigenciaColector');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
            </div>
            <div class="body">
                <fieldset>
                <legend>Historial que Modifican Vigencia</legend>
                <iframe id="iframe_historialCambioVigenciaColector" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
                      
    <div id="cambiarVigenciaColector" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_cambiarVigenciaColector" CssClass="cerrar" OnClientClick="javascript:close_dialog('cambiarVigenciaColector');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Cambiar Vigencia</legend>
                <iframe id="iframe_cambiarVigenciaConcesion" src="" width="400" height="300" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
    
    <div id="extenderPlazoVigenciaColector" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_extenderPlazoVigenciaColector" CssClass="cerrar" OnClientClick="javascript:close_dialog('extenderPlazoVigenciaColector');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Extender Plazo Vigencia</legend>
                <iframe id="iframe_extenderPlazoVigenciaColector" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div> 
