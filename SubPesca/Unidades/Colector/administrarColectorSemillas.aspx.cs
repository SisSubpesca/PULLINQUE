...
using SubPesca.Solicitudes.Colector;
using LogicaNegocio.cl.subpesca.rb.servicios.solicitudes;

namespace SubPesca.Unidades.Colector
{
    public partial class administrarColectorSemillas : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_UNIDAD_ESPACIAL_COLECTORES };
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else if (PreviousPage != null && PreviousPage is unidadEspacialColector)
                {
                    MensajeSuperior.Text = ((unidadEspacialColector)PreviousPage).MensajeRegistro;
                    PanelMensajeSuperior.Visible = true;
                    UpdatePanelMensajeSuperior.Update();
                }
                ...
                // Cargamos la grilla
                Session["Filtro_Solicitud_Colector_Semilla"] = null;
                CargaGrilla();
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudColectorTraspaso(solicitudFiltro);
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "VerColector":
                    ...
                    Response.Redirect("~/Unidades/Colector/resumenColector.aspx");

                    break;
                case "ModificarColector":
                    ...
                    break;
                case "Desasociar":
                    Response.Redirect("~/Unidades/Colector/cambiarVigenciaColector.aspx?idSolConcesion=" + e.CommandArgument);
                    break;
                ...
                */
                ...
                if (boton_historial != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.HISTORIAL))
                    {
                        ...
                        boton_historial.Attributes.Add("onclick", "javascript:abre_dialogo('historialCambioVigenciaColector', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
                ...
                if (boton_ampliarVigencia != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.AMPLIAR_VIGENCIA))
                    {
                        ...
                        boton_ampliarVigencia.Attributes.Add("onclick", "javascript:abre_dialogo('extenderPlazoVigenciaColector', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            grilla.DataBind();
            SubPesca.Utilidades.GridViewExportUtil.Export("AdministrarColector.xls", grilla);
        }
    }
}