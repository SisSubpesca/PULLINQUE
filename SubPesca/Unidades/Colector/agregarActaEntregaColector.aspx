<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agregarActaEntregaColector.aspx.cs" Theme="admin_style" Inherits="SubPesca.Unidades.Colector.agregarActaEntregaColector" %>
...
<body>
    <form id="dialog_actaEntregaColector" runat="server">
