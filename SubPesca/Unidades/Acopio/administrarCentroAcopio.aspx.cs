...
using SubPesca.Solicitudes.Acopio;
using LogicaNegocio.cl.subpesca.rb.servicios.solicitudes;

namespace SubPesca.Unidades.Acopio
{
    public partial class administrarCentroAcopio : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_UNIDAD_ESPACIAL_ACOPIO };
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else if (PreviousPage != null && PreviousPage is unidadEspacialAcopio)
                {
                    MensajeSuperior.Text = ((unidadEspacialAcopio)PreviousPage).MensajeRegistro;
                    PanelMensajeSuperior.Visible = true;
                    UpdatePanelMensajeSuperior.Update();
                }
                ...
                // Cargamos la grilla
                Session["Filtro_Solicitud_Centro_Acopio"] = null;
                CargaGrilla();
        ...
        protected void CargaGrilla()
        {
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudAcopioTraspaso(solicitudFiltro);
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "VerAcopio":
                    ...
                    Response.Redirect("~/Unidades/Acopio/resumenAcopio.aspx");

                    break;
                case "ModificarAcopio":
                    ...
                    break;
                case "Desasociar":
                    Response.Redirect("~/Unidades/Acopio/cambiarVigenciaAcopio.aspx?idSolConcesion=" + e.CommandArgument);
                    break;
        ...
        protected void GridSolicitudesAdm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (boton_actaEntrega != null)
                {
                    ...
                    boton_actaEntrega.Attributes.Add("onclick", "javascript:abre_dialogo('actaEntregaAcopio', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                }
                */
                ...
                if (boton_historial != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.HISTORIAL))
                    {
                        ...
                        boton_historial.Attributes.Add("onclick", "javascript:abre_dialogo('historialCambioVigenciaAcopio', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
                ...
                if (boton_ampliarVigencia != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.AMPLIAR_VIGENCIA))
                    {
                        ...
                        boton_ampliarVigencia.Attributes.Add("onclick", "javascript:abre_dialogo('extenderPlazoVigenciaAcopio', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            grilla.DataBind();
            SubPesca.Utilidades.GridViewExportUtil.Export("AdministrarAcopio.xls", grilla);
        }
    }
}