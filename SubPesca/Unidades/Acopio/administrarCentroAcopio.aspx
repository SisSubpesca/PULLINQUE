<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarCentroAcopio.aspx.cs" 
Inherits="SubPesca.Unidades.Acopio.administrarCentroAcopio" Theme="admin_style" %>

<%@ Reference Page="~/Solicitudes/Acopio/inicioSolicitudAcopio.aspx" %>
<%@ Reference Page="~/Solicitudes/Acopio/unidadEspacialAcopio.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Centro de Acopio</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Centro de Acopio</legend>

             
    <table class="form" cellpadding="0px" cellspacing="0px">
    <tr>
        <td class="col1"><span class="item">Código de Centro de Acopio</span></td>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="200px">
                                <ItemTemplate>
                                         ...
                                         <asp:ImageButton ID="gVer" Visible="false" runat="server" CausesValidation="false" CommandName="VerAcopio" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Acopio" ToolTip="Ver Acopio" />
                                           
                                         <asp:ImageButton ID="gModificar" Visible="false" runat="server" CausesValidation="false" CommandName="ModificarAcopio" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar Acopio" ToolTip="Modificar Acopio" />
    ...
    <br />
     ...
     <div id="historialCambioVigenciaAcopio" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_historialCambioVigenciaAcopio" CssClass="cerrar" OnClientClick="javascript:close_dialog('historialCambioVigenciaAcopio');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
            </div>
            <div class="body">
                <fieldset>
                <legend>Historial que Modifican Vigencia</legend>
                <iframe id="iframe_historialCambioVigenciaAcopio" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
                    
    <div id="cambiarVigenciaAcopio" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_cambiarVigenciaAcopio" CssClass="cerrar" OnClientClick="javascript:close_dialog('cambiarVigenciaAcopio');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Cambiar Vigencia</legend>
                <iframe id="iframe_cambiarVigenciaAcopio" src="" width="400" height="300" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>

       <div id="extenderPlazoVigenciaAcopio" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_extenderPlazoVigenciaAcopio" CssClass="cerrar" OnClientClick="javascript:close_dialog('extenderPlazoVigenciaAcopio');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Extender Plazo Vigencia</legend>
                <iframe id="iframe_extenderPlazoVigenciaAcopio" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div> 
