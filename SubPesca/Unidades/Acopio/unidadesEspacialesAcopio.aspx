<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioCentroAcopio.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesAcopio.aspx.cs" 
Inherits="SubPesca.Unidades.Acopio.unidadesEspacialesAcopio" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Centro de Acopio</span></td>
        </tr>
    </table>
               ...
               <%-- <asp:Panel ID="PanelCapitaniaPuerto" Visible="false" runat="server">
                ...
                <div class="calendario">
                    ...
                    <asp:Panel ID="Panel1" Visible="false" runat="server">
                        <div class="calendario_icono">
                            <img  src="../../App_Themes/admin_style/images/calendar.png" id="img1" alt="Calendario" style="vertical-align: middle" />
                        </div>
                    </asp:Panel>


                    <asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" ControlToValidate="FechaInicioPeriodo"  ValidationGroup="grupo1"
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacial");
    </script>
