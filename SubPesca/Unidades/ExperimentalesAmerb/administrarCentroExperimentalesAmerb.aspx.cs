...
using SubPesca.Solicitudes.ExperimentalesAmerb;
using LogicaNegocio.cl.subpesca.rb.servicios.solicitudes;


namespace SubPesca.Unidades.ExperimentalesAmerb
{
    public partial class administrarCentroExperimentalesAmerb : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_UNIDAD_ESPACIAL_EXPERIMENTAL_AMERB };
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (PreviousPage != null && PreviousPage is inicioSolicitudExperimentalesAmerb)
                {

                    if (((inicioSolicitudExperimentalesAmerb)PreviousPage).MensajeRegistro != null && !((inicioSolicitudExperimentalesAmerb)PreviousPage).MensajeRegistro.Trim().Equals(""))
                    {
                        MensajeSuperior.Text = ((inicioSolicitudExperimentalesAmerb)PreviousPage).MensajeRegistro;
                ...
                // Cargamos la grilla
                Session["Filtro_Solicitud_Acuicultura_Experimentales_Amerb"] = null;
                CargaGrilla();
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                Session["Filtro_Solicitud_Acuicultura_Experimentales_Amerb"] = solicitudFiltro;
        ...
        protected void CargaGrilla()
        {
            ...
            try
            {
                solicitudFiltro = (SolicitudConcesion)Session["Filtro_Solicitud_Acuicultura_Experimentales_Amerb"];
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudExAmerbTraspaso(solicitudFiltro);
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "VerConcesion":
                    ...
                    Response.Redirect("~/Unidades/ExperimentalesAmerb/resumenExperimentalesAmerb.aspx");
                ...
                case "ModificarConcesion":
                    ...
                    solicitudVer = new SolicitudConcesion();
                    solicitudVer = solicitudDA.ObtieneSolicitudConcesion(idSolConces, ((Datos.Entidades.Usuario.Serializable)Session["Usuario"]).id_usuario);
                    //Esto es momentado comentar una vez que no se utilice.
                ...
                case "Desasociar":
                    Response.Redirect("~/Unidades/ExperimentalesAmerb/cambiarVigenciaExperimentalesAmerb.aspx?idSolConcesion=" + e.CommandArgument);
                    break;
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                */
                ...
                if (boton_historial != null)
                {
                    ...
                    {
                        boton_historial.Visible = true;
                        boton_historial.Attributes.Add("onclick", "javascript:abre_dialogo('historialCambioVigenciaExperimentalAmerb', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
                ...
                if (boton_ampliarVigencia != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.AMPLIAR_VIGENCIA))
                    {
                        ...
                        boton_ampliarVigencia.Attributes.Add("onclick", "javascript:abre_dialogo('extenderPlazoVigenciaExperimentalAmerb', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            grilla.DataBind();
            SubPesca.Utilidades.GridViewExportUtil.Export("AdministrarExperimentalesAmerb.xls", grilla);
        }
    }
}