<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioExperimentalesAmerb.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesExperimentalesAmerb.aspx.cs" 
Inherits="SubPesca.Unidades.ExperimentalesAmerb.unidadesEspacialesExperimentalesAmerb" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Experimental de Amerb</span></td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos de Experimental de Amerb</legend>
                ...
                <tr>
                    ...
                    <td class="col3">
                       ...
                       <ContentTemplate>
                            ...
                            <asp:TextBox ID="CodigoCentro" MaxLength="15" Width="80px" runat="server" CausesValidation="true" CssClass="campoDeshabilitado"></asp:TextBox> 
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacialExpAmerb");
    </script>
