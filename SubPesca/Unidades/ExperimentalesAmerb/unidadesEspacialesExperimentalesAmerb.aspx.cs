...
{
    public partial class unidadesEspacialesExperimentalesAmerb : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            ViewState["URL_ADMINISTRAR_SOLICITUD"] = paginas.URL_ADMINISTRAR_EXPERIMENTALES_AMERB;
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.UNIDAD_ESPACIAL_EXPERIMENTALES_AMERB_CREADO };
        }
        ...
        */
        protected void GuardarUnidadEspacial_Click(object sender, ImageClickEventArgs e)
        {
            ...
            List<String> listaErroresUnidadEspacial = unidadEspacialValidacion.validaUnidadEspacialExperimentalesAmerbCreada(unidadEspacial);
