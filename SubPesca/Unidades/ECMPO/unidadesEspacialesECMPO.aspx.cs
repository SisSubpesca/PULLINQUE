...
{
    public partial class unidadesEspacialesECMPO : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.UNIDAD_ESPACIAL_ECMPO_CREADO };
        }
        ...
        */
        protected void GuardarUnidadEspacial_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (PlazoNominal != null && !PlazoNominal.Text.Equals(""))
            {
                unidadEspacial.tipoPlazoNominal = new ParametroGenerico(Convert.ToInt32(PlazoNominal.Text));
            }
