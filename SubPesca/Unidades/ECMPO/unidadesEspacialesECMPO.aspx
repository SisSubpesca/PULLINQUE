<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioCentroECMPO.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesECMPO.aspx.cs" 
Inherits="SubPesca.Unidades.ECMPO.unidadesEspacialesECMPO" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Centro en ECMPO</span></td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos del Centro en ECMPO</legend>
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacialECMPO");
    </script>
