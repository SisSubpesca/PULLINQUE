<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarCentroECMPO.aspx.cs" Inherits="SubPesca.Unidades.ECMPO.administrarCentroECMPO" Theme="admin_style" %>

<%@ Reference Page="~/Solicitudes/ECMPO/inicioSolicitudECMPO.aspx" %>
<%@ Reference Page="~/Solicitudes/ECMPO/unidadEspacialECMPO.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Acuicultura en ECMPO</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Acuicultura en ECMPO</legend>

             
    <table class="form" cellpadding="0px" cellspacing="0px">
    <tr>
        <td class="col1"><span class="item">Código de Centro de Acuicultura en ECMPO</span></td>
    ...
    <tr>
     ...
     <tr>
        <td class="col1"><span class="item">ECMPO</span></td>
        <td class="col2"><span class="item">:</span></td>
        <td class="col3">
            <asp:UpdatePanel ID="UpdatePanelAmerb" UpdateMode="Conditional" runat="server">
            <ContentTemplate>
                <asp:TextBox ID="ECMPO" runat="server" Width="350px" AutoCompleteType="Disabled"></asp:TextBox>
                <asp:AutoCompleteExtender 
                        runat="server" 
                        ID="AutoCompleteExtender1" 
                        TargetControlID="ECMPO"
                        ServicePath="~/Solicitudes/Registrar/adminSolicitudConcesion.asmx"
                        ServiceMethod="BuscarECMPOs"
                        MinimumPrefixLength="2" 
                        CompletionInterval="1000"
                        EnableCaching="true"
                        CompletionListCssClass="autocompletionList"
                    ...
                    <asp:GridView ID="GridSolicitudesAdm"  
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="ECMPO">
                                <ItemTemplate>
                                  <asp:Label runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("datosSolicitudUE.ecmpoVista.descripcion")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="150px">
                                <ItemTemplate>
                                         <asp:ImageButton ID="gVer" Visible="true" runat="server" CausesValidation="false" CommandName="VerECMPO" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Centro ECMPO" ToolTip="Ver Centro ECMPO" />

                                         <asp:ImageButton ID="gModificar" Visible="false" runat="server" CausesValidation="false" CommandName="ModificarECMPO" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar ECMPO" ToolTip="Modificar ECMPO" />
    ...
    <script type="text/javascript">
        invoca_calendarios("administrarSolicitudECMPO");
    </script>
    
     <div id="historialCambioVigenciaECMPO" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_historialCambioVigenciaECMPO" CssClass="cerrar" OnClientClick="javascript:close_dialog('historialCambioVigenciaECMPO');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
            </div>
            <div class="body">
                <fieldset>
                <legend>Historial que Modifican Vigencia</legend>
                <iframe id="iframe_historialCambioVigenciaECMPO" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
                    
    <div id="cambiarVigenciaECMPO" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_cambiarVigenciaECMPO" CssClass="cerrar" OnClientClick="javascript:close_dialog('cambiarVigenciaECMPO');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Cambiar Vigencia</legend>
                <iframe id="iframe_cambiarVigenciaECMPO" src="" width="400" height="300" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
    
    <div id="extenderPlazoVigenciaECMPO" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_extenderPlazoVigenciaECMPO" CssClass="cerrar" OnClientClick="javascript:close_dialog('extenderPlazoVigenciaECMPO');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Extender Plazo Vigencia</legend>
                <iframe id="iframe_extenderPlazoVigenciaECMPO" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div> 
