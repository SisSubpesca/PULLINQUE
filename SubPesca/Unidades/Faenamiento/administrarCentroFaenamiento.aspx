<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarCentroFaenamiento.aspx.cs" Inherits="SubPesca.Unidades.Faenamiento.administrarCentroFaenamiento" Theme="admin_style" %>

<%@ Reference Page="~/Solicitudes/Faenamiento/inicioSolicitudFaenamiento.aspx" %>
<%@ Reference Page="~/Solicitudes/Faenamiento/unidadEspacialFaenamiento.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Centro de Faenamiento</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Centro de Faenamiento</legend>

             
    <table class="form" cellpadding="0px" cellspacing="0px">
    <tr>
        <td class="col1"><span class="item">Código de Centro de Faenamiento</span></td>
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="150px">
                                <ItemTemplate>
                                         <asp:ImageButton ID="gVer" Visible="true" runat="server" CausesValidation="false" CommandName="VerCentroFaenamiento" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Centro Faenamiento" ToolTip="Ver Centro Faenamiento" />

                                         <asp:ImageButton ID="gModificar" Visible="true" runat="server" CausesValidation="false" CommandName="ModificarCentroFaenamiento" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar Centro Faenamiento" ToolTip="Modificar Centro Faenamiento" />
    ...
    <script type="text/javascript">
        invoca_calendarios("administrarSolicitudFaenamiento");
    </script>

     <div id="historialCambioVigenciaFaenamiento" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_historialCambioVigenciaFaenamiento" CssClass="cerrar" OnClientClick="javascript:close_dialog('historialCambioVigenciaFaenamiento');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
            </div>
            <div class="body">
                <fieldset>
                <legend>Historial que Modifican Vigencia</legend>
                <iframe id="iframe_historialCambioVigenciaFaenamiento" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>

    <div id="cambiarVigenciaFaenamiento" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_cambiarVigenciaFaenamiento" CssClass="cerrar" OnClientClick="javascript:close_dialog('cambiarVigenciaFaenamiento');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Cambiar Vigencia</legend>
                <iframe id="iframe_cambiarVigenciaFaenamiento" src="" width="400" height="300" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>

      <div id="extenderVigenciaFaenamiento" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_extenderVigenciaFaenamiento" CssClass="cerrar" OnClientClick="javascript:close_dialog('extenderVigenciaFaenamiento');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Extender Plazo Vigencia</legend>
                <iframe id="iframe_extenderVigenciaFaenamiento" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div> 
