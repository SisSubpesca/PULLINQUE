<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioCentroFaenamiento.Master" AutoEventWireup="true" CodeBehind="titularFaenamiento.aspx.cs" 
Inherits="SubPesca.Unidades.Faenamiento.titularFaenamiento" Theme="admin_style" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
<%@ Register src="~/Unidades/Concesion/arrendatarioUnidadEspacialComponente.ascx" tagname="arrendatario" tagprefix="uc0" %>  
...
<asp:Content ID="FormularioIngresoSolicitante" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Identificación del Titular</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
       ...
       <asp:Panel ID="PanelArrendatario"  Visible="true" runat="server">
            <uc0:arrendatario ID="arrendatarioComponente" runat="server" />
       </asp:Panel>
