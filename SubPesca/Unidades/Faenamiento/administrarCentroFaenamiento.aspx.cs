...
using SubPesca.Solicitudes.Faenamiento;
using LogicaNegocio.cl.subpesca.rb.servicios.solicitudes;

namespace SubPesca.Unidades.Faenamiento
{
    public partial class administrarCentroFaenamiento : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_UNIDAD_ESPACIAL_FAENAMIENTO };
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (PreviousPage != null && PreviousPage is inicioSolicitudFaenamiento)
                {
                    MensajeSuperior.Text = ((inicioSolicitudFaenamiento)PreviousPage).MensajeRegistro;
                    PanelMensajeSuperior.Visible = true;
                    UpdatePanelMensajeSuperior.Update();
                }
                else if (PreviousPage != null && PreviousPage is unidadEspacialFaenamiento)
                {
                    MensajeSuperior.Text = ((unidadEspacialFaenamiento)PreviousPage).MensajeRegistro;
                    PanelMensajeSuperior.Visible = true;
                    UpdatePanelMensajeSuperior.Update();
                }
                ...
                // Cargamos la grilla
                Session["Filtro_Solicitud_Centro_Faenamiento"] = null;
                CargaGrilla();
        ...
        protected void Buscar_Click(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                Session["Filtro_Solicitud_Centro_Faenamiento"] = solicitudFiltro;
        ...
        protected void CargaGrilla()
        {
            ...
            try
            {
                solicitudFiltro = (SolicitudConcesion)Session["Filtro_Solicitud_Centro_Faenamiento"];
            ...
            List<SolicitudConcesion> relocalizacionTramite = solicitudDA.ListarSolicitudFaenamientoTraspaso(solicitudFiltro);
        ...
        protected void GridSolicitudesAdm_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "VerCentroFaenamiento":
                    ...
                    Response.Redirect("~/Unidades/Faenamiento/resumenFaenamiento.aspx");

                    break;
                case "ModificarCentroFaenamiento":
                    ...
                    break;
                case "Desasociar":
                    Response.Redirect("~/Unidades/Faenamiento/cambiarVigenciaFaenamiento.aspx?idSolConcesion=" + e.CommandArgument);
                    break;
        ...
        protected void GridSolicitudesAdm_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (boton_actaEntrega != null)
                {
                    ...
                    boton_actaEntrega.Attributes.Add("onclick", "javascript:abre_dialogo('agregarActaEntregaFaenamiento', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                }
                 * */
                ...
                if (boton_historial != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.HISTORIAL))
                    {
                        ...
                        boton_historial.Attributes.Add("onclick", "javascript:abre_dialogo('historialCambioVigenciaFaenamiento', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
                ...
                if (boton_ampliarVigencia != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.AMPLIAR_VIGENCIA))
                    {
                        ...
                        boton_ampliarVigencia.Attributes.Add("onclick", "javascript:abre_dialogo('extenderVigenciaFaenamiento', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            grilla.DataBind();
            SubPesca.Utilidades.GridViewExportUtil.Export("AdministrarFaenamiento.xls", grilla);
        }
    }
}