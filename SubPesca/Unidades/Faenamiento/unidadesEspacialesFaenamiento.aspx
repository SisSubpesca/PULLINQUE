<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioCentroFaenamiento.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesFaenamiento.aspx.cs" 
Inherits="SubPesca.Unidades.Faenamiento.unidadesEspacialesFaenamiento" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Centro de Faenamiento</span></td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos del Centro de Faenamiento</legend>
        ...
        <br /> 
                ...
                <tr>
                    ...
                    <td class="col3">
                       ...
                       <ContentTemplate>
                            ...
                            <asp:TextBox ID="CodigoCentro" MaxLength="15" Width="80px" runat="server" CausesValidation="true" ReadOnly="true" CssClass="campoDeshabilitado"></asp:TextBox> 
                            <asp:RequiredFieldValidator id="RequiredFieldValidator" runat="server" ControlToValidate="CodigoCentro" ValidationGroup="grupo1" 
                            ErrorMessage="Código de Centro" Display="Static" >*</asp:RequiredFieldValidator>
                ...
                <asp:Panel ID="PanelNumeroDiarioOficial" Visible="false" runat="server">
                <tr>
                ...
                <asp:Panel ID="PanelFechaDiarioOficial" Visible="false" runat="server">
                <tr>
                ...
                <ContentTemplate>
                    ...
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorFechaDiarioOficial" runat="server" ControlToValidate="FechaDiarioOficial"  ValidationGroup="grupo1"
                        ErrorMessage="Fecha Diario Oficial" Display="Static">*</asp:RequiredFieldValidator>

                    <asp:RegularExpressionValidator 
                        ID="RegularExpressionValidatorFechaDiarioOficial" 
                        runat="server"
                ...
                <asp:Panel ID="PanelNumeroActadeEntrega" Visible="false" runat="server">
                <tr>
                ...
                <asp:Panel ID="PanelFechaActaEnt" Visible="false" runat="server">
                <tr>
              ...
              <%--  <asp:Panel ID="PanelCapitaniaPuerto" Visible="false" runat="server">
                <tr>
                    ...
                    <td class="col3">
                        ...
                        <asp:DropDownList ID="CapitaniaPuerto" runat="server" CausesValidation = "true"></asp:DropDownList>                  
                        <asp:RequiredFieldValidator id="RequiredFieldValidatorCapitaniaPuerto" runat="server" ControlToValidate="CapitaniaPuerto" ValidationGroup="grupo1" ErrorMessage="Capitanía de Puerto" Display="Static" InitialValue="-1">*</asp:RequiredFieldValidator>
                ...
                <div class="calendario">
                    ...
                    <asp:RequiredFieldValidator id="RequiredFieldValidatorFechaInicioPeriodo" runat="server" ControlToValidate="FechaRecepcion"  ValidationGroup="grupo1"
                        ErrorMessage="Fecha Inicio Periodo" Display="Static">*</asp:RequiredFieldValidator>
                ...
                <asp:Panel id="PanelBotonGuardar" runat="server" Visible="true">
                    <tr>
                        ...
                        <td class="col3">
                                ...
                                AlternateText="Guardar Unidad Espacial" ToolTip="Guardar Unidad Espacial" onclick="GuardarUnidadEspacial_Click" 
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacialFaenamiento");
    </script>
