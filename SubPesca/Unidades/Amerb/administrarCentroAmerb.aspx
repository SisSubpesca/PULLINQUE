<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrador/SitioAdmin.Master" CodeBehind="administrarCentroAmerb.aspx.cs" 
Inherits="SubPesca.Unidades.Amerb.administrarCentroAmerb" Theme="admin_style" %>

<%@ Reference Page="~/Solicitudes/Amerb/inicioSolicitudAmerb.aspx" %>
<%@ Reference Page="~/Solicitudes/Amerb/unidadEspacialAmerb.aspx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Acuicultura Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <legend>B&uacute;squeda de Acuicultura Amerb</legend>

             
    <table class="form" cellpadding="0px" cellspacing="0px">
    <tr>
        <td class="col1"><span class="item">Código de Centro de Acuicultura en AMERB</span></td>
    ...
    <tr>
        ...
        <td class="col3">
            ...
            <ContentTemplate>
                <asp:TextBox ID="Amerb" runat="server" Width="350px" AutoCompleteType="Disabled"></asp:TextBox>
                <asp:AutoCompleteExtender 
                        runat="server" 
                        ID="AutoCompleteExtender1" 
                        TargetControlID="Amerb"
                        ServicePath="~/Solicitudes/Registrar/adminSolicitudConcesion.asmx"
                        ServiceMethod="BuscarAmerbs"
                        MinimumPrefixLength="2" 
                        CompletionInterval="1000"
                        EnableCaching="true"
                        CompletionListCssClass="autocompletionList"
                    ...
                    <asp:GridView ID="GridSolicitudesAdm"  
                       ...
                       Width="100%">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="AMERB">
                                <ItemTemplate>
                                  <asp:Label ID="Label2" runat="server" Text='<%# System.Web.HttpUtility.HtmlEncode((string)Eval("datosSolicitudUE.amerbVista.descripcion")) %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="150px">
                                <ItemTemplate>
                                         <asp:ImageButton ID="gVer" Visible="false" runat="server" CausesValidation="false" CommandName="VerAmerb" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Centro Amerb" ToolTip="Ver Centro Amerb" />

                                         <asp:ImageButton ID="gModificar" Visible="false" runat="server" CausesValidation="false" CommandName="ModificarAmerb" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "idSolConcesion") %>'
                                         ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar Centro Amerb" ToolTip="Modificar Centro Amerb" />
    ...
    <script type="text/javascript">
        invoca_calendarios("administrarSolicitudAmerb");
    </script>
    
    <div id="historialCambioVigenciaAmerb" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_historialCambioVigenciaAmerb" CssClass="cerrar" OnClientClick="javascript:close_dialog('historialCambioVigenciaAmerb');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
            </div>
            <div class="body">
                <fieldset>
                <legend>Historial que Modifican Vigencia</legend>
                <iframe id="iframe_historialCambioVigenciaAmerb" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
                    
    <div id="cambiarVigenciaAmerb" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_cambiarVigenciaAmerb" CssClass="cerrar" OnClientClick="javascript:close_dialog('cambiarVigenciaAmerb');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Cambiar Vigencia</legend>
                <iframe id="iframe_cambiarVigenciaAmerb src="" width="400" height="300" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
    
     <div id="extenderPlazoVigenciaAmerb" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_extenderPlazoVigenciaAmerb" CssClass="cerrar" OnClientClick="javascript:close_dialog('extenderPlazoVigenciaAmerb');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Extender Plazo Vigencia</legend>
                <iframe id="iframe_extenderPlazoVigenciaAmerb" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div> 
