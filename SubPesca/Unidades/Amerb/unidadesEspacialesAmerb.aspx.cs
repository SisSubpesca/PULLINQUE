...
{
    public partial class unidadesEspacialesAmerb : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.UNIDAD_ESPACIAL_AMERB_CREADO };
        }
        ...
        private void Inicialize_Campos()
        {
            ...
            PanelNumeroActadeEntrega.Visible = false;
        ...
        */
        protected void GuardarUnidadEspacial_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (NumeroActaEntrega.Text != null && !NumeroActaEntrega.Text.Trim().Equals(""))
            {
            ...
            if (PlazoInicio.Text != null && !PlazoInicio.Text.Trim().Equals(""))
            {
            ...
            if (PlazoVencimiento.Text != null && !PlazoVencimiento.Text.Trim().Equals(""))
            {
            ...
            List<String> listaErroresUnidadEspacial = unidadEspacialValidacion.validaUnidadEspacialAmerbCreada(unidadEspacial);
