<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioCentroAmerb.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesAmerb.aspx.cs" 
Inherits="SubPesca.Unidades.Amerb.unidadesEspacialesAmerb" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Acuicultura en Amerb</span></td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos de la Acuicultura en Amerb</legend>
        ...
        <br /> 
                ...
                <tr>
                    ...
                    <td class="col3">
                       ...
                       <ContentTemplate>
                            ...
                            <asp:TextBox ID="CodigoCentro" MaxLength="15" Width="80px" runat="server" ReadOnly="true" CausesValidation="true" CssClass="campoDeshabilitado"></asp:TextBox> 
                ...
                <tr>
                    <td class="col1"><span class="item">Fecha Web Resolución Pesca</span></td>
                    <td class="col2"><span class="item">:</span></td>
                    <td class="col3">
    ...
    <script type="text/javascript">
        invoca_calendarios("unidadEspacialAmerb");
    </script>
