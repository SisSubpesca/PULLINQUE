<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="historialCambioVigenciaConcecion.aspx.cs" Inherits="SubPesca.Unidades.Concesion.historialCambioVigenciaConcecion" %>
...
<body>
    <form id="dialog_historialCambioVigenciaConcecion" runat="server">
        ...
        <ContentTemplate>   
            ...
            <asp:GridView 
               ...
               AllowPaging="false" OnPageIndexChanging="GridNombres_PageIndexChanged">
                <RowStyle BackColor="#EFF3FB"/>
                <Columns>
                     <asp:TemplateField HeaderText="Resolución/Informe">
                                <ItemTemplate>
                                     <%# DataBinder.Eval(Container, "DataItem.cadena")%> <%# DataBinder.Eval(Container, "DataItem.cadenaDocConcesion")%>
                                </ItemTemplate>
                    </asp:TemplateField>
