<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="resolucionesConcesionComponente.ascx.cs" Inherits="SubPesca.Unidades.Concesion.resolucionesConcesionComponente" %>
...
<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
               <span id="titulo_modulo"> Resoluciones 
    ...
    <asp:UpdatePanel ID="UpdatePanelReferenciaGlobal" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
        <asp:Panel ID="PanelReferenciaGlobal" runat="server" Visible="true">

        
            <fieldset>
   

            <legend>Resoluciones de <asp:Label ID="NombreUnidadEspacialResoluciones" runat="server"></asp:Label></legend>
            <br />
            ...
            <script type="text/javascript">
                ...
                </asp:Panel></ContentTemplate></asp:UpdatePanel><br />

                 <!--  Resoluciones de la unidad espacial y sus trámites asociados -->
                 <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                 <ContentTemplate>  
                 <asp:Panel ID="Panel2"  Visible="true" runat="server">
                        <asp:GridView 
                        ID="GridViewResoluciones" 
                        runat="server" 
                        AutoGenerateColumns="False" 
                        CellPadding="4" 
                        ForeColor="#333333"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Resolución"           DataField="nombreSubRequerimiento" SortExpression="nombreSubRequerimiento" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField HeaderText="Tipo Documento" DataField="nombreTipoDocReq" SortExpression="nombreTipoDocReq" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField HeaderText="Nº"             DataField="numeroReq" SortExpression="numeroReq"  ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField HeaderText="Fecha"          DataField="fechaReq" SortExpression="fechaReq" ItemStyle-Width="50px" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:dd/MM/yyyy}" />
