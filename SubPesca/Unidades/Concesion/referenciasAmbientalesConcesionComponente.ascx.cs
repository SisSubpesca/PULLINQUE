...
{
    public partial class referenciasAmbientalesConcesionComponente : System.Web.UI.UserControl
    {
        ...
        protected void GridViewAmbiental_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            GridViewAmbiental.PageIndex = e.NewPageIndex;
            GridViewAmbiental.DataBind();
            CargaGrilla();
        }
        ...
        private void CargaGrilla()
        {
            ...
            {
                DataTable dt = dataExternaDA.Listar_SSP_DatosInfa(Convert.ToInt32(unidadEspacial.centrosDeCultivo.codigoCentro));

                if (dt != null && dt.Rows.Count > 0)
                {
                    GridViewAmbiental.DataSource = dt;
                    GridViewAmbiental.DataBind();
                ...
                {
                    msgGrilla.Text = "No existe referencias ambientales asociadas a la unidad espacial.";
