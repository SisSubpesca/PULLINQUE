...
{
    public partial class titularConcesion : System.Web.UI.Page
    {
        ...
        protected void setearModulo()
        {
            ...
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.IDENTIFICACION_SOLICITANTE_CONCESION_CREADO };
                ...
                if (solicitanteService.VerPersona(solicitante.rut, 0) != null)
                {
                    ...
                    if (solicitanteService.existeSolicitante(IdSolicitud.Value, solicitante.rut, 0) == null)
                    {
                        ...
                        if (resp)
                        {
                            ...
                            msgGrilla.Text = "Se ha asociado el Solicitante de forma exitosa a la concesión de acuicultura.";
                            Content_msgGrilla.Visible = true;
                        ...
                        {
                            msgGrilla.Text = "No se ha asociado el Solicitante a la concesión de acuicultura.";
                            Content_msgGrilla.Visible = true;
                        }
                    }
                    else
                    {
                        msgGrilla.Text = "El Solicitante ya se encuentra asociado a la concesión de acuicultura.";
                        Content_msgGrilla.Visible = true;
                        LimpiarCamposSolicitante();
                    }
                    Ico_msgGrillaGral_1.ImageUrl = "~/App_Themes/admin_style/images/info.gif";
