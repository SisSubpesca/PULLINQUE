...
{
    public partial class resolucionesConcesionComponente : System.Web.UI.UserControl
    {
        ...
        int dbPestana = rbPestana.RESOLUCIONES;
        int dbSeccion = rbSeccion.RESOLUCIONES;
        ...
        protected void Initialize_Form()
        {
            ...
            if (concesion != null && concesion.idSolConcesion > 0)
            {
                ...
                UpdatePanelReferenciaGlobal.Update();
            }
        ...
        protected void GridRequerimiento_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                GridView GridRequerimiento = (GridView)sender;
                ViewState["labelDocumentos"] = "Documentos Resoluciones Unidad Espacial";
