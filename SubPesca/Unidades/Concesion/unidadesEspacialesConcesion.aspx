<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioConcesionAcuicultura.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesConcesion.aspx.cs" 
Inherits="SubPesca.Unidades.Concesion.unidadesEspacialesConcesion" Theme="admin_style" %>
...
<asp:Content ID="FormularioUnidadesEspeciales" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Unidad Espacial Concesión de Acuicultura</span></td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend>Datos de la Concesión de Acuicultura</legend>
