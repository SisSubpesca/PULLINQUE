<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioExperimentalesConcesion.Master" AutoEventWireup="true" CodeBehind="proyectoTecnicoExperimentalesConcesion.aspx.cs"
Inherits="SubPesca.Unidades.ExperimentalesConcesion.proyectoTecnicoExperimentalesConcesion" Theme="admin_style" %>


<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit"%>

<%@ Register src="~/Solicitudes/Registrar/proyTecnicoComponente.ascx"                   tagname="proyTecnicoComponente"                 tagprefix="uc01" %>
