...
{
    public partial class administrarCentroExperimentalesConcesion : System.Web.UI.Page
    {
        ...
        {
            ViewState["SECCION_ESPECIFICA"] = new int[] { rbSeccionUnidadEspacial.ADMINISTRAR_UNIDAD_ESPACIAL_EXPERIMENTAL_CONCESION };
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                // Cargamos la grilla
                Session["Filtro_Solicitud_Experimentales_Concesion"] = null;
                CargaGrilla();
            }
        ...
        protected void GridSolicitudesAdm_PageIndexChanged(object sender, GridViewPageEventArgs e)
        {
            ...
            solicitudFiltro = (SolicitudConcesion)Session["Filtro_Solicitud_Experimentales_Concesion"];
            ...
            Session["Filtro_Solicitud_Experimentales_Concesion"] = solicitudFiltro;
        ...
        protected void CargaGrilla()
        {
            ...
            SolicitudConcesion solicitudFiltro = (SolicitudConcesion)Session["Filtro_Solicitud_Experimentales_Concesion"];
            ...
            List<SolicitudConcesion> solicitudesExperimentalesConcesionList = solicitudDA.ListarSolicitudExConcesionTraspaso(solicitudFiltro);

            if (solicitudesExperimentalesConcesionList == null || solicitudesExperimentalesConcesionList.Count <= 0)
            {
                ...
                solicitudesExperimentalesConcesionList = new List<SolicitudConcesion>();
                GridSolicitudesAdm.DataSource = solicitudesExperimentalesConcesionList;
                GridSolicitudesAdm.DataBind();
            }
            else
            {
            ...
            switch (e.CommandName)
            {
                case "VerConcesion":
                    ...
                    */
                    ...
                    Response.Redirect("~/Unidades/ExperimentalesConcesion/resumenExperimentalesConcesion.aspx");
                ...
                case "Desasociar":
                    Response.Redirect("~/Unidades/ExperimentalesConcesion/cambiarVigenciaExperimentalesConcesion.aspx?idSolConcesion=" + e.CommandArgument);
                    break;
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                */
                ...
                if (boton_historial != null)
                {
                    ...
                    {
                        boton_historial.Visible = true;
                        boton_historial.Attributes.Add("onclick", "javascript:abre_dialogo('historialCambioVigenciaExperimentalConcecion', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
                ...
                if (boton_ampliarVigencia != null)
                {
                    if (permisosService.tieneAccesoA2((int[])ViewState["SECCION_ESPECIFICA"], (Datos.Entidades.Usuario.Serializable)Session["Usuario"], null, rbAccion.AMPLIAR_VIGENCIA))
                    {
                        ...
                        boton_ampliarVigencia.Attributes.Add("onclick", "javascript:abre_dialogo('extenderPlazoVigenciaExperimentalConcesion', '" + DataBinder.Eval(e.Row.DataItem, "idSolConcesion") + "')");
                    }
                }
        ...
        protected void ExportarGrilla_Click(object sender, EventArgs e)
        {
            ...
            grilla.DataBind();
            SubPesca.Utilidades.GridViewExportUtil.Export("AdministrarExperimentalesConcesion.xls", grilla);
        }
