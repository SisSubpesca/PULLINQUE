<%@ Page Language="C#" MasterPageFile="~/Unidades/SitioExperimentalesConcesion.Master" AutoEventWireup="true" CodeBehind="unidadesEspacialesExperimentalesConcesion.aspx.cs" 
Inherits="SubPesca.Unidades.ExperimentalesConcesion.unidadesEspacialesExperimentalesConcesion" Theme="admin_style" %>
    ...
    <table class="formtop" cellpadding="0px" cellspacing="0px">
        <tr>
            <td align="left" valign="middle">
                <span id="titulo_modulo">Experimental Concesión</span>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        ...
        <br /> 
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="PanelCalendarioFechaActaEntrega" Visible="true" runat="server">
                        <div class="calendario_icono">
                ...
                <tr>
                    ...
                    <td class="col3">
                        ...
                        <asp:RequiredFieldValidator id="RequiredFieldValidator4" runat="server" ControlToValidate="PlazoVencimiento"  ValidationGroup="grupo1"
