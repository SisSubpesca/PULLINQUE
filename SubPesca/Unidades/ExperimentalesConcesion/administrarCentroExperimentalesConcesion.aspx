<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="administrarCentroExperimentalesConcesion.aspx.cs" 
Inherits="SubPesca.Unidades.ExperimentalesConcesion.administrarCentroExperimentalesConcesion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Administrar Experimentales Concesión</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
    ...
    <fieldset>
        <legend style="width: 254px">Búsqueda de Experimentales Concesión</legend>
        ...
        <ContentTemplate> 
            ...
            <asp:Panel ID="Panel1"  Visible="false" runat="server" >
                     <div class="msgGrilla_div1">
                        <asp:Image ID="Image1" CssClass="Ico_msgGrilla" runat="server" />
                    </div>
                       ...
                       Width="100%">
                        ...
                        <asp:TemplateField HeaderText="Opciones" ItemStyle-Width="170px">
                                <ItemTemplate>
                                         ...
                                         ImageUrl="../../App_Themes/admin_style/images/ver.png" Height="20px" AlternateText="Ver Experimentales Concesión" ToolTip="Ver Experimentales Concesión" />
                                         ...
                                         ImageUrl="../../App_Themes/admin_style/images/modificar.png" Height="20px" AlternateText="Modificar Experimentales Concesión" ToolTip="Modificar Experimentales Concesión" />
    ...
    </script><div id="historialCambioVigenciaExperimentalConcecion" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_historialCambioVigenciaExperimentalConcecion" CssClass="cerrar" OnClientClick="javascript:close_dialog('historialCambioVigenciaExperimentalConcecion');" CausesValidation="false" runat="server"></asp:LinkButton></div><div class="body">
            </div>
            <div class="body">
                <fieldset>
                <legend>Historial que Modifican Vigencia</legend>
                <iframe id="iframe_historialCambioVigenciaExperimentalConcecion" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div>
    ...
    <div id="cambiarVigenciaConcesion" class="dialog">
       ...
       <div id="extenderPlazoVigenciaExperimentalConcesion" class="dialog">
        <div class="background"></div>
        <div class="content_dialog">
            <div class="top">
                <asp:LinkButton ID="cerrar_extenderPlazoVigenciaConcesion" CssClass="cerrar" OnClientClick="javascript:close_dialog('extenderPlazoVigenciaExperimentalConcesion');" CausesValidation="false" runat="server"></asp:LinkButton>
            </div>
            <div class="body">
                <fieldset>
                <legend>Extender Plazo Vigencia</legend>
                <iframe id="iframe_extenderPlazoVigenciaExperimentalConcesion" src="" width="550" height="400" scrolling="auto" frameborder="0"></iframe>
                </fieldset> 
            </div>
        </div>
      </div> 
