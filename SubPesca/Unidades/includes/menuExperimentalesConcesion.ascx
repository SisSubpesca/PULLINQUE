<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="menuExperimentalesConcesion.ascx.cs" Inherits="SubPesca.Unidades.includes.menuExperimentalesConcesion" %>
...
<asp:Panel ID="Content_MenuV" CssClass="menuV" runat="server"></asp:Panel>
