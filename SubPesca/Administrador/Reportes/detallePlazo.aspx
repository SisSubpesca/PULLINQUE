<%@ Page Language="C#"  MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="detallePlazo.aspx.cs" 
Inherits="SubPesca.Administrador.Reportes.detallePlazo"  Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Detalle del Requerimiento con Plazo</span>
        </td>
    ...
    <fieldset>
        <legend>Información del requerimiento</legend>
        <br />
        <table cellpadding="0px" cellspacing="4px">
        <tr>
            <td><span class="item">Requerimiento</span></td>
            <td><span class="item">:</span></td>
            <td><asp:Label ID="Requerimiento" runat="server" Text=""></asp:Label></td>
        </tr>
        </table>     
    </fieldset>
    ...
    <fieldset>
        ...
        <tr>
            ...
            <td><asp:Label ID="Region" runat="server" Text=""></asp:Label></td>
        </tr>
        ...
        <tr id="tr_tipoDesti" visible="false" runat="server">
            <td><span class="item">Destinatario</span></td>
            <td><span class="item">:</span></td>
            <td><asp:Label ID="TipoDesti" runat="server" Text=""></asp:Label></td>
        </tr>
        </table>  
    </fieldset>  
    ...
    <fieldset>
        ...
        <ContentTemplate>   
            ...
            <asp:GridView ID="GridView1" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Nro Pert" DataField="NroPert" SortExpression="NroPert" ItemStyle-Width="60px" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField HeaderText="Titulares" DataField="Titulares" SortExpression="Titulares" ItemStyle-Width="150px" />
                    ...
                    <asp:BoundField HeaderText="Comunas" DataField="Comunas" SortExpression="Comunas" ItemStyle-Width="120px" />                    
                    <asp:BoundField HeaderText="Superficie" DataField="AreaTotalSolicitada" SortExpression="AreaTotalSolicitada" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:f4}" />
                    <asp:BoundField HeaderText="Sector solicitado" DataField="Toponimio" SortExpression="Toponimio" ItemStyle-Width="87px" />
                    <asp:BoundField HeaderText="Fecha Vencimiento Original" DataField="fechaVencimientoInicial" SortExpression="fechaVencimientoInicial" ItemStyle-Width="87px" DataFormatString="{0:dd'/'MM'/'yyyy}" />
                    <asp:BoundField HeaderText="Fecha Vencimiento Extendida" DataField="fechaNuevoVencimiento" SortExpression="fechaNuevoVencimiento" ItemStyle-Width="87px"  DataFormatString="{0:dd'/'MM'/'yyyy}"/>
        ...
        <asp:HiddenField ID="IdSubRequerimiento" runat="server" /> 
