<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="detalleSolicitudP3.aspx.cs" 
Inherits="SubPesca.Administrador.IndicadoresP3.detalleSolicitudP3" Theme="admin_style" %>
        ...
        <ContentTemplate>       
            ...
            <asp:GridView ID="GridView1" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Cantidad máxima" DataField="CantidadMaxima" SortExpression="CantidadMaxima" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Right" />
        ...
        <ContentTemplate>       
            ...
            <asp:GridView ID="GridView2" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Biomasa" DataField="Biomasa" SortExpression="Biomasa" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Right" />
                    ...
                    <asp:BoundField HeaderText="Prod. máxima por año" DataField="ProdMaxAnio" SortExpression="ProdMaxAnio" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Right" />
                </Columns>
                <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                <PagerStyle BackColor="#2461BF" ForeColor="#446699" HorizontalAlign="Center" />
                <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
