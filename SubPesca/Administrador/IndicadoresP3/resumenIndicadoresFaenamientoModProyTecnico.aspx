<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="resumenIndicadoresFaenamientoModProyTecnico.aspx.cs" 
Inherits="SubPesca.Administrador.IndicadoresP3.resumenIndicadoresFaenamientoModProyTecnico" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <fieldset>
        <legend>Resumen de Indicadores de Faenamiento Proyecto Técnico/Especie</legend>
        <br />
       ...
       <%-- <!-- -- INDICADOR Nº1 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <div class="indicadores_abajo">
            ...
            <tr>
                <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind01_VerDetalle" CssClass="txt_verdetalle" Text="Ingresar" CommandArgument="546,1,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
            </tr>
            </table>
        </div>
        </div>--%>
       ...
       <%-- <!-- -- INDICADOR Nº2 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind02_VerDetalle" Text="Ingresar" CommandArgument="546,2,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%--  <!-- -- INDICADOR Nº3 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind03_VerDetalle" Text="Ingresar" CommandArgument="546,3,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind04_VerDetalle" Text="Ingresar" CommandArgument="546,4,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
      ...
      <%--  <!-- -- INDICADOR Nº5 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind05_VerDetalle" Text="Ingresar" CommandArgument="546,5,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
       ...
       <%-- 
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind06_VerDetalle" Text="Ingresar" CommandArgument="546,6,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind07_VerDetalle" Text="Ingresar" CommandArgument="546,7,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind08_VerDetalle" Text="Ingresar" CommandArgument="546,8,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind09_VerDetalle" Text="Ingresar" CommandArgument="546,9,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind10_VerDetalle" Text="Ingresar" CommandArgument="546,10,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
       ...
       <%-- <!-- -- INDICADOR Nº11 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind11_VerDetalle" Text="Ingresar" CommandArgument="546,11,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind12_VerDetalle" Text="Ingresar" CommandArgument="546,12,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind13_VerDetalle" Text="Ingresar" CommandArgument="546,13,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind14_VerDetalle" Text="Ingresar" CommandArgument="546,14,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind15_VerDetalle" Text="Ingresar" CommandArgument="546,15,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind16_VerDetalle" Text="Ingresar" CommandArgument="546,16,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
      ...
      <%--  <!-- -- INDICADOR Nº17 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind17_VerDetalle" Text="Ingresar" CommandArgument="546,17,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
--%>
       ...
       <%-- <!-- -- INDICADOR Nº18 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind18_VerDetalle" Text="Ingresar" CommandArgument="546,18,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%--  <!-- -- INDICADOR Nº19 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind19_VerDetalle" Text="Ingresar" CommandArgument="546,19,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%-- 
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind20_VerDetalle" Text="Ingresar" CommandArgument="546,20,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
...
<%--
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind21_VerDetalle" Text="Ingresar" CommandArgument="546,21,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
--%>
       ...
       <%-- <!-- -- INDICADOR Nº22 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind22_VerDetalle" Text="Ingresar" CommandArgument="546,22,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind23_VerDetalle" Text="Ingresar" CommandArgument="546,23,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind24_VerDetalle" Text="Ingresar" CommandArgument="546,24,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind25_VerDetalle" Text="Ingresar" CommandArgument="546,25,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
       ...
       <%-- <!-- INDICADOR Nº26 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind26_VerDetalle" Text="Ingresar" CommandArgument="546,26,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
       ...
       <%-- <!-- INDICADOR Nº27 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind27_VerDetalle" Text="Ingresar" CommandArgument="546,27,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
       ...
       <%-- <!-- INDICADOR Nº28 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind28_VerDetalle" Text="Ingresar" CommandArgument="546,28,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%--  <!-- INDICADOR Nº29 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind29_VerDetalle" Text="Ingresar" CommandArgument="546,29,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind30_VerDetalle" Text="Ingresar" CommandArgument="546,30,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
       ...
       <%-- <!-- INDICADOR Nº31 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind31_VerDetalle" Text="Ingresar" CommandArgument="546,31,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%--  <!-- INDICADOR Nº32 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind32_VerDetalle" Text="Ingresar" CommandArgument="546,32,543" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
