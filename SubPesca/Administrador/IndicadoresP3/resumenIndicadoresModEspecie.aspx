<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master"  AutoEventWireup="true" CodeBehind="resumenIndicadoresModEspecie.aspx.cs" 
Inherits="SubPesca.Administrador.IndicadoresP3.resumenIndicadoresModEspecie" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <fieldset>
        <legend>Resumen de Indicadores de Especie</legend>
        <br />
     ...
     <%--   <!-- -- INDICADOR Nº1 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <div class="indicadores_abajo">
            ...
            <tr>
                <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind01_VerDetalle" CssClass="txt_verdetalle" Text="Ingresar" CommandArgument="89,1,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
            </tr>
            </table>
        </div>
        </div>--%>
     ...
     <%--   <!-- -- INDICADOR Nº2 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind02_VerDetalle" Text="Ingresar" CommandArgument="89,2,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%--  <!-- -- INDICADOR Nº3 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind03_VerDetalle" Text="Ingresar" CommandArgument="89,3,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind04_VerDetalle" Text="Ingresar" CommandArgument="89,4,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
      ...
      <%--  <!-- -- INDICADOR Nº5 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind05_VerDetalle" Text="Ingresar" CommandArgument="89,5,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
      ...
      <%--  <!-- -- INDICADOR Nº6 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind06_VerDetalle" Text="Ingresar" CommandArgument="89,6,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind07_VerDetalle" Text="Ingresar" CommandArgument="89,7,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind08_VerDetalle" Text="Ingresar" CommandArgument="89,8,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind09_VerDetalle" Text="Ingresar" CommandArgument="89,9,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind10_VerDetalle" Text="Ingresar" CommandArgument="89,10,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind11_VerDetalle" Text="Ingresar" CommandArgument="89,11,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind12_VerDetalle" Text="Ingresar" CommandArgument="89,12,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind13_VerDetalle" Text="Ingresar" CommandArgument="89,13,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind14_VerDetalle" Text="Ingresar" CommandArgument="89,14,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind15_VerDetalle" Text="Ingresar" CommandArgument="89,15,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind16_VerDetalle" Text="Ingresar" CommandArgument="89,16,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind17_VerDetalle" Text="Ingresar" CommandArgument="89,17,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
     ...
     <%--   <!-- -- INDICADOR Nº18 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind18_VerDetalle" Text="Ingresar" CommandArgument="89,18,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind19_VerDetalle" Text="Ingresar" CommandArgument="89,19,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
      ...
      <%--  
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind20_VerDetalle" Text="Ingresar" CommandArgument="89,20,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind21_VerDetalle" Text="Ingresar" CommandArgument="89,21,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind22_VerDetalle" Text="Ingresar" CommandArgument="89,22,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind23_VerDetalle" Text="Ingresar" CommandArgument="89,23,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind24_VerDetalle" Text="Ingresar" CommandArgument="89,24,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind25_VerDetalle" Text="Ingresar" CommandArgument="89,25,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind26_VerDetalle" Text="Ingresar" CommandArgument="89,26,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind27_VerDetalle" Text="Ingresar" CommandArgument="89,27,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind28_VerDetalle" Text="Ingresar" CommandArgument="89,28,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
      ...
      <%--  <!-- INDICADOR Nº29 ---------------------------------------------------------------------------------------------------------------------------------- !-->
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind29_VerDetalle" Text="Ingresar" CommandArgument="89,29,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
--%>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind30_VerDetalle" Text="Ingresar" CommandArgument="89,30,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind31_VerDetalle" Text="Ingresar" CommandArgument="89,31,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
        ...
        <table class="indicadores" cellpadding="0px" cellspacing="0px">        
        <tr>
            <td class="td_verdetalle" colspan="3"><span class="item"><asp:LinkButton ID="Ind32_VerDetalle" Text="Ingresar" CommandArgument="89,32,90" OnClick="VerDetalleIndicador_Click" runat="server"></asp:LinkButton></span></td>
        </tr>
        </table>
        </div>
        </div>
