...
{
    public partial class resumenIndicadoresExperimentalAmerb : System.Web.UI.Page
    {
        ...
        protected void VerDetalleIndicador_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect(String.Format("~/Administrador/IndicadoresP3/indicador.aspx?id_indicador={0}&id_solicitud={1}", id_indicador, id_solicitud));
