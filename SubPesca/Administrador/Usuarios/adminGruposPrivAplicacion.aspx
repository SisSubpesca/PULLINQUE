<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="adminGruposPrivAplicacion.aspx.cs" 
         Inherits="SubPesca.Administrador.Usuarios.adminGruposPrivAplicacion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <fieldset> 
        <legend>Asignación de privilegios a grupos de usuario</legend>
        <br />
        ...
        <tr>
            ...
            <td class="col3">
                ...
                <ContentTemplate>
                    <asp:DropDownList ID="GruposUsuarios" runat="server" AutoPostBack="true" OnSelectedIndexChanged="Carga_Privilegios"></asp:DropDownList>
                    <asp:LinkButton ID="link_adminGrupos" Visible="true" OnClientClick="javascript:abre_dialogo('adminGrupos', 0);" runat="server">[Administrar grupos de usuario]</asp:LinkButton>
                </ContentTemplate>
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="Cancelar" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="Finalizar" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="cerrar_adminGrupos" EventName="Click" />
                </Triggers>
                </asp:UpdatePanel>
            </td>
        </tr>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="Finalizar" EventName="Click" />
            <asp:AsyncPostBackTrigger ControlID="GruposUsuarios" EventName="SelectedIndexChanged" />
        </Triggers>
        </asp:UpdatePanel>    
