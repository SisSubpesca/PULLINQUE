...
{
    public partial class ReportesSolicitudesAMERB : System.Web.UI.Page
    {
        ...
        private static int idTipoUE = 119;
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_ACUICULTURA_EN_AMERB)
                    {
                        TipoTramite.Items.Add(new ListItem("Solicitud de Acuicultura en Amerb", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Modificación de Acuicultura en Amerb", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Experimental de Amerb", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB)));
                    }
                ...
                case "TipoModificacion":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_ACUICULTURA_EN_AMERB)
                    {
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Amerb: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_AMERB_AMPLIA_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Amerb: Reducción de Superficie", Convert.ToString(rbTipo.MOD_AMERB_REDUCE_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Amerb: Especie", Convert.ToString(rbTipo.MOD_AMERB_ESPECIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Amerb: Proyecto Técnico", Convert.ToString(rbTipo.MOD_AMERB_PT)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Amerb: Regularización", Convert.ToString(rbTipo.MOD_AMERB_REGULARIZACION)));
                    }
                ...
                case "TiposReportes":
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_ACUICULTURA_EN_AMERB || idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_AMERB)
                    {
                    ...
                    //if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB && (idTipoModificacion == rbTipo.MOD_AMERB_AMPLIA_SUPERFICIE || idTipoModificacion == rbTipo.MOD_AMERB_REDUCE_SUPERFICIE || idTipoModificacion == rbTipo.MOD_AMERB_ESPECIE || idTipoModificacion == rbTipo.MOD_AMERB_PT || idTipoModificacion == rbTipo.MOD_AMERB_REGULARIZACION))
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_AMERB)
                    {
