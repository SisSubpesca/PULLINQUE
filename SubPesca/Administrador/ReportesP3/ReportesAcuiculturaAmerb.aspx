<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master"  AutoEventWireup="true" CodeBehind="ReportesAcuiculturaAmerb.aspx.cs" 
Inherits="SubPesca.Administrador.ReportesP3.ReportesAcuiculturaAmerb" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Reportes Actividades de Acuicultura Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
