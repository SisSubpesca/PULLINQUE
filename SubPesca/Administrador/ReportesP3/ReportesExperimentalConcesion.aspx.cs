...
namespace SubPesca.Administrador.ReportesP3
{
    ...
    public partial class ReportesExperimentalConcesion : System.Web.UI.Page
    {
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoUE":
                    ...
                    TipoUE.DataBind();
                    TipoUE.SelectedValue = rbTipo.UNID_ESPACIAL_EXPERIMENTALES_CONCESION.ToString();
                ...
                case "TiposReportes":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_EXPERIMENTALES_CONCESION)
                    {
