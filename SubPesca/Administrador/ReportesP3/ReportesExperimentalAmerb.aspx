<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ReportesExperimentalAmerb.aspx.cs" 
Inherits="SubPesca.Administrador.ReportesP3.ReportesExperimentalAmerb" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Reportes Actividades Experimentales en Amerb</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
