...
{
    public partial class ReportesSolicitudesAcuicultura : System.Web.UI.Page
    {
        ...
        private static int idTipoUE = 36;
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CONCESION)
                    {

                        TipoTramite.Items.Add(new ListItem("Solicitud de Concesion de Acuicultura", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_CONCESION_ACUICULTURA)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Modificación de Acuicultura", Convert.ToString(rbTipo.TIPO_TRAMITE_MODIFICACION)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Relocalización por LEY", Convert.ToString(rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Relocalización RESA", Convert.ToString(rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Experimental de Concesion de Acuicultura", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION)));
                ...
                case "TipoModificacion":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CONCESION)
                    {
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Concesión: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_CONCESION_AMPLIA_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Concesión: Reducción de Superficie", Convert.ToString(rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Concesión: Especie", Convert.ToString(rbTipo.MOD_CONCESION_ESPECIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Concesión: Proyecto Técnico", Convert.ToString(rbTipo.MOD_CONCESION_PT)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Concesión: Regularización", Convert.ToString(rbTipo.MOD_CONCESION_REGULARIZACION)));
                    }
                ...
                case "TiposReportes":
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_CONCESION_ACUICULTURA)
                    {
                    ...
                    //if (idTipoTramite == rbTipo.TIPO_TRAMITE_MODIFICACION && (idTipoModificacion == rbTipo.MOD_CONCESION_AMPLIA_SUPERFICIE || idTipoModificacion == rbTipo.MOD_CONCESION_REDUCE_SUPERFICIE || idTipoModificacion == rbTipo.MOD_CONCESION_ESPECIE || idTipoModificacion == rbTipo.MOD_CONCESION_PT || idTipoModificacion == rbTipo.MOD_CONCESION_REGULARIZACION))
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_MODIFICACION)
                    {
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_EXPERIMENTALES_CONCESION) //EXPERIMENTAL DE CONCESION
                    {
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION) //RELOCALIZACION POR LEY
                    {
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA) //RELOCALIZACION RESA
                    {
        ...
        protected bool validarForm()
        {
            ...
            if (Convert.ToInt32(TipoTramite.SelectedValue) < 0)
            {
                ...
                //if (Convert.ToInt32(TipoTramite.SelectedValue)  == rbTipo.TIPO_TRAMITE_MODIFICACION){

                //    if (Convert.ToInt32(TipoModificacion.SelectedValue) < 0)
                //    {
                //        errores_list.Add("Seleccione Tipo de Modificación.");
                //    }
                //}
                //if (Convert.ToInt32(TipoTramite.SelectedValue) == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION)
                //{
                //    if (Convert.ToInt32(TipoRelocalizacion.SelectedValue) < 0)
                //    {
                //        errores_list.Add("Seleccione Tipo de Relocalización Por Ley.");
                //    }
                //}
                //if (Convert.ToInt32(TipoTramite.SelectedValue) == rbTipo.TIPO_TRAMITE_SECTOR_RELOCALIZACION_RESA)
                //{
                //    if (Convert.ToInt32(TipoTramite.SelectedValue) < 0)
                //    {
                //        errores_list.Add("Seleccione Tipo de Relocalización RESA.");
                //    }
                //}
