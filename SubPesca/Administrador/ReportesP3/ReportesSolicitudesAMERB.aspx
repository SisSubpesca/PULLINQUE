<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ReportesSolicitudesAMERB.aspx.cs" 
Inherits="SubPesca.Administrador.ReportesP3.ReportesSolicitudesAMERB" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Reportes Solicitudes Acuicultura de AMERB</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
