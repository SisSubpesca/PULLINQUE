...
{
    public partial class ReportesSolicitudesSemillas : System.Web.UI.Page
    {
        ...
        private static int idTipoUE = 120;
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_COLECTORES_DE_SEMILLA)
                    {
                        TipoTramite.Items.Add(new ListItem("Solicitud de Colectores de Semilla", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA)));
                    }
                ...
                case "TiposReportes":
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_COLECTORES_DE_SEMILLA)
                    {
