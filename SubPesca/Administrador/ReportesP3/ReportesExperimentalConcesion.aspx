<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ReportesExperimentalConcesion.aspx.cs" 
Inherits="SubPesca.Administrador.ReportesP3.ReportesExperimentalConcesion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Reportes Actividades Experimentales de Concesión</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
                        ...
                        <td class="col3">
                            ...
                            <div class="calendario">
                                ...
                                <asp:CustomValidator ID="ccFecha" ControlToValidate="FechaDesde" ErrorMessage="Fecha" ClientValidationFunction="validaFechaDDMMAAAA" 
                                    Display="static" Font-Size="10" runat="server"><asp:Literal ID="FechaNoValidaLiteral" runat="server" Text="<%$Resources:spanish.language,fechaNoValida%>"/></asp:CustomValidator></div></td></tr></asp:Panel></ContentTemplate></asp:UpdatePanel><asp:UpdatePanel ID="UpdatePanelFechaHasta" UpdateMode="Conditional" runat="server">
            <ContentTemplate>                        
                <asp:Panel ID="PanelFechaHasta"  Visible="false" runat="server">
                    ...
                    <tr>
                        <td class="col1"><span class="item">Fecha Hasta</span></td><td class="col2"><span class="item">:</span></td><td class="col3">
                            ...
                            <div class="calendario">
                                <div class="calendario_textbox">               
                                    <asp:TextBox ID="FechaHasta" Columns="8" Width="80px" runat="server"></asp:TextBox><asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" TargetControlID="FechaHasta"
                                        Mask="99/99/9999" MaskType="Date" CultureName="es-CL" CultureAMPMPlaceholder=""
                                        CultureDateFormat="DMY" CultureDatePlaceholder="/">
                                    </asp:MaskedEditExtender>
                                ...
                                <div class="calendario_icono">
                                    <asp:Image src="../../App_Themes/admin_style/images/calendar.png" id="fechaHastaImgDinamica" alt="Calendario" runat="server" style="vertical-align: middle" />&nbsp;<asp:Label ID="Label2" runat="server"></asp:Label><asp:ImageButton  ID="LimpiarFechaHasta" runat="server" AlternateText="Limpiar" Height="20px"  ImageUrl="~/App_Themes/admin_style/images/clean.png"  onclick="LimpiarHasta_Click" ToolTip="Limpiar" />
                                </div>
                                <asp:CustomValidator ID="CustomValidator1" ControlToValidate="FechaHasta" ErrorMessage="Fecha" ClientValidationFunction="validaFechaDDMMAAAA" 
                                    Display="static" Font-Size="10" runat="server"><asp:Literal ID="Literal1" runat="server" Text="<%$Resources:spanish.language,fechaNoValida%>"/></asp:CustomValidator></div></td></tr></asp:Panel></ContentTemplate></asp:UpdatePanel><tr>
            <td class="col1"></td>
            <td class="col2"></td>
            <td class="col3">
    ...
    <ContentTemplate>   
        ...
        <fieldset id="Content_Resultado" visible="false" runat="server">
            <legend>Resultado</legend><asp:Panel ID="Content_msgGrilla" CssClass="Content_msgGrilla" Visible="false" runat="server">
                <div class="msgGrilla_div1">
                    <asp:Image ID="Ico_msgGrilla" CssClass="Ico_msgGrilla" runat="server" />
                </div>
                <div class="msgGrilla_div2">
                    <asp:Label ID="msgGrilla" runat="server"></asp:Label></div></asp:Panel><asp:Panel ID="Content_Grilla" CssClass="Content_Grilla" runat="server">
