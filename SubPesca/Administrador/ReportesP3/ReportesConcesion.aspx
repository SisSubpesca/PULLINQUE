<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master"  AutoEventWireup="true" CodeBehind="ReportesConcesion.aspx.cs" 
Inherits="SubPesca.Administrador.ReportesP3.ReportesConcesion" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Reportes Concesión de Acuicultura</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
