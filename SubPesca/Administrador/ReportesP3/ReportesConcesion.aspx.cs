...
namespace SubPesca.Administrador.ReportesP3
{
    ...
    public partial class ReportesConcesion : System.Web.UI.Page
    {
            ...
            switch (combobox)
            {
                ...
                case "TiposReportes":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CONCESION)
                    {
                        ...
                        TiposReportes.Items.Add(new ListItem(TipoReportes.REPORTE_UNIDADES_ESPACIALES_CENTROS_DE_CULTIVO_STRING, Convert.ToString(TipoReportes.REPORTE_UNIDADES_ESPACIALES_CENTROS_DE_CULTIVO)));
