...
{
    public partial class ReportesSolicitudesFaenamiento : System.Web.UI.Page
    {
        ...
        private static int idTipoUE = 37;
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CENTRO_DE_FAENAMIENTO)
                    {

                        TipoTramite.Items.Add(new ListItem("Solicitud de Centro de Faenamiento", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Modificación Centro de Faenamiento", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO)));
                    }
                ...
                case "TipoModificacion":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CENTRO_DE_FAENAMIENTO)
                    {
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Reducción de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Renovación", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_RENOVACION)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Proyecto Técnico/Especie", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_PT_ESPECIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Faenamiento: Regularización", Convert.ToString(rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION)));
                    }
                ...
                case "TiposReportes":
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_FAENAMIENTO)
                    {
                    ...
                    //if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO && (idTipoModificacion == rbTipo.MOD_CENTRO_FAENAMIENTO_AMPLIA_SUPERFICIE || idTipoModificacion == rbTipo.MOD_CENTRO_FAENAMIENTO_REDUCE_SUPERFICIE || idTipoModificacion == rbTipo.MOD_CENTRO_FAENAMIENTO_ESPECIE || idTipoModificacion == rbTipo.MOD_CENTRO_FAENAMIENTO_PT || idTipoModificacion == rbTipo.MOD_CENTRO_FAENAMIENTO_REGULARIZACION))
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_FAENAMIENTO)
                    {
