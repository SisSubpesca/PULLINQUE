...
{
    public partial class ReportesSolicitudesAcopio : System.Web.UI.Page
    {
        ...
        private static int idTipoUE = 118;
            ...
            switch (combobox)
            {
                ...
                case "TipoTramite":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CENTRO_DE_ACOPIO)
                    {
                        ...
                        TipoTramite.Items.Add(new ListItem("Solicitud de Centro de Acopio", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO)));
                        TipoTramite.Items.Add(new ListItem("Solicitud de Modificación de Centro de Acopio", Convert.ToString(rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO)));
                ...
                case "TipoModificacion":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_CENTRO_DE_ACOPIO)
                    {
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Ampliación de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Reducción de Superficie", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Renovación", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_RENOVACION)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Proyecto Técnico/Especie", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_PT_ESPECIE)));
                        TipoModificacion.Items.Add(new ListItem("Solicitud Modificación Centro Acopio: Regularización", Convert.ToString(rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION)));
                    }
                ...
                case "TiposReportes":
                    ...
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_CENTRO_DE_ACOPIO)
                    {
                    ...
                    //if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO && (idTipoModificacion == rbTipo.MOD_CENTRO_ACOPIO_AMPLIA_SUPERFICIE || idTipoModificacion == rbTipo.MOD_CENTRO_ACOPIO_REDUCE_SUPERFICIE || idTipoModificacion == rbTipo.MOD_CENTRO_ACOPIO_ESPECIE || idTipoModificacion == rbTipo.MOD_CENTRO_ACOPIO_PT || idTipoModificacion == rbTipo.MOD_CENTRO_ACOPIO_REGULARIZACION))
                    if (idTipoTramite == rbTipo.TIPO_TRAMITE_SOLICITUD_MOD_CENTRO_ACOPIO)
                    {
