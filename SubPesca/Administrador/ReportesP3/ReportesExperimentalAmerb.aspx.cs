...
namespace SubPesca.Administrador.ReportesP3
{
    ...
    public partial class ReportesExperimentalAmerb : System.Web.UI.Page
    {
        ...
        protected void Initialize_Form()
        {
            ...
            switch (idTipoUE)
            {
                ...
                case 533:  // EXPERIMENTAL CONCESION
                    tr_tipoReporte.Visible = true;
                    tr_region.Visible = true;
                    tr_provincia.Visible = true;
                    tr_comuna.Visible = true;
        ...
        protected void Carga_Combobox(string combobox)
        {
            ...
            switch (combobox)
            {
                ...
                case "TipoUE":
                    ...
                    TipoUE.Items.Add(new ListItem("Experimental de Concesión", Convert.ToString(rbTipo.UNID_ESPACIAL_EXPERIMENTALES_CONCESION)));
                    TipoUE.Items.Add(new ListItem("Experimental de Amerb", Convert.ToString(rbTipo.UNID_ESPACIAL_EXPERIMENTALES_AMERB)));
                    ...
                    TipoUE.DataBind();
                    TipoUE.SelectedValue = rbTipo.UNID_ESPACIAL_EXPERIMENTALES_AMERB.ToString();
                ...
                case "TiposReportes":
                    ...
                    if (idTipoUE == rbTipo.UNID_ESPACIAL_EXPERIMENTALES_AMERB)
                    {
        ...
        protected DataTable CargaGrilla()
        {
            ...
            ViewState["TIPO_REPORTE"] = idTipoReporte;

            DataTable dt = reporteService.GenerarReporte(idTipoReporte, idTipoUE, idTipoTramite, idTipoRelocalizacion, idTipoModificacion, idRegion, idProvincia, idComuna, macrozona, barrio, especies, idGrupoEspecie, idEstado, numPert, codigoCentro, fechaInicio, fechaFin);
        ...
        protected void GridView_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                int tipoReporte = (int)ViewState["TIPO_REPORTE"];
                if (tipoReporte == TipoReportes.REPORTE_UNIDADES_ESPACIALES_CENTROS_DE_CULTIVO)
                {

                    //ImageButton ib = new ImageButton
                    //{
                    //    CommandName = "VerConcesion",
                    //    CommandArgument = "1",
                    //    ImageUrl = "~/App_Themes/admin_style/images/form.png",
                    //    AlternateText = "Ver Centro de Cultivo",
                    //    ToolTip = "Ver Centro de Cultivo",
                    //    Height = 20,
                    ...
                    ////ImageButton boton_ver = new ImageButton();
                    ////boton_ver.ImageUrl = "~/App_Themes/admin_style/images/form.png";
                    ////boton_ver.Height = 20;
                    ////boton_ver.AlternateText = "Ver Centro de Cultivo";
                    ////boton_ver.ToolTip = "Ver Centro de Cultivo";
                    ////boton_ver.Visible = true;

                    ////boton_ver.CommandName = "VerConcesion";
                    ////boton_ver.CommandArgument = "1";
                    ////boton_ver.Command += ImageButton_OnCommand;


                    int iSolConcesion = Convert.ToInt32(e.Row.Cells[0].Text); //idSolConcesion

                    HyperLink lnk = new HyperLink();
                    lnk.NavigateUrl = "~/Administrador/ReportesP3/detalleCentroCultivoP3.aspx?id_centrocultivo=" + iSolConcesion + "&origen=1";
                    lnk.ImageUrl = "~/App_Themes/admin_style/images/form.png";


                    int cantidadColumnas = e.Row.Cells.Count;
                    //e.Row.Cells[cantidadColumnas - 1].Controls.Add(ib);
                    e.Row.Cells[cantidadColumnas - 1].Controls.Add(lnk);
        ...
        protected void GridRequerimiento_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            string idRequerimiento = e.CommandArgument.ToString();
