<%@ Page Language="C#" MasterPageFile="~/Administrador/SitioAdmin.Master" AutoEventWireup="true" CodeBehind="ReportesSolicitudesSemillas.aspx.cs" 
Inherits="SubPesca.Administrador.ReportesP3.ReportesSolicitudesSemillas" Theme="admin_style" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="rightbody" runat="server">
    ...
    <tr>
        <td align="left" valign="middle">
            <span id="titulo_modulo">Reportes Solicitudes Colectores de Semillas</span>
        </td>
    </tr>
    </table>
    <hr style="width:100%;" />
